...
> **최종 업데이트:** 2026-06-27 (**v3.63 운영 배포** — 모바일 더블오더 방지(자동복귀+스티키 카트바) + 애드온 추천 카드 버그수정(사진/이모지/기본글리프 폴백·재진입 유지·자동이동제거)+자동폴백. SW 4.23, Smoke 9/9, Backup 20260627_061214. **#7 인쇄가시성은 배포에서 격리(print-guard 8/8 무변경·운영번들 print-events 0건)** — 인쇄/주문/단계 완전 무접촉.)
>
