...
> **최종 업데이트:** 2026-06-26 (thefire 잔여 #2 부분취소·#3 합본빌(혼합차지+포장비)·#6 주방매수·#9 오프라인큐·#11c 크로스셀 전부 운영배포 + 합본주문 표시/빌/우측패널/터치UX 정돈. 전수감사로 모든 진입점 갭 수정. 배포 스크립트 불안정으로 수동 rsync 다수. 상세 session-state.)
>
