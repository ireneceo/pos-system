...
> **최종 업데이트:** 2026-06-27 #2 (**thefire 브랜드메뉴 3매장 완전동기화 — 운영 데이터 작업, 코드 무수정**. 브랜드메뉴 126개 옵션·세트구성 thefire01/02/03 동일화 + "수요일 세트 안나옴" 근본수정(thefire01 LUNCH MENU 카테고리 비활성→활성) + 요일 런치스케줄 3매장 동일 적용. 세트 전파 영구수정(brandMenuSyncService.js)은 dev 미커밋·**/배포 대기**.)
>
