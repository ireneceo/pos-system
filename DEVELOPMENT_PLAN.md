...
> **최종 업데이트:** 2026-09-07 (**SW 4.86 · 개발서버 반영, 운영 미배포**). 브랜드제너럴 리포트를 "브랜드 자기 매출"로 재정의하고, 매장 판매 분석 6탭은 성과 메뉴 밑으로 옮겼다. 진실원장은 **브랜드가 발행한 인보이스** 하나(프로덕트 개별판매 `trade` · 구독판매 `brand_plan` · 수수료), `soa` 는 자식 인보이스의 묶음이라 제외한다.
> 함께: 브랜드 성과 화면에 오늘/어제 필터(매장 타임존 기준) · 오염값·중복 정리 도구(운영 미적용, `/배포` 때 실행) · 재발 감시 인스펙션 3건.
