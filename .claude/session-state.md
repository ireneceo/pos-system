## 현재 작업 상태
**마지막 업데이트:** 2026-09-04 (재고아이템 다이렉트 — 프로덕트/메뉴 = 재고아이템)
**버전:** v3.82 배포됨 + **미배포 dev 변경 있음**
**작업 상태:** dev 구현·게이트 완료, **운영 미배포** (Fable 게이트 대상)

### 이번 작업 — 재고아이템 다이렉트 (docs/TRADE_STRUCTURE.md §2-1)
