...
### 2026-09-25
- (개발 중·미완) 오너 모자 — 한 아이디에서 오너까지 고를 수 있게. 시스템 관리자가 Staff Management 에서 「오너 · 매장」을 부여하면, 그 사람의 「Choose where to work」에 오너 카드 1장(소유 매장 전체)이 생기고 고르면 오너 화면으로 들어갑니다. 지금까지는 역할마다 별도 아이디를 만들어야 했습니다
- (개발 중·미완) 자격 부여 화면에 **역할 선택**이 생깁니다 — 매장 관리자 / 오너. 전에는 매장 관리자 하나뿐이었습니다
- ⚠ 위 2건은 프론트 일부·문서·빌드가 남아 **미배포**. 운영 DB 변경은 없습니다
