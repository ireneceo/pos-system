...
`,C=t.Ay.div`
  ...
  font-size: 14px;
`,w=()=>{const[e,a]=(0,n.useState)(!1),[o,t]=(0,n.useState)(!1),[w,F]=(0,n.useState)(null),[T,S]=(0,n.useState)({companyName:"",registrationNo:"",tradeName:"",address:"",city:"",state:"",postalCode:"",country:"MY",phone:"",email:"",website:"",taxNo:"",logoUrl:"",operationSettings:{openingTime:"09:00",closingTime:"22:00",timeZone:"Asia/Kuala_Lumpur"}});(0,n.useEffect)(()=>{k()},[]);const k=async()=>{try{const n=localStorage.getItem("auth_token"),t=await fetch("/api/brands/company-info",{headers:{Authorization:`Bearer ${n}`}});if(t.ok){const n=await t.json();var e,a,o;if(n)S({companyName:n.company_name||n.name||"",registrationNo:n.registration_no||"",tradeName:n.trade_name||"",address:n.address||"",city:n.city||"",state:n.state||"",postalCode:n.postal_code||"",country:n.country||"MY",phone:n.phone||"",email:n.email||"",website:n.website||"",taxNo:n.tax_no||"",logoUrl:n.logo_url||"",operationSettings:{openingTime:(null===(e=n.operation_settings)||void 0===e?void 0:e.openingTime)||"09:00",closingTime:(null===(a=n.operation_settings)||void 0===a?void 0:a.closingTime)||"22:00",timeZone:(null===(o=n.operation_settings)||void 0===o?void 0:o.timeZone)||"Asia/Kuala_Lumpur"}})}}catch(n){console.error("Error fetching company info:",n)}},B=(e,o)=>{S(a=>({...a,[e]:o})),a(!0),F(null)},z=(e,o)=>{S(a=>({...a,operationSettings:{...a.operationSettings,[e]:o}})),a(!0),F(null)};return(0,d.jsx)(i.A,{children:(0,d.jsxs)(c,{children:[(0,d.jsxs)(h,{children:[(0,d.jsx)(g,{children:"Company Information"}),(0,d.jsx)(u,{hasChanges:e,onClick:async()=>{t(!0),F(null);try{const e=localStorage.getItem("auth_token");if(!(await fetch("/api/brands/company-info",{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({company_name:T.companyName,registration_no:T.registrationNo,trade_name:T.tradeName,address:T.address,city:T.city,state:T.state,postal_code:T.postalCode,country:T.country,phone:T.phone,email:T.email,website:T.website,tax_no:T.taxNo,logo_url:T.logoUrl,operation_settings:T.operationSettings})})).ok)throw new Error("Failed to save");F({type:"success",text:"Company information saved successfully!"}),a(!1)}catch(e){F({type:"error",text:"Failed to save company information. Please try again."})}finally{t(!1)}},disabled:!e||o,children:o?"Saving...":"Save Changes"})]}),(0,d.jsxs)(x,{children:[w&&(0,d.jsx)(C,{type:w.type,children:w.text}),(0,d.jsxs)(m,{children:[(0,d.jsx)(y,{children:"Basic Information"}),(0,d.jsxs)(b,{children:[(0,d.jsxs)(v,{children:[(0,d.jsxs)(j,{children:["Company Name ",(0,d.jsx)("span",{children:"*"})]}),(0,d.jsx)(f,{type:"text",value:T.companyName,onChange:e=>B("companyName",e.target.value),placeholder:"Enter company name"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Registration No."}),(0,d.jsx)(f,{type:"text",value:T.registrationNo,onChange:e=>B("registrationNo",e.target.value),placeholder:"e.g., 202001234567"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Trade Name"}),(0,d.jsx)(f,{type:"text",value:T.tradeName,onChange:e=>B("tradeName",e.target.value),placeholder:"Trading as..."})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Tax No. (SST/GST)"}),(0,d.jsx)(f,{type:"text",value:T.taxNo,onChange:e=>B("taxNo",e.target.value),placeholder:"e.g., W10-1234-56789012"})]})]})]}),(0,d.jsxs)(m,{children:[(0,d.jsx)(y,{children:"Address"}),(0,d.jsxs)(b,{children:[(0,d.jsxs)(v,{fullWidth:!0,children:[(0,d.jsxs)(j,{children:["Street Address ",(0,d.jsx)("span",{children:"*"})]}),(0,d.jsx)(f,{type:"text",value:T.address,onChange:e=>B("address",e.target.value),placeholder:"Enter street address"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"City"}),(0,d.jsx)(f,{type:"text",value:T.city,onChange:e=>B("city",e.target.value),placeholder:"e.g., Kuala Lumpur"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"State"}),(0,d.jsx)(f,{type:"text",value:T.state,onChange:e=>B("state",e.target.value),placeholder:"e.g., Wilayah Persekutuan"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Postal Code"}),(0,d.jsx)(f,{type:"text",value:T.postalCode,onChange:e=>B("postalCode",e.target.value),placeholder:"e.g., 50000"})]}),(0,d.jsxs)(v,{children:[(0,d.jsxs)(j,{children:["Country ",(0,d.jsx)("span",{children:"*"})]}),(0,d.jsx)(A,{value:T.country,onChange:e=>B("country",e.target.value),children:r.FS.map(e=>(0,d.jsx)("option",{value:e.code,children:e.name},e.code))})]})]})]}),(0,d.jsxs)(m,{children:[(0,d.jsx)(y,{children:"Contact Information"}),(0,d.jsxs)(b,{children:[(0,d.jsxs)(v,{children:[(0,d.jsxs)(j,{children:["Phone ",(0,d.jsx)("span",{children:"*"})]}),(0,d.jsx)(s.A,{value:T.phone,onChange:e=>B("phone",e),defaultCountry:T.country})]}),(0,d.jsxs)(v,{children:[(0,d.jsxs)(j,{children:["Email ",(0,d.jsx)("span",{children:"*"})]}),(0,d.jsx)(f,{type:"email",value:T.email,onChange:e=>B("email",e.target.value),placeholder:"company@example.com"})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Website"}),(0,d.jsx)(f,{type:"url",value:T.website,onChange:e=>B("website",e.target.value),placeholder:"https://www.example.com"})]})]})]}),(0,d.jsxs)(m,{children:[(0,d.jsx)(y,{children:"Operation Settings"}),(0,d.jsxs)(b,{children:[(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Opening Time"}),(0,d.jsx)(f,{type:"time",value:T.operationSettings.openingTime,onChange:e=>z("openingTime",e.target.value)})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Closing Time"}),(0,d.jsx)(f,{type:"time",value:T.operationSettings.closingTime,onChange:e=>z("closingTime",e.target.value)})]}),(0,d.jsxs)(v,{children:[(0,d.jsx)(j,{children:"Timezone"}),(0,d.jsx)(A,{value:T.operationSettings.timeZone,onChange:e=>z("timeZone",e.target.value),children:p.map(e=>(0,d.jsx)("option",{value:e.value,children:e.label},e.value))})]})]})]}),(0,d.jsxs)(m,{children:[(0,d.jsx)(y,{children:"Company Logo"}),(0,d.jsx)(l.A,{value:T.logoUrl,onChange:e=>B("logoUrl",e),imageAltText:"Company Logo"})]})]})]})})}}}]);