"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[5581],{5581:(e,r,s)=>{s.r(r),s.d(r,{default:()=>Z});var n=s(9950),t=s(4752),i=s(3310),l=s(3832),a=s(4728),o=s(1721),d=s(5665),c=s(7492),p=s(9610),h=s(4414);const x=t.Ay.div`
  background: white;
  border-radius: 12px;
