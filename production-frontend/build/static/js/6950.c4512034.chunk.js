"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[6950],{4021:(e,n,r)=>{r.d(n,{i1:()=>o});var t=r(9950),a=r(1367),i=r(6038);const o=()=>{const{user:e}=(0,a.As)(),[n,r]=(0,t.useState)("RM"),[o,s]=(0,t.useState)(Object.keys(i.DL)),[l,d]=(0,t.useState)(!0),[c,p]=(0,t.useState)(null);return(0,t.useEffect)(()=>{(async()=>{const n=window.location.pathname.split("/"),t=n.indexOf("restaurant");let a=t>=0?n[t+1]:null;if(!a&&null!==e&&void 0!==e&&e.restaurant_id&&(a=e.restaurant_id.toString()),!a)return r("RM"),void d(!1);try{const e=localStorage.getItem("auth_token"),n=await fetch(`/api/restaurants/${a}`,{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"}});if(n.ok){var i;const e=await n.json(),t=e.currency||(null===(i=e.operation_settings)||void 0===i?void 0:i.currency)||"RM";r(t)}else r("RM")}catch(o){console.error("Failed to fetch restaurant currency:",o),p("Failed to load currency settings"),r("RM")}finally{d(!1)}})()},[null===e||void 0===e?void 0:e.restaurant_id]),{defaultCurrency:n,supportedCurrencies:o,loading:l,error:c}}},6950:(e,n,r)=>{r.r(n),r.d(n,{default:()=>ie});var t=r(9950),a=r(4752),i=r(3310),o=r(1367),s=r(6910),l=r(6038),d=r(4021),c=r(4414);const p=a.Ay.div`
  min-height: 100vh;
  background: #FAFBFC;
`,h=a.Ay.div`
  padding: 32px;
