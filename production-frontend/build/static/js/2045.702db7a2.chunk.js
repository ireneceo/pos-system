"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[2045],{2045:(e,t,n)=>{n.d(t,{A:()=>ue});var r=n(9950),i=n(4492),a=n(4752),s=n(2674),o=n(2488),l=n(1367),c=n(9610),d=n(4021),p=n(6038),u=n(3705),x=n(7617),h=n(4414);const g=a.Ay.div`
  padding: 24px 0;
`,m=a.Ay.div`
  display: grid;
  gap: 12px;
...
`,y=i.Ay.input`
  display: none;
`,j=e=>{let{value:t,onChange:n,label:i="Logo Upload",helpText:j="Upload an image for your logo",maxSize:_=2,previewSize:v=150,showRemoveButton:k=!0,changeButtonText:f="Change Image",removeButtonText:b="Remove Image",imageAltText:w="Uploaded"}=e;const[F,C]=(0,r.useState)(!1),S=(0,r.useRef)(null),A=(0,r.useRef)(null),E=e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*_*1024)return void alert(`Image size should be less than ${_}MB`);const t=new FileReader;t.onload=e=>{var t;const r=new Image;r.onload=()=>{const e=document.createElement("canvas"),t=e.getContext("2d");if(!t)return;const i=800;let a=r.width,s=r.height;(a>i||s>i)&&(a>s?(s=s/a*i,a=i):(a=a/s*i,s=i)),e.width=a,e.height=s,t.drawImage(r,0,0,a,s);const o=e.toDataURL("image/jpeg",.85);n(o)},r.src=null===(t=e.target)||void 0===t?void 0:t.result},t.readAsDataURL(e)},B=e=>{const t=e.target.files;t&&t.length>0&&E(t[0])};return(0,a.jsxs)(s,{children:[i&&(0,a.jsx)(o,{children:i}),j&&(0,a.jsx)(l,{children:j}),(0,a.jsxs)(c,{children:[(0,a.jsx)(d,{ref:A,isDragging:F,hasImage:!!t,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),C(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===A.current&&C(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{e.preventDefault(),e.stopPropagation(),C(!1);const t=e.dataTransfer.files;t&&t.length>0&&E(t[0])},onClick:()=>{var e;t||(null===(e=S.current)||void 0===e||e.click())},children:t?(0,a.jsx)("img",{src:t,alt:w}):(0,a.jsxs)(p,{children:[(0,a.jsx)(u,{children:F?"Drop image here":"Drag & drop or click to upload"}),(0,a.jsxs)(x,{children:["PNG, JPG, GIF up to ",_,"MB"]})]})}),t&&(0,a.jsxs)(h,{children:[(0,a.jsxs)(g,{children:[f,(0,a.jsx)("input",{ref:S,type:"file",accept:"image/*",onChange:B})]}),k&&(0,a.jsx)(m,{onClick:()=>{n("")},children:b})]})]}),!t&&(0,a.jsx)(y,{ref:S,type:"file",accept:"image/*",onChange:B})]})}},7617:(e,t,n)=>{n.d(t,{A:()=>u});n(9950);var r=n(4752),i=n(9610),a=n(4414);const s=r.Ay.div`
  background: white;
  border-radius: 12px;
