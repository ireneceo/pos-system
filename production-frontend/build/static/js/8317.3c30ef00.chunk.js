...
`},4021:(e,n,a)=>{a.d(n,{i1:()=>o});var r=a(9950),t=a(1367);a(6038);const o=()=>{const{user:e}=(0,t.As)(),[n,a]=(0,r.useState)("USD"),[o,s]=(0,r.useState)(["USD"]),[i,l]=(0,r.useState)(!0),[d,c]=(0,r.useState)(null);return(0,r.useEffect)(()=>{(async()=>{if(null===e||void 0===e||!e.brand_id)return a("USD"),s(["USD","MYR","KRW"]),void l(!1);try{const n=localStorage.getItem("token"),r=await fetch(`/api/currencies/brands/${e.brand_id}`,{headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"}});if(r.ok){const e=await r.json();e.success&&e.data&&(a(e.data.default_currency||"USD"),s(e.data.supported_currencies||["USD"]))}else a("USD"),s(["USD","MYR","KRW"])}catch(n){console.error("Failed to fetch brand currency:",n),c("Failed to load currency settings"),a("USD"),s(["USD","MYR","KRW"])}finally{l(!1)}})()},[null===e||void 0===e?void 0:e.brand_id]),{defaultCurrency:n,supportedCurrencies:o,loading:i,error:d}}},8317:(e,n,a)=>{a.r(n),a.d(n,{default:()=>te});var r=a(9950),t=a(4492),o=a(4752),s=a(3310),i=a(3705),l=a(1367),d=a(7492),c=a(4021),p=a(6038),u=a(4414);const x=o.Ay.div`
  min-height: 100vh;
