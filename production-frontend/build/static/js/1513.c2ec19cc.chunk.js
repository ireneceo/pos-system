"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[1513],{1513:(e,a,n)=>{n.r(a),n.d(a,{default:()=>C});var o=n(9950),t=n(4752),r=n(3310),i=n(2435),s=n(2874),l=n(4669),d=n(4414);const c=t.Ay.div`
  background: #FAFBFC;
  min-height: 100vh;
`,p=t.Ay.div`
  background: white;
...
`,y=t.Ay.input`
  display: none;
`,b=e=>{let{value:a,onChange:n,label:t="Logo Upload",helpText:b="Upload an image for your logo",maxSize:j=2,previewSize:f=150,showRemoveButton:v=!0,changeButtonText:A="Change Image",removeButtonText:C="Remove Image",imageAltText:k="Uploaded"}=e;const[w,F]=(0,o.useState)(!1),N=(0,o.useRef)(null),z=(0,o.useRef)(null),B=e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*j*1024)return void alert(`Image size should be less than ${j}MB`);const a=new FileReader;a.onload=e=>{var a;const o=new Image;o.onload=()=>{const e=document.createElement("canvas"),a=e.getContext("2d");if(!a)return;const t=800;let r=o.width,i=o.height;(r>t||i>t)&&(r>i?(i=i/r*t,r=t):(r=r/i*t,i=t)),e.width=r,e.height=i,a.drawImage(o,0,0,r,i);const s=e.toDataURL("image/jpeg",.85);n(s)},o.src=null===(a=e.target)||void 0===a?void 0:a.result},a.readAsDataURL(e)},S=e=>{const a=e.target.files;a&&a.length>0&&B(a[0])};return(0,r.jsxs)(i,{children:[t&&(0,r.jsx)(s,{children:t}),b&&(0,r.jsx)(l,{children:b}),(0,r.jsxs)(d,{children:[(0,r.jsx)(c,{ref:z,isDragging:w,hasImage:!!a,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),F(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===z.current&&F(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{e.preventDefault(),e.stopPropagation(),F(!1);const a=e.dataTransfer.files;a&&a.length>0&&B(a[0])},onClick:()=>{var e;a||(null===(e=N.current)||void 0===e||e.click())},children:a?(0,r.jsx)("img",{src:a,alt:k}):(0,r.jsxs)(p,{children:[(0,r.jsx)(h,{children:w?"Drop image here":"Drag & drop or click to upload"}),(0,r.jsxs)(x,{children:["PNG, JPG, GIF up to ",j,"MB"]})]})}),a&&(0,r.jsxs)(g,{children:[(0,r.jsxs)(m,{children:[A,(0,r.jsx)("input",{ref:N,type:"file",accept:"image/*",onChange:S})]}),v&&(0,r.jsx)(u,{onClick:()=>{n("")},children:C})]})]}),!a&&(0,r.jsx)(y,{ref:N,type:"file",accept:"image/*",onChange:S})]})}}}]);