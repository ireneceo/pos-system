...
const rentBillingRouter = require('./routes/rent-billing');
...
const adminDeployRecordsRouter = require('./routes/admin-deploy-records');
...
app.use('/api/admin/deploy-records', adminDeployRecordsRouter);
