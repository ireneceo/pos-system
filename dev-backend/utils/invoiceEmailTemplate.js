...
<div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
  <div style="background: linear-gradient(135deg, #635BFF, #4B45C6); padding: 32px 24px; text-align: center; border-radius: 8px 8px 0 0;">
    <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 600;">Invoice Notification</h1>
  </div>
  ...
  <div style="padding: 32px 24px;">
    ...
    <p style="color: #9CA3AF; font-size: 12px; text-align: center; margin: 24px 0 0; border-top: 1px solid #E5E7EB; padding-top: 16px;">
      This is an automatically generated invoice. If you have questions, please contact your administrator.
    </p>
  </div>
</div>`;
