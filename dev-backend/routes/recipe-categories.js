...
const { RecipeCategory, Recipe, Brand, Restaurant } = require('../models');
...
/**
 * GET /api/brands/:brand_id/recipe-categories
 * 브랜드 레시피 카테고리 목록 조회
 */
router.get('/brands/:brand_id/recipe-categories', authenticateToken, isBrandManager, async (req, res) => {
  try {
...
/**
 * POST /api/brands/:brand_id/recipe-categories
 * 브랜드 레시피 카테고리 생성
 */
router.post('/brands/:brand_id/recipe-categories', authenticateToken, isBrandManager, async (req, res) => {
  try {
    const { brand_id } = req.params;
...
/**
 * PUT /api/brands/:brand_id/recipe-categories/:category_id
 * 브랜드 레시피 카테고리 수정
 */
router.put('/brands/:brand_id/recipe-categories/:category_id', authenticateToken, isBrandManager, async (req, res) => {
  try {
...
/**
 * DELETE /api/brands/:brand_id/recipe-categories/:category_id
 * 브랜드 레시피 카테고리 삭제
 */
router.delete('/brands/:brand_id/recipe-categories/:category_id', authenticateToken, isBrandManager, async (req, res) => {
  try {
    const { brand_id, category_id } = req.params;
...
/**
 * PUT /api/brands/:brand_id/recipe-categories/reorder
 * 브랜드 레시피 카테고리 순서 변경
 */
router.put('/brands/:brand_id/recipe-categories/reorder', authenticateToken, isBrandManager, async (req, res) => {
  try {
    const { brand_id } = req.params;
...
/**
 * GET /api/restaurants/:restaurant_id/recipe-categories
 * 레스토랑 레시피 카테고리 목록 조회
 */
router.get('/restaurants/:restaurant_id/recipe-categories', authenticateToken, async (req, res) => {
  try {
...
/**
 * POST /api/restaurants/:restaurant_id/recipe-categories
 * 레스토랑 레시피 카테고리 생성 (독립 레스토랑만)
 */
router.post('/restaurants/:restaurant_id/recipe-categories', authenticateToken, async (req, res) => {
  try {
    const { restaurant_id } = req.params;
    const { name, description, emoji, display_order } = req.body;
...
/**
 * PUT /api/restaurants/:restaurant_id/recipe-categories/:category_id
 * 레스토랑 레시피 카테고리 수정
 */
router.put('/restaurants/:restaurant_id/recipe-categories/:category_id', authenticateToken, async (req, res) => {
  try {
...
/**
 * DELETE /api/restaurants/:restaurant_id/recipe-categories/:category_id
 * 레스토랑 레시피 카테고리 삭제
 */
router.delete('/restaurants/:restaurant_id/recipe-categories/:category_id', authenticateToken, async (req, res) => {
  try {
    const { restaurant_id, category_id } = req.params;
