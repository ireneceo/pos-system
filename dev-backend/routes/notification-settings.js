...
const NOTIFICATION_CATEGORIES = [
  ...
  // 2026-09-01(Q6): 구매자가 먼저 수령하면 판매자 출고가 영영 안 일어나 재고가 안 빠졌다.
  { key: 'buyer_received', label: 'Buyer Confirmed Receipt', description: 'When a buyer confirms they received your shipment (you may still need to record dispatch)', section: 'Supply Chain', roles: ['Supplier Admin', 'Brand General', 'Brand Manager', 'Foodcourt General', 'Foodcourt Manager'] },
