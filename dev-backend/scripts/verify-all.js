...
const GATES = [
  ...
  // 2026-09-24 SEO C1: nginx 는 마케팅 주소를 정규식으로 따로 적는다 — config/seoPages.js 와 어긋나면 그 페이지가 조용히 빈 HTML/404
  { id: 'seo-nginx', tier: 'static', label: '🔎 마케팅 주소 목록 (seoPages.js ↔ nginx 초안 2개)', cwd: BACKEND, cmd: ['node', 'scripts/check-seo-nginx.js'] },
