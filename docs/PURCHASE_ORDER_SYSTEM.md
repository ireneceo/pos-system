...
| **브랜드 재료** | **무관.** 브랜드 메뉴 레시피용 / 매장 공유용 | `ingredients` (`brand_id`, 매장 없음) | 146건, 수량 0 — **정상** |
...
- **브랜드 메뉴 체인**은 별개: 브랜드 레시피(`recipes` brand_id) → **브랜드 재료**(`ingredients` brand_id).
  이건 K-DINE 메뉴용이고 **BG 재고 계산에 들어오지 않는다.**
