...
> 상태: **구현·운영 배포 완료 (v3.69, 2026-07-16).** Fable 게이트 CONDITIONAL GO→보안수정(device-report body.restaurant_id 폴백 제거)→GO. 인쇄 보호파일 8/8 무접촉. 구현 형태: 서버체크 S1~S8(S9는 S8 흡수)·기기체크 D1~D8(D9 lan_reach는 Phase2). **남은 것: D8 테스트 인쇄 1회 실프린터 종이 확인(매장).**
