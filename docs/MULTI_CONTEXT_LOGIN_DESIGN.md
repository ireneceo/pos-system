...
**상태(2026-09-03 실측 갱신):** **P1~P4 구현·운영 배포 완료** — `models/UserContext.js` · `services/userContexts.js` ·
`GET /auth/contexts` · `POST /auth/switch-context` · SA 부여 API(`routes/users.js` `/:id/contexts` 3종) ·
