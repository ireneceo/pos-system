"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[4602],{2488:(e,i,a)=>{a.d(i,{DO:()=>c,Jt:()=>p,Qn:()=>x});a(9950);var t=a(4752),n=a(4414);const r=t.Ay.div`
  display: flex;
  gap: 16px;
  margin-bottom: 24px;
  flex-wrap: wrap;
