...
`,v=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",j=e=>{let{value:a,onChange:n,label:t="Logo Upload",helpText:j="Upload an image for your logo",maxSize:f=2,previewSize:A=150,showRemoveButton:C=!0,changeButtonText:k="Change Image",removeButtonText:w="Remove Image",imageAltText:F="Uploaded"}=e;const[T,S]=(0,o.useState)(!1),[N,_]=(0,o.useState)(!1),B=(0,o.useRef)(null),z=(0,o.useRef)(null),E=async e=>{try{const a=localStorage.getItem("auth_token"),n=await fetch(`${v()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify({image:e})}),o=await n.json();return o.success?o.data.original:(console.error("Image upload failed:",o.message),null)}catch(a){return console.error("Image upload error:",a),null}},M=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*f*1024)return void alert(`Image size should be less than ${f}MB`);if(_(!0),"image/svg+xml"===e.type){const a=new FileReader;return a.onload=async e=>{var a;const o=null===(a=e.target)||void 0===a?void 0:a.result,t=await E(o);_(!1),t?n(t):alert("Failed to upload image. Please try again.")},void a.readAsDataURL(e)}const a=new FileReader;a.onload=async a=>{var o;const t=new Image;t.onload=async()=>{const a=document.createElement("canvas"),o=a.getContext("2d");if(!o)return void _(!1);const i=1200;let r=t.width,s=t.height;(r>i||s>i)&&(r>s?(s=s/r*i,r=i):(r=r/s*i,s=i)),a.width=r,a.height=s,o.drawImage(t,0,0,r,s);const l="image/png"===e.type?a.toDataURL("image/png"):a.toDataURL("image/jpeg",.85),d=await E(l);_(!1),d?n(d):alert("Failed to upload image. Please try again.")},t.src=null===(o=a.target)||void 0===o?void 0:o.result},a.readAsDataURL(e)},D=e=>{if(N)return;const a=e.target.files;a&&a.length>0&&M(a[0]),e.target.value=""};return(0,i.jsxs)(r,{children:[t&&(0,i.jsx)(s,{children:t}),j&&(0,i.jsx)(l,{children:j}),(0,i.jsxs)(d,{children:[(0,i.jsx)(c,{ref:z,isDragging:T,hasImage:!!a,isUploading:N,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),N||S(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===z.current&&S(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),S(!1),N)return;const a=e.dataTransfer.files;a&&a.length>0&&M(a[0])},onClick:()=>{var e;a||N||(null===(e=B.current)||void 0===e||e.click())},children:N?(0,i.jsxs)(p,{children:[(0,i.jsx)(b,{}),(0,i.jsx)(h,{style:{marginTop:"12px"},children:"Uploading..."})]}):a?(0,i.jsx)("img",{src:(U=a,U?U.startsWith("http")?U:U.startsWith("/uploads/")?`${v()}${U}`:U:""),alt:F}):(0,i.jsxs)(p,{children:[(0,i.jsx)(h,{children:T?"Drop image here":"Drag & drop or click to upload"}),(0,i.jsxs)(g,{children:["PNG, JPG, GIF up to ",f,"MB"]})]})}),a&&!N&&(0,i.jsxs)(u,{children:[(0,i.jsxs)(x,{disabled:N,children:[k,(0,i.jsx)("input",{ref:B,type:"file",accept:"image/*",onChange:D,disabled:N})]}),C&&(0,i.jsx)(m,{onClick:()=>{n("")},disabled:N,children:w})]})]}),!a&&!N&&(0,i.jsx)(y,{ref:B,type:"file",accept:"image/*",onChange:D})]});var U}}}]);