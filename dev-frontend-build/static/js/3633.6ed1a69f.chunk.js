...
`,$=e=>{let{startDate:t,endDate:n,onRangeSelect:r,onClose:$,isOpen:C}=e;const D=new Date,[S,B]=(0,i.useState)(D.getMonth()),[z,T]=(0,i.useState)(D.getFullYear()),[R,Y]=(0,i.useState)(null),[I,L]=(0,i.useState)(null),[P,M]=(0,i.useState)(null),[N,W]=(0,i.useState)("start"),_=(0,i.useRef)(null);(0,i.useEffect)(()=>{t&&Y(d(t)),n&&L(d(n))},[t,n]),(0,i.useEffect)(()=>{C&&W("start")},[C]),(0,i.useEffect)(()=>{const e=e=>{_.current&&!_.current.contains(e.target)&&$()};return C&&document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[C,$]);const H=(0,i.useCallback)(()=>{0===S?(B(11),T(e=>e-1)):B(e=>e-1)},[S]),U=(0,i.useCallback)(()=>{11===S?(B(0),T(e=>e+1)):B(e=>e+1)},[S]),O=(e,t)=>{const n=((e,t)=>new Date(e,t+1,0).getDate())(e,t),i=((e,t)=>new Date(e,t,1).getDay())(e,t),d=[];for(let r=0;r<i;r++)d.push(null);for(let r=1;r<=n;r++)d.push(new Date(e,t,r));return(0,a.jsxs)(F,{children:[(0,a.jsx)(y,{children:p(e,t)}),(0,a.jsx)(k,{children:o.map(e=>(0,a.jsx)(v,{children:e},e))}),(0,a.jsx)(j,{children:d.map((e,t)=>{if(!e)return(0,a.jsx)(E,{},`e-${t}`);const{isStart:n,isEnd:i,isInRange:o,isHoverEnd:d}=(e=>{const t=R&&l(e,R),n=I&&l(e,I),i="end"===N&&P?P:I;let r=!1;if(R&&i){const[t,n]=R<=i?[R,i]:[i,R];r=((e,t,n)=>{const i=e.getTime();return i>t.getTime()&&i<n.getTime()})(e,t,n)}return{isStart:t,isEnd:n,isInRange:r,isHoverEnd:"end"===N&&P&&l(e,P)}})(e),p=l(e,D);return(0,a.jsx)(A,{$isStart:!!n,$isEnd:!!i,$isInRange:o,$isHoverEnd:!!d,$isToday:p,onClick:()=>(e=>{if("start"===N)Y(e),L(null),W("end");else{let t=R,n=e;n<t&&([t,n]=[n,t]),Y(t),L(n),W("start"),r(s(t),s(n)),setTimeout($,200)}})(e),onMouseEnter:()=>M(e),onMouseLeave:()=>M(null),children:e.getDate()},e.getTime())})})]})},Z=11===S?0:S+1,q=11===S?z+1:z,J=e=>{const t=new Date;let n;const i=t;switch(e){case"this_week":n=new Date(t),n.setDate(t.getDate()-t.getDay());break;case"this_month":n=new Date(t.getFullYear(),t.getMonth(),1);break;case"this_year":n=new Date(t.getFullYear(),0,1);break;default:return}Y(n),L(i),W("start"),r(s(n),s(i)),setTimeout($,150)};return C?(0,a.jsx)(x,{ref:_,children:(0,a.jsxs)(c,{children:[(0,a.jsxs)(h,{children:[(0,a.jsx)(u,{onClick:()=>J("this_week"),children:"This Week"}),(0,a.jsx)(u,{onClick:()=>J("this_month"),children:"This Month"}),(0,a.jsx)(u,{onClick:()=>J("this_year"),children:"This Year"})]}),(0,a.jsxs)(g,{children:[(0,a.jsxs)(m,{children:[(0,a.jsx)(w,{onClick:H,"aria-label":"Previous month",children:(0,a.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,a.jsx)("polyline",{points:"15 18 9 12 15 6"})})}),(0,a.jsx)(w,{onClick:U,"aria-label":"Next month",children:(0,a.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,a.jsx)("polyline",{points:"9 6 15 12 9 18"})})})]}),(0,a.jsxs)(b,{children:[O(z,S),(0,a.jsx)(f,{children:O(q,Z)})]})]})]})}):null},C=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,D=(e,t)=>{const n=(e=>{if(!e)return new Date;try{const t=new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date),[n,i,r]=t.split("-").map(Number);return new Date(n,i-1,r)}catch{return new Date}})(t);let i=new Date(n);const r=new Date(n);switch(e){case"today":break;case"week":i.setDate(n.getDate()-6);break;case"month":i.setDate(n.getDate()-29);break;case"year":i.setDate(n.getDate()-364);break;case"all":i=new Date(2020,0,1)}return{start:C(i),end:C(r)}},S=r.Ay.div`
  margin-bottom: 24px;
`,B=r.Ay.div`
  display: flex;
  gap: 8px;
