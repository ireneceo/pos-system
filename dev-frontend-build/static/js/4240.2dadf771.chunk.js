"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[4240],{2488:(e,r,i)=>{i.d(r,{DO:()=>c,Jt:()=>d,Qn:()=>l});i(9950);var n=i(4752),t=i(4414);const a=n.Ay.div`
  display: flex;
  gap: 16px;
  margin-bottom: 24px;
  flex-wrap: wrap;
