...
`,p=new Set(["kitchen","entrance"]),u={kitchen:{bg:"transparent",border:"transparent",text:"#6B7280"},counter:{bg:"#FEF3C7",border:"#D97706",text:"#92400E"},entrance:{bg:"transparent",border:"transparent",text:"#6B7280"}},x=n.memo(e=>{let{table:t,status:a="available",isSelected:n=!1,isEditing:i=!1,onClick:x,onMouseDown:g,onTouchStart:b,statusInfo:f,currency:v=""}=e;const y=t.tableType||"table",m="table"!==y,$=p.has(y),w=m?u[y]||u.kitchen:i?{bg:"#F8F9FA",border:"#D1D9E0",text:"#374151"}:!i&&null!==f&&void 0!==f&&f.orderStatus&&r.v[f.orderStatus]?r.v[f.orderStatus]:r.Ez[a],E=m?{...$?{background:"transparent",border:n&&i?"1.5px dashed #635BFF":"none",boxShadow:n&&i?"0 0 0 2px rgba(99, 91, 255, 0.2)":"none",borderRadius:"4px"}:{border:`2.5px solid ${n?"#635BFF":w.border}`},cursor:i?"grab":"default",opacity:i?1:.85}:void 0,F="counter"===y&&t.width<t.height,j=!i&&"staffMeal"===(null===f||void 0===f?void 0:f.paymentMethod);return(0,o.jsxs)(l,{$x:t.x,$y:t.y,$w:t.width,$h:t.height,$shape:$?"square":t.shape,$rotation:t.rotation,$bgColor:$?"transparent":w.bg,$borderColor:$?"transparent":w.border,$textColor:w.text,$isSelected:n&&!$,$isEditing:i,onClick:e=>{i||!x||m||(e.stopPropagation(),x(t.tableNumber))},onMouseDown:e=>{i&&g&&g(e,t.id)},onTouchStart:e=>{i&&b&&b(e,t.id)},style:E,children:[j&&(0,o.jsx)(h,{children:"S"}),(0,o.jsx)(s,{$textColor:w.text,style:$?{fontSize:"14px",fontWeight:600,whiteSpace:"nowrap"}:F?{writingMode:"vertical-rl",textOrientation:"mixed",letterSpacing:"1px"}:void 0,children:t.label||t.tableNumber}),!m&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(d,{$textColor:w.text,children:!i&&null!==f&&void 0!==f&&f.guestCount?`${f.guestCount} guests`:`${t.seats} seats`}),!i&&f&&"available"!==a&&(0,o.jsx)(c,{$textColor:w.text,children:j?"Staff Meal":{pending:"Pending",preparing:"Preparing",ready:"Ready",served:"Served",awaiting_payment:"Awaiting Pay",outstanding:"Outstanding"}[f.orderStatus||""]||"Occupied"})]})]})});x.displayName="TableNode";const g=x,b=i.Ay.div`
  width: 100%;
  flex: 1;
  overflow: hidden;
  background: white;
