...
`,y=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",w=e=>{let{value:t,onChange:i,label:o="Logo Upload",helpText:w="Upload an image for your logo",maxSize:v=2,previewSize:F=150,showRemoveButton:A=!0,changeButtonText:j="Change Image",removeButtonText:k="Remove Image",imageAltText:B="Uploaded"}=e;const[C,E]=(0,n.useState)(!1),[z,D]=(0,n.useState)(!1),$=(0,n.useRef)(null),S=(0,n.useRef)(null),I=async e=>{try{const t=localStorage.getItem("auth_token"),i=await fetch(`${y()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({image:e})}),n=await i.json();return n.success?n.data.original:(console.error("Image upload failed:",n.message),null)}catch(t){return console.error("Image upload error:",t),null}},O=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*v*1024)return void alert(`Image size should be less than ${v}MB`);if(D(!0),"image/svg+xml"===e.type){const t=new FileReader;return t.onload=async e=>{var t;const n=null===(t=e.target)||void 0===t?void 0:t.result,o=await I(n);D(!1),o?i(o):alert("Failed to upload image. Please try again.")},void t.readAsDataURL(e)}const t=new FileReader;t.onload=async t=>{var n;const o=new Image;o.onload=async()=>{const t=document.createElement("canvas"),n=t.getContext("2d");if(!n)return void D(!1);const r=1200;let a=o.width,s=o.height;(a>r||s>r)&&(a>s?(s=s/a*r,a=r):(a=a/s*r,s=r)),t.width=a,t.height=s,n.drawImage(o,0,0,a,s);const l="image/png"===e.type?t.toDataURL("image/png"):t.toDataURL("image/jpeg",.85),d=await I(l);D(!1),d?i(d):alert("Failed to upload image. Please try again.")},o.src=null===(n=t.target)||void 0===n?void 0:n.result},t.readAsDataURL(e)},R=e=>{if(z)return;const t=e.target.files;t&&t.length>0&&O(t[0]),e.target.value=""};return(0,r.jsxs)(a,{children:[o&&(0,r.jsx)(s,{children:o}),w&&(0,r.jsx)(l,{children:w}),(0,r.jsxs)(d,{children:[(0,r.jsx)(p,{ref:S,isDragging:C,hasImage:!!t,isUploading:z,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),z||E(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===S.current&&E(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),E(!1),z)return;const t=e.dataTransfer.files;t&&t.length>0&&O(t[0])},onClick:()=>{var e;t||z||(null===(e=$.current)||void 0===e||e.click())},children:z?(0,r.jsxs)(c,{children:[(0,r.jsx)(b,{}),(0,r.jsx)(x,{style:{marginTop:"12px"},children:"Uploading..."})]}):t?(0,r.jsx)("img",{src:(L=t,L?L.startsWith("http")?L:L.startsWith("/uploads/")?`${y()}${L}`:L:""),alt:B}):(0,r.jsxs)(c,{children:[(0,r.jsx)(x,{children:C?"Drop image here":"Drag & drop or click to upload"}),(0,r.jsxs)(h,{children:["PNG, JPG, GIF up to ",v,"MB"]})]})}),t&&!z&&(0,r.jsxs)(u,{children:[(0,r.jsxs)(g,{disabled:z,children:[j,(0,r.jsx)("input",{ref:$,type:"file",accept:"image/*",onChange:R,disabled:z})]}),A&&(0,r.jsx)(m,{onClick:()=>{i("")},disabled:z,children:k})]})]}),!t&&!z&&(0,r.jsx)(f,{ref:$,type:"file",accept:"image/*",onChange:R})]});var L}},8012:(e,t,i)=>{i.d(t,{Ay:()=>l});i(9950);var n=i(4752),o=i(4414);const r=n.Ay.div`
  background: white;
  padding: 16px 32px;
  border-bottom: 1px solid #E6EBF1;
  margin-bottom: 0;
