...
`,Be=e=>{let{onCountChange:t}=e;const[r,n]=(0,i.useState)([]),[o,a]=(0,i.useState)(!0),[s,d]=(0,i.useState)(""),[c,p]=(0,i.useState)(!1),[u,h]=(0,i.useState)(!1),[g,b]=(0,i.useState)(null),[y,f]=(0,i.useState)(null),[v,j]=(0,i.useState)({name:"",is_required:!1,options:[]}),[w,F]=(0,i.useState)({name:"",price_adjustment:0}),C=(0,i.useCallback)(async()=>{try{const e=localStorage.getItem("auth_token"),r=await fetch("/api/brand-product-option-groups",{headers:{Authorization:`Bearer ${e}`}});if(r.ok){const e=await r.json();e.success&&(n(e.data),t(e.data.length))}}catch(e){console.error("Error fetching option groups:",e)}finally{a(!1)}},[t]);(0,i.useEffect)(()=>{C()},[C]);const k=e=>{e?(b(e),j({name:e.name,is_required:e.is_required,options:e.options.map(e=>({...e}))})):(b(null),j({name:"",is_required:!1,options:[]})),p(!0)},A=()=>{p(!1),b(null),j({name:"",is_required:!1,options:[]}),F({name:"",price_adjustment:0})},E=r.filter(e=>e.name.toLowerCase().includes(s.toLowerCase()));return o?(0,m.jsx)("div",{style:{padding:"40px",textAlign:"center",color:"#6B7280"},children:"Loading..."}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsxs)(ne,{children:[(0,m.jsx)(oe,{type:"text",placeholder:"Search option groups...",value:s,onChange:e=>d(e.target.value)}),(0,m.jsx)(ae,{onClick:()=>k(),children:"Add Option Group"})]}),0===E.length?(0,m.jsxs)(l.pp,{children:[(0,m.jsx)(fe,{children:"No option groups yet"}),(0,m.jsx)(ve,{children:"Create option groups to add customizable options to your products"}),(0,m.jsx)(ae,{onClick:()=>k(),children:"Add Option Group"})]}):(0,m.jsx)(se,{children:E.map(e=>(0,m.jsxs)(de,{children:[(0,m.jsxs)(le,{children:[(0,m.jsxs)(ce,{children:[(0,m.jsx)(pe,{children:e.name}),(0,m.jsxs)(xe,{children:[(0,m.jsx)(ue,{type:e.is_required?"required":"optional",children:e.is_required?"Required":"Optional"}),(0,m.jsxs)("span",{style:{fontSize:"13px",color:"#6B7280"},children:[e.options.length," options"]})]})]}),(0,m.jsxs)(he,{children:[(0,m.jsx)(ge,{onClick:()=>k(e),children:(0,m.jsxs)("svg",{viewBox:"0 0 24 24",fill:"none",children:[(0,m.jsx)("path",{d:"M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"}),(0,m.jsx)("path",{d:"M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})]})}),(0,m.jsx)(ge,{onClick:()=>{return t=e.id,f(t),void h(!0);var t},children:(0,m.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",children:(0,m.jsx)("path",{d:"M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2m3 0v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6h14zM10 11v6M14 11v6",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})})})]})]}),(0,m.jsx)(me,{children:e.options.map((e,t)=>(0,m.jsxs)(be,{children:[e.name,0!==e.price_adjustment&&(0,m.jsxs)(ye,{children:[Number(e.price_adjustment)>0?"+":"","RM ",(Number(e.price_adjustment)||0).toFixed(2)]})]},t))})]},e.id))}),(0,m.jsxs)(x.aF,{isOpen:c,onClose:A,title:g?"Edit Option Group":"New Option Group",children:[(0,m.jsxs)(je,{children:[(0,m.jsx)(we,{children:"Group Name"}),(0,m.jsx)(Fe,{type:"text",value:v.name,onChange:e=>j({...v,name:e.target.value}),placeholder:"e.g., Size, Grade, Packaging"})]}),(0,m.jsx)(je,{children:(0,m.jsx)(Ce,{children:(0,m.jsxs)(ke,{children:[(0,m.jsx)("input",{type:"checkbox",checked:v.is_required,onChange:e=>j({...v,is_required:e.target.checked})}),"Required Selection"]})})}),(0,m.jsxs)(je,{children:[(0,m.jsx)(we,{children:"Options"}),(0,m.jsxs)("div",{style:{display:"flex",gap:"8px",marginBottom:"12px"},children:[(0,m.jsx)(Fe,{type:"text",value:w.name,onChange:e=>F({...w,name:e.target.value}),placeholder:"Option name",style:{flex:2}}),(0,m.jsx)(Fe,{type:"number",value:w.price_adjustment,onChange:e=>F({...w,price_adjustment:parseFloat(e.target.value)||0}),placeholder:"Price adj.",step:"0.50",style:{flex:1}}),(0,m.jsx)(ae,{type:"button",variant:"secondary",onClick:()=>{if(!w.name.trim())return;const e=isNaN(w.price_adjustment)?0:w.price_adjustment;j(t=>({...t,options:[...t.options,{name:w.name.trim(),price_adjustment:e}]})),F({name:"",price_adjustment:0})},disabled:!w.name.trim(),children:"Add"})]}),v.options.map((e,t)=>(0,m.jsxs)(Ae,{children:[(0,m.jsxs)("div",{style:{flex:1},children:[(0,m.jsx)("strong",{children:e.name}),0!==e.price_adjustment&&(0,m.jsxs)("span",{style:{marginLeft:"8px",color:"#6B7280"},children:["(",Number(e.price_adjustment)>0?"+":"","RM ",(Number(e.price_adjustment)||0).toFixed(2),")"]})]}),(0,m.jsx)(Ee,{onClick:()=>{return e=t,void j(t=>({...t,options:t.options.filter((t,r)=>r!==e)}));var e},children:"x"})]},t))]}),(0,m.jsxs)("div",{style:{display:"flex",gap:"12px",justifyContent:"flex-end",marginTop:"24px"},children:[(0,m.jsx)(ae,{type:"button",variant:"secondary",onClick:A,children:"Cancel"}),(0,m.jsx)(ae,{type:"button",onClick:async()=>{if(v.name.trim()&&0!==v.options.length)try{const e=localStorage.getItem("auth_token"),t=g?`/api/brand-product-option-groups/${g.id}`:"/api/brand-product-option-groups",r=g?"PUT":"POST";(await fetch(t,{method:r,headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:v.name,is_required:v.is_required,options:v.options})})).ok&&(C(),A())}catch(e){console.error("Error saving option group:",e)}},disabled:!v.name.trim()||0===v.options.length,children:g?"Update":"Create"})]})]}),(0,m.jsxs)(x.aF,{isOpen:u,onClose:()=>h(!1),title:"Delete Option Group",children:[(0,m.jsx)("p",{children:"Are you sure you want to delete this option group? This action cannot be undone."}),(0,m.jsxs)("div",{style:{display:"flex",gap:"12px",justifyContent:"flex-end",marginTop:"24px"},children:[(0,m.jsx)(ae,{type:"button",variant:"secondary",onClick:()=>h(!1),children:"Cancel"}),(0,m.jsx)(ae,{type:"button",variant:"danger",onClick:async()=>{if(y)try{const e=localStorage.getItem("auth_token"),t=await fetch(`/api/brand-product-option-groups/${y}`,{method:"DELETE",headers:{Authorization:`Bearer ${e}`}});if(t.ok)C();else{const e=await t.json();alert(e.error||"Failed to delete option group")}}catch(e){console.error("Error deleting option group:",e)}finally{h(!1),f(null)}},children:"Delete"})]})]})]})},_e=()=>{const{user:e}=(0,s.As)(),[t,r]=(0,a.M)("products"),[d,l]=(0,i.useState)(0),[c,p]=(0,i.useState)(0),[x,u]=(0,i.useState)(0),[h,g]=(0,i.useState)([]),[b,y]=(0,i.useState)(!0),[f,v]=(0,i.useState)(0),[j]=(0,i.useState)(0);(0,i.useEffect)(()=>{!e||"Brand General"!==e.role&&"Brand Manager"!==e.role?y(!1):w()},[e]);const w=async()=>{try{const e=localStorage.getItem("auth_token"),t=await fetch("/api/brands",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const e=await t.json();g(e)}}catch(e){console.error("Error fetching brands:",e)}finally{y(!1)}};return b?(0,m.jsx)(m.Fragment,{children:(0,m.jsxs)(n.mc,{children:[(0,m.jsx)(n.Y9,{children:(0,m.jsx)(n.hE,{children:"Product Management"})}),(0,m.jsx)(n.UC,{children:(0,m.jsx)("div",{style:{textAlign:"center",padding:"40px",color:"#6B7280"},children:"Loading..."})})]})}):(0,m.jsx)(m.Fragment,{children:(0,m.jsxs)(n.mc,{children:[(0,m.jsx)(n.Y9,{children:(0,m.jsx)(n.hE,{children:"Product Management"})}),(0,m.jsxs)(n.UC,{children:[(0,m.jsxs)(o.tU,{children:[(0,m.jsxs)(o.oz,{active:"products"===t,onClick:()=>r("products"),children:["Products",(0,m.jsx)(o.Ex,{count:d,showZero:!0})]}),(0,m.jsxs)(o.oz,{active:"categories"===t,onClick:()=>r("categories"),children:["Categories",(0,m.jsx)(o.Ex,{count:c,showZero:!0})]}),(0,m.jsxs)(o.oz,{active:"options"===t,onClick:()=>r("options"),children:["Options",(0,m.jsx)(o.Ex,{count:x,showZero:!0})]})]}),(0,m.jsx)("div",{style:{display:"products"===t?"block":"none"},children:(0,m.jsx)(N,{brands:h,onCountChange:l,categoryRefreshKey:f,optionRefreshKey:j})}),(0,m.jsx)("div",{style:{display:"categories"===t?"block":"none"},children:(0,m.jsx)(ie,{onCountChange:p,onCategoryChange:()=>v(e=>e+1)})}),(0,m.jsx)("div",{style:{display:"options"===t?"block":"none"},children:(0,m.jsx)(Be,{onCountChange:u})})]})]})})}},9194:(e,t,r)=>{r.d(t,{A:()=>m});var i=r(9950),n=r(4752),o=r(4414);const a=n.Ay.div`
  position: relative;
  width: 100%;
`,s=n.Ay.div`
  display: flex;
