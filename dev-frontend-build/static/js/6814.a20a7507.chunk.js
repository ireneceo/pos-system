...
`,V=r.Ay.div`
  ...
  gap: 6px;
  margin-top: 8px;
`,W={"#F59E0B":{bg:"#FFF7ED",text:"#D97706",hoverBg:"#FEF3C7"},"#3B82F6":{bg:"#EFF6FF",text:"#1D4ED8",hoverBg:"#DBEAFE"},"#10B981":{bg:"#ECFDF5",text:"#047857",hoverBg:"#D1FAE5"}},U=r.Ay.button`
  flex: 1;
  padding: 8px 12px;
...
`,oe=r.Ay.div`
  ...
  align-items: center;
  gap: 6px;
`,de=()=>{const{user:e}=(0,a.As)(),{menuItems:t}=(0,o.b)(),[i,r]=(0,n.useState)([]),[W,de]=(0,n.useState)(new Date),[,le]=(0,n.useState)(null),[pe,ce]=(0,n.useState)(!1),[ue,me]=(0,n.useState)(null),[ge,he]=(0,n.useState)(()=>localStorage.getItem("kitchenDisplayViewMode")||"order"),xe=(0,n.useCallback)(async()=>{if(null!==e&&void 0!==e&&e.restaurantId)try{const t=localStorage.getItem("auth_token"),i=await fetch(`/api/orders/restaurant/${e.restaurantId}`,{credentials:"include",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}}),n=await i.json();if(n.success&&n.data){const e=n.data.filter(e=>{if(!["pending","preparing","ready"].includes(e.status))return!1;if("ready"===e.status){let t=e.order_items||[];if("string"===typeof t)try{t=JSON.parse(t)}catch{t=[]}if(t.length>0&&t.every(e=>e.is_set_menu&&e.set_items&&e.set_items.length>0?e.set_items.every(e=>"served"===e.status||"completed"===e.status):"served"===e.status||"completed"===e.status))return!1}return!0}).map(e=>{let t=e.order_items||[];if("string"===typeof t)try{t=JSON.parse(t)}catch{t=[]}const i=[];return t.forEach((t,n)=>{if(t.is_set_menu&&t.set_items&&t.set_items.length>0){var r;const s=t.set_items.map((i,r)=>({...i,id:`item-${e.id}-${n}-set-${r}`,name:i.name,quantity:i.quantity*(t.quantity||1),status:i.status||"pending"}));i.push({...t,id:`item-${e.id}-${n}`,name:t.name||(null===(r=t.menuItem)||void 0===r?void 0:r.name)||"Set Menu",quantity:t.quantity,options:t.options||[],special_instructions:t.special_instructions||t.specialInstructions||"",status:t.status||"pending",is_set_menu:!0,set_items:s})}else{var s;i.push({...t,id:`item-${e.id}-${n}`,name:t.name||(null===(s=t.menuItem)||void 0===s?void 0:s.name)||"Item",quantity:t.quantity,options:t.options||[],special_instructions:t.special_instructions||t.specialInstructions||"",status:t.status||"pending",is_set_menu:!1})}}),{id:e.id.toString(),orderNumber:e.order_number,pickupNumber:e.order_number.split("-")[1]||e.order_number.slice(-3),pagerNumber:e.pager_number||void 0,items:i,status:e.status,orderTime:new Date(e.createdAt),paymentStatus:e.payment_status,customerName:e.customer_name||void 0,tableNumber:e.table_number||void 0,orderType:e.order_type||"dine-in",source:e.source||"pos",scheduledPickupTime:e.scheduled_pickup_time||null}});r(t=>{const i=new Set(t.map(e=>e.id));return e.filter(e=>!i.has(e.id)).length>0&&ye(),e})}}catch(t){console.error("Failed to fetch orders:",t)}},[null===e||void 0===e?void 0:e.restaurantId]);(0,n.useEffect)(()=>{(async()=>{if(null!==e&&void 0!==e&&e.restaurantId)try{const t=localStorage.getItem("auth_token"),i=await fetch(`/api/restaurants/${e.restaurantId}`,{credentials:"include",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}});if(i.ok){const e=await i.json();me(e.operation_settings)}}catch(t){console.error("Failed to load operation settings:",t)}})()},[null===e||void 0===e?void 0:e.restaurantId]),(0,n.useEffect)(()=>{xe();const e=setInterval(xe,3e4);return()=>clearInterval(e)},[xe]),(0,n.useEffect)(()=>{if(null===e||void 0===e||!e.restaurantId)return;const t=(0,s.Ay)("/orders",{transports:["websocket","polling"],reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10});return t.on("connect",()=>{ce(!0),t.emit("join-restaurant",e.restaurantId),xe()}),t.on("disconnect",()=>ce(!1)),t.on("connect_error",()=>ce(!1)),t.on("reconnect",()=>{ce(!0),xe()}),t.on("order-created",t=>{if(t.restaurant_id!==e.restaurantId)return;let i=t.order_items||[];if("string"===typeof i)try{i=JSON.parse(i)}catch{i=[]}const n=[];i.forEach((e,i)=>{const r=(e.special_instructions||"").match(/^\[(.*?)\]/);if(r){r[1].split(",").map(e=>e.trim()).forEach((r,s)=>{const a=r.match(/^(.*?)\s+x(\d+)$/);if(a){const[,r,o]=a;n.push({id:`item-${t.id}-${i}-set-${s}`,name:r.trim(),quantity:parseInt(o)*e.quantity,options:[],status:e.status||"pending",isSetItem:!0,parentSetName:e.name})}}),e.options&&e.options.length>0&&n.push({id:`item-${t.id}-${i}`,name:`${e.name} (Options)`,quantity:e.quantity,options:e.options,status:e.status||"pending"})}else{var s;n.push({id:`item-${t.id}-${i}`,name:e.name||(null===(s=e.menuItem)||void 0===s?void 0:s.name)||"Item",quantity:e.quantity,options:e.options||[],status:e.status||"pending"})}});const s={id:t.id.toString(),orderNumber:t.order_number,pickupNumber:t.order_number.split("-")[1]||t.order_number.slice(-3),items:n,status:t.status||"pending",orderTime:new Date(t.createdAt||Date.now()),tableNumber:t.table_number,customerName:t.customer_name,orderType:t.order_type||"dine-in",source:t.source||"pos",scheduledPickupTime:t.scheduled_pickup_time||null};r(e=>[s,...e]),ye()}),t.on("order-updated",t=>{t.restaurant_id===e.restaurantId&&r(e=>e.map(e=>e.id===t.id.toString()?{...e,status:t.status,orderTime:new Date(t.createdAt)}:e).filter(e=>!!["pending","preparing","ready"].includes(e.status)&&("ready"!==e.status||!_e(e))))}),t.on("order-deleted",e=>{let{id:t}=e;r(e=>e.filter(e=>e.id!==t.toString()))}),le(t),()=>{t.disconnect()}},[null===e||void 0===e?void 0:e.restaurantId]),(0,n.useEffect)(()=>{const e=setInterval(()=>de(new Date),1e3);return()=>clearInterval(e)},[]);const ye=()=>{new Audio("/notification.mp3").play().catch(()=>{})},fe=e=>{const i=(e=>{const i=t.find(t=>t.name===e);return(null===i||void 0===i?void 0:i.code)||""})(e);return i?`${i} ${e}`:e},ve=e=>Math.floor((W.getTime()-e.getTime())/1e3/60),be=async function(e,t){(!(arguments.length>2&&void 0!==arguments[2])||arguments[2])&&r(i=>i.map(i=>i.id===e?{...i,status:t}:i).filter(e=>!!["pending","preparing","ready"].includes(e.status)&&("ready"!==e.status||!_e(e))));try{const i=localStorage.getItem("auth_token"),n=await fetch(`/api/orders/${e}/status`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{}},body:JSON.stringify({status:t})});(await n.json()).success||xe()}catch{xe()}},je=(e,t)=>{const i={pending:"preparing",preparing:"ready",ready:"served"}[e]||"completed";return t===i||"ready"===e&&"completed"===t?e:i},_e=e=>e.items.every(e=>e.is_set_menu&&e.set_items&&e.set_items.length>0?e.set_items.every(e=>"served"===e.status||"completed"===e.status):"served"===e.status||"completed"===e.status),Ae=(e,t)=>{switch(e){case"pending":return"preparing"===t;case"preparing":return"ready"===t;case"ready":return"served"===t||"completed"===t;default:return!1}},we=(e,t)=>e.every(e=>e.is_set_menu&&e.set_items&&e.set_items.length>0?e.set_items.every(e=>Ae(t,e.status||"pending")):Ae(t,e.status||"pending")),$e=async(e,t)=>{try{const n=i.find(t=>t.id===e);if(!n)return;const s=n.items.map(e=>{if(e.id===t){const t=je(n.status,e.status||"pending");return{...e,status:t}}return e}),a=localStorage.getItem("auth_token"),o=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:JSON.stringify({order_items:s.map(e=>({...e,status:e.status}))})});if(!(await o.json()).success)return;if(r(t=>t.map(t=>t.id===e?{...t,items:s}:t)),we(s,n.status)){const t={pending:"preparing",preparing:"ready",ready:"served"}[n.status];t&&await be(e,t,!0)}}catch(n){console.error("updateItemStatus error:",n),xe()}},Fe=async(e,t,n)=>{try{const s=i.find(t=>t.id===e);if(!s)return;const a=s.items.map(e=>{if(e.id===t&&e.set_items){const t=e.set_items.map(e=>{if(e.id===n){const t=je(s.status,e.status||"pending");return{...e,status:t}}return e}),i=t.every(e=>Ae(s.status,e.status||"pending"))?je(s.status,s.status):s.status;return{...e,set_items:t,status:i}}return e}),o=localStorage.getItem("auth_token"),d=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...o?{Authorization:`Bearer ${o}`}:{}},body:JSON.stringify({order_items:a.map(e=>({...e,status:e.status}))})});if(!(await d.json()).success)return;if(r(t=>t.map(t=>t.id===e?{...t,items:a}:t)),we(a,s.status)){const t={pending:"preparing",preparing:"ready",ready:"served"}[s.status];t&&await be(e,t,!0)}}catch{xe()}},ke=async e=>{try{const t=i.find(t=>t.id===e);if(!t)return;const n=t.items.map(e=>{const t={...e,status:"served"};return e.set_items&&e.set_items.length>0&&(t.set_items=e.set_items.map(e=>({...e,status:"served"}))),t}),s=localStorage.getItem("auth_token"),a=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...s?{Authorization:`Bearer ${s}`}:{}},body:JSON.stringify({order_items:n.map(e=>({...e,status:e.status}))})});if(!(await a.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:n}:t)),await be(e,"served",!0)}catch{xe()}},Se=e=>i.filter(t=>t.status===e).sort((e,t)=>e.orderTime.getTime()-t.orderTime.getTime()),Ie={pending:Se("pending").length,preparing:Se("preparing").length,ready:Se("ready").length},Te=e=>{const t=ve(e.orderTime),s=t>15&&"pending"===e.status;let a=0,o=0;e.items.forEach(t=>{t.is_set_menu&&t.set_items&&t.set_items.length>0?(a+=t.set_items.length,o+=t.set_items.filter(t=>Ae(e.status,t.status||"pending")).length):(a+=1,Ae(e.status,t.status||"pending")&&(o+=1))});const d=a>0?o/a*100:0,l=(e=>{switch(e){case"pending":return"#F59E0B";case"preparing":return"#3B82F6";case"ready":return"#10B981";default:return"#6B7C93"}})(e.status);return(0,p.jsxs)($,{children:[(0,p.jsxs)(F,{children:[(0,p.jsxs)(k,{children:[(0,p.jsx)(S,{children:e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pagerNumber?`P${e.pagerNumber}`:`#${e.pickupNumber}`}),"takeaway"===e.orderType&&(0,p.jsx)(I,{children:"TAKEAWAY"}),"pickup"===e.orderType&&(0,p.jsxs)(I,{variant:"pickup",children:["PICKUP ",e.scheduledPickupTime?c(e.scheduledPickupTime):"ASAP"]}),"delivery"===e.orderType&&(0,p.jsx)(I,{variant:"delivery",children:"DELIVERY"})]}),(0,p.jsxs)(T,{children:[(0,p.jsx)(E,{children:e.orderNumber}),(0,p.jsxs)(C,{urgent:s,children:[t,"m"]})]})]}),a>1&&(0,p.jsxs)(D,{children:[(0,p.jsx)(N,{children:(0,p.jsx)(B,{percent:d,color:l})}),(0,p.jsxs)(q,{children:[o,"/",a]})]}),(0,p.jsx)(G,{children:e.items.map(t=>(0,p.jsxs)(n.Fragment,{children:[(0,p.jsxs)(z,{done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:[(0,p.jsxs)(P,{children:[t.is_set_menu?(0,p.jsxs)("div",{style:{fontSize:"12px",fontWeight:500,color:"#6B7C93"},children:[fe(t.name)," ",t.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:["x ",t.quantity]})]}):(0,p.jsxs)(M,{done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:[fe(t.name)," ",t.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:["x ",t.quantity]})]}),(i=>{const n=(null===(i=t.options)||void 0===i?void 0:i.filter(e=>!/^.+\sx\d+$/.test(e)))||[];return 0!==n.length||t.special_instructions?(0,p.jsxs)(O,{children:[n.map((i,n)=>(0,p.jsx)(J,{done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:i},n)),t.special_instructions&&(0,p.jsx)(L,{done:Ae(e.status,t.status||"pending")&&"pending"!==e.status,children:t.special_instructions})]}):null})()]}),!t.is_set_menu&&1===a&&(0,p.jsx)(Z,{style:{padding:"6px 10px",fontSize:"12px",marginRight:4},onClick:()=>{const t="preparing"===e.status?"pending":"ready"===e.status?"preparing":null;t&&be(e.id,t)},children:"\u21ba"}),!t.is_set_menu&&(0,p.jsx)(H,{done:Ae(e.status,t.status||"pending"),statusColor:l,onClick:()=>$e(e.id,t.id),children:Ae(e.status,t.status||"pending")?"pending"===e.status?"Started":"preparing"===e.status?"Done \u2713":"Served":"pending"===e.status?"Start":"preparing"===e.status?"Done":"Serve"})]}),t.is_set_menu&&t.set_items&&t.set_items.length>0&&(0,p.jsx)(K,{children:t.set_items.map(i=>(0,p.jsxs)(R,{done:Ae(e.status,i.status||"pending")&&"pending"!==e.status,children:[(0,p.jsxs)(Y,{done:Ae(e.status,i.status||"pending")&&"pending"!==e.status,children:[fe(i.name)," ",i.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,done:Ae(e.status,i.status||"pending")&&"pending"!==e.status,children:["x ",i.quantity]})]}),(0,p.jsx)(H,{done:Ae(e.status,i.status||"pending"),statusColor:l,onClick:()=>Fe(e.id,t.id,i.id),children:Ae(e.status,i.status||"pending")?"pending"===e.status?"Started":"preparing"===e.status?"Done \u2713":"Served":"pending"===e.status?"Start":"preparing"===e.status?"Done":"Serve"})]},i.id))})]},t.id))}),"pending"===e.status&&a>1&&(0,p.jsx)(V,{children:(0,p.jsx)(U,{color:"#F59E0B",onClick:()=>(async(e,t)=>{try{const n=i.find(t=>t.id===e);if(!n)return;const s=n.items.map(e=>{const i={...e,status:t};return e.set_items&&e.set_items.length>0&&(i.set_items=e.set_items.map(e=>({...e,status:t}))),i}),a=localStorage.getItem("auth_token");await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:JSON.stringify({order_items:s.map(e=>({...e,status:e.status}))})}),r(t=>t.map(t=>t.id===e?{...t,items:s}:t)),await be(e,t,!0)}catch{xe()}})(e.id,"preparing"),children:"Start All"})}),"preparing"===e.status&&a>1&&(0,p.jsxs)(V,{children:[(0,p.jsx)(Z,{onClick:()=>be(e.id,"pending"),children:"\u21ba"}),(0,p.jsx)(U,{color:"#3B82F6",onClick:()=>(async e=>{try{const t=i.find(t=>t.id===e);if(!t)return;const n=t.items.map(e=>{const t={...e,status:"ready"};return e.set_items&&e.set_items.length>0&&(t.set_items=e.set_items.map(e=>({...e,status:"ready"}))),t}),s=localStorage.getItem("auth_token"),a=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...s?{Authorization:`Bearer ${s}`}:{}},body:JSON.stringify({order_items:n.map(e=>({...e,status:e.status}))})});if(!(await a.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:n}:t)),await be(e,"ready",!0)}catch{xe()}})(e.id),children:"Mark Ready"})]}),"ready"===e.status&&a>1&&(0,p.jsxs)(V,{children:[(0,p.jsx)(Z,{onClick:()=>be(e.id,"preparing"),children:"\u21ba"}),(0,p.jsx)(U,{color:"#10B981",onClick:()=>ke(e.id),children:"Serve All"})]})]},e.id)},Ee=()=>{const e=Se("preparing"),t=[];return e.forEach(e=>{const i=e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pagerNumber?`P${e.pagerNumber}`:`#${e.pickupNumber}`;e.items.forEach(n=>{var r;n.is_set_menu&&n.set_items&&n.set_items.length>0?n.set_items.forEach(r=>{t.push({orderId:e.id,itemId:r.id,parentItemId:n.id,menuName:r.name,formattedName:fe(r.name),quantity:r.quantity,orderLabel:i,orderNumber:e.orderNumber,orderTime:e.orderTime,status:r.status||"pending",isSetItem:!0})}):t.push({orderId:e.id,itemId:n.id,menuName:n.name,formattedName:fe(n.name),quantity:n.quantity,orderLabel:i,orderNumber:e.orderNumber,orderTime:e.orderTime,options:null===(r=n.options)||void 0===r?void 0:r.filter(e=>!/^.+\sx\d+$/.test(e)),special_instructions:n.special_instructions,status:n.status||"pending",isSetItem:!1})})}),t.sort((e,t)=>e.orderTime.getTime()-t.orderTime.getTime())},Ce=()=>{const e=Se("ready").filter(e=>!_e(e));return[...i.filter(e=>"preparing"===e.status).filter(e=>e.items.some(e=>e.is_set_menu&&e.set_items&&e.set_items.length>0?e.set_items.some(e=>"ready"===e.status):"ready"===e.status)).sort((e,t)=>e.orderTime.getTime()-t.orderTime.getTime()),...e]};return(0,p.jsxs)(u,{children:[(0,p.jsx)(d.Ay,{title:"Kitchen Display",children:(0,p.jsxs)(g,{children:[(0,p.jsxs)(X,{children:[(0,p.jsx)(ee,{active:"order"===ge,onClick:()=>{he("order"),localStorage.setItem("kitchenDisplayViewMode","order")},children:"Order"}),(0,p.jsx)(ee,{active:"item"===ge,onClick:()=>{he("item"),localStorage.setItem("kitchenDisplayViewMode","item")},children:"Item"})]}),(0,p.jsxs)(x,{connected:pe,children:[(0,p.jsx)(y,{connected:pe}),pe?"Live":"Offline"]}),(0,p.jsx)(h,{children:(0,l.fU)(W,ue)})]})}),(0,p.jsx)(m,{children:(0,p.jsxs)(f,{children:[(0,p.jsxs)(v,{children:[(0,p.jsxs)(b,{status:"pending",children:[(0,p.jsx)(j,{children:(0,p.jsx)(_,{status:"pending",children:"Pending"})}),(0,p.jsx)(A,{color:"#F59E0B",children:Ie.pending})]}),(0,p.jsx)(w,{children:"order"===ge?Se("pending").map(Te):(()=>{const e=Se("pending"),t=new Map;return e.forEach(e=>{const i=e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pagerNumber?`P${e.pagerNumber}`:`#${e.pickupNumber}`;e.items.forEach(n=>{if(n.is_set_menu&&n.set_items&&n.set_items.length>0)n.set_items.forEach(n=>{if(Ae("pending",n.status||"pending"))return;const r=n.name;t.has(r)||t.set(r,{menuName:n.name,formattedName:fe(n.name),plainQty:0,plainSources:[],optionSources:[],earliestTime:e.orderTime});const s=t.get(r);s.plainQty+=n.quantity,e.orderTime<s.earliestTime&&(s.earliestTime=e.orderTime),s.plainSources.push({orderId:e.id,itemId:n.id,label:i,orderNumber:e.orderNumber,quantity:n.quantity,is_set_menu:!0})});else{var r;if(Ae("pending",n.status||"pending"))return;const s=n.name;t.has(s)||t.set(s,{menuName:n.name,formattedName:fe(n.name),plainQty:0,plainSources:[],optionSources:[],earliestTime:e.orderTime});const a=t.get(s);e.orderTime<a.earliestTime&&(a.earliestTime=e.orderTime);const o=(null===(r=n.options)||void 0===r?void 0:r.filter(e=>!/^.+\sx\d+$/.test(e)))||[];o.length>0||n.special_instructions?a.optionSources.push({orderId:e.id,itemId:n.id,label:i,orderNumber:e.orderNumber,quantity:n.quantity,options:o,special_instructions:n.special_instructions}):(a.plainQty+=n.quantity,a.plainSources.push({orderId:e.id,itemId:n.id,label:i,orderNumber:e.orderNumber,quantity:n.quantity}))}})}),Array.from(t.values()).sort((e,t)=>e.earliestTime.getTime()-t.earliestTime.getTime())})().map((e,t)=>{const n=e.plainQty+e.optionSources.reduce((e,t)=>e+t.quantity,0),r=new Map;e.plainSources.forEach(e=>{r.set(e.label,(r.get(e.label)||0)+e.quantity)});const s=Array.from(r.entries()).map(e=>{let[t,i]=e;return i>1?`${t} x${i}`:t}).join(", ");return(0,p.jsxs)(te,{children:[(0,p.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,p.jsxs)(ie,{children:[e.formattedName,n>1&&(0,p.jsxs)(Q,{highlight:!0,children:["x ",n]})]}),(0,p.jsx)(U,{color:"#F59E0B",style:{flex:"none",padding:"6px 14px",fontSize:"12px"},onClick:()=>(async e=>{const t=[...e.plainSources,...e.optionSources];for(const n of t)if(n.is_set_menu){const e=i.find(e=>e.id===n.orderId);if(!e)continue;for(const t of e.items)if(t.set_items){const e=t.set_items.find(e=>e.id===n.itemId);e&&!Ae("pending",e.status||"pending")&&await Fe(n.orderId,t.id,n.itemId)}}else await $e(n.orderId,n.itemId)})(e),children:"Start All"})]}),e.plainQty>0&&(0,p.jsx)(ne,{children:s}),e.optionSources.length>0&&(0,p.jsx)("div",{style:{marginTop:8,paddingTop:e.plainQty>0?8:0,borderTop:e.plainQty>0?"1px solid #E6EBF1":"none"},children:e.optionSources.map((t,i)=>{var n;return(0,p.jsxs)("div",{style:{padding:"6px 0",borderBottom:i<e.optionSources.length-1?"1px dashed #E6EBF1":"none"},children:[(0,p.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:6,marginBottom:3},children:[(0,p.jsx)("span",{style:{fontSize:12,fontWeight:600,color:"#9CA3AF"},children:t.label}),(0,p.jsx)("span",{style:{fontSize:11,color:"#9CA3AF"},children:t.orderNumber}),t.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,children:["x ",t.quantity]})]}),(0,p.jsxs)(O,{children:[null===(n=t.options)||void 0===n?void 0:n.map((e,t)=>(0,p.jsx)(J,{children:e},t)),t.special_instructions&&(0,p.jsx)(L,{children:t.special_instructions})]})]},`opt-${i}`)})})]},`group-${t}`)})})]}),(0,p.jsxs)(v,{children:[(0,p.jsxs)(b,{status:"preparing",children:[(0,p.jsx)(j,{children:(0,p.jsx)(_,{status:"preparing",children:"Preparing"})}),(0,p.jsx)(A,{color:"#3B82F6",children:"order"===ge?Ie.preparing:Ee().filter(e=>!Ae("preparing",e.status)).length})]}),(0,p.jsx)(w,{children:"order"===ge?Se("preparing").map(Te):Ee().filter(e=>!Ae("preparing",e.status)).map((e,t)=>{var n;const s=!1;return(0,p.jsxs)(re,{children:[(0,p.jsxs)(se,{children:[(0,p.jsxs)(ae,{children:[e.orderLabel," ",e.orderNumber]}),(0,p.jsxs)(C,{urgent:!1,children:[ve(e.orderTime),"m"]})]}),(0,p.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,p.jsxs)("div",{children:[(0,p.jsxs)(oe,{children:[(0,p.jsx)("span",{style:{color:"#0A2540"},children:e.formattedName}),e.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,done:s,children:["x ",e.quantity]})]}),(e.options&&e.options.length>0||e.special_instructions)&&(0,p.jsxs)(O,{style:{marginTop:4},children:[null===(n=e.options)||void 0===n?void 0:n.map((e,t)=>(0,p.jsx)(J,{done:s,children:e},t)),e.special_instructions&&(0,p.jsx)(L,{done:s,children:e.special_instructions})]})]}),(0,p.jsxs)("div",{style:{display:"flex",gap:4,alignItems:"center"},children:[(0,p.jsx)(Z,{style:{padding:"6px 10px",fontSize:"12px"},onClick:()=>(async(e,t,n)=>{try{const s=i.find(t=>t.id===e);if(!s)return;const a={preparing:"pending",ready:"preparing",served:"ready",completed:"ready"},o=s.items.map(e=>{if(n&&e.id===n&&e.set_items){const i=e.set_items.map(e=>e.id===t?{...e,status:a[e.status||"pending"]||"pending"}:e);return{...e,set_items:i}}return n||e.id!==t?e:{...e,status:a[e.status||"pending"]||"pending"}}),d=localStorage.getItem("auth_token"),l=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...d?{Authorization:`Bearer ${d}`}:{}},body:JSON.stringify({order_items:o.map(e=>({...e,status:e.status}))})});if(!(await l.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:o}:t))}catch(s){console.error("revertItemStatus error:",s),xe()}})(e.orderId,e.itemId,e.isSetItem?e.parentItemId:void 0),children:"\u21ba"}),(0,p.jsx)(H,{done:s,statusColor:"#3B82F6",onClick:()=>{e.isSetItem&&e.parentItemId?Fe(e.orderId,e.parentItemId,e.itemId):$e(e.orderId,e.itemId)},children:"Done"})]})]})]},`prep-item-${t}`)})})]}),(0,p.jsxs)(v,{children:[(0,p.jsxs)(b,{status:"ready",children:[(0,p.jsx)(j,{children:(0,p.jsx)(_,{status:"ready",children:"Ready"})}),(0,p.jsx)(A,{color:"#10B981",children:"order"===ge?Ie.ready:Ce().length})]}),(0,p.jsx)(w,{children:"order"===ge?Se("ready").map(Te):Ce().map(e=>{const t=ve(e.orderTime),i="#10B981";let n=0,r=0,s=0;const a=[];e.items.forEach(e=>{if(e.is_set_menu&&e.set_items&&e.set_items.length>0)e.set_items.forEach(t=>{n++;const i=t.status||"pending";"ready"===i&&r++,"served"!==i&&"completed"!==i||s++,a.push({id:t.id,parentId:e.id,name:t.name,quantity:t.quantity,status:i,isSetItem:!0})});else{var t;n++;const i=e.status||"pending";"ready"===i&&r++,"served"!==i&&"completed"!==i||s++,a.push({id:e.id,name:e.name,quantity:e.quantity,options:null===(t=e.options)||void 0===t?void 0:t.filter(e=>!/^.+\sx\d+$/.test(e)),special_instructions:e.special_instructions,status:i,isSetItem:!1})}});const o=n-r-s,d=n>0?s/n*100:0,l=a.filter(e=>"ready"===e.status||"served"===e.status||"completed"===e.status);return 0===l.length?null:(0,p.jsxs)($,{children:[(0,p.jsxs)(F,{children:[(0,p.jsxs)(k,{children:[(0,p.jsx)(S,{children:e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pagerNumber?`P${e.pagerNumber}`:`#${e.pickupNumber}`}),"takeaway"===e.orderType&&(0,p.jsx)(I,{children:"TAKEAWAY"}),"pickup"===e.orderType&&(0,p.jsxs)(I,{variant:"pickup",children:["PICKUP ",e.scheduledPickupTime?c(e.scheduledPickupTime):"ASAP"]}),"delivery"===e.orderType&&(0,p.jsx)(I,{variant:"delivery",children:"DELIVERY"})]}),(0,p.jsxs)(T,{children:[(0,p.jsx)(E,{children:e.orderNumber}),(0,p.jsxs)(C,{children:[t,"m"]})]})]}),n>1&&(0,p.jsxs)(D,{children:[(0,p.jsx)(N,{children:(0,p.jsx)(B,{percent:d,color:i})}),(0,p.jsxs)(q,{children:[s,"/",n]})]}),(0,p.jsx)(G,{children:l.map((t,n)=>{var r;const s="served"===t.status||"completed"===t.status;return(0,p.jsxs)(z,{done:s,children:[(0,p.jsxs)(P,{children:[(0,p.jsxs)(M,{done:s,children:[fe(t.name)," ",t.quantity>1&&(0,p.jsxs)(Q,{highlight:!0,done:s,children:["x ",t.quantity]})]}),(t.options&&t.options.length>0||t.special_instructions)&&(0,p.jsxs)(O,{children:[null===(r=t.options)||void 0===r?void 0:r.map((e,t)=>(0,p.jsx)(J,{done:s,children:e},t)),t.special_instructions&&(0,p.jsx)(L,{done:s,children:t.special_instructions})]})]}),(0,p.jsx)(H,{done:s,statusColor:i,onClick:()=>{t.isSetItem&&t.parentId?Fe(e.id,t.parentId,t.id):$e(e.id,t.id)},children:s?"Served":"Serve"})]},n)})}),o>0&&(0,p.jsxs)("div",{style:{marginTop:8,padding:"6px 10px",background:"#FEF3C7",borderRadius:4,fontSize:12,fontWeight:600,color:"#D97706",textAlign:"center"},children:["Waiting ",o," item",o>1?"s":""," from kitchen"]}),0===o&&l.some(e=>"ready"===e.status)&&(0,p.jsxs)(V,{children:[(0,p.jsx)(Z,{onClick:()=>be(e.id,"preparing"),children:"\u21ba"}),(0,p.jsx)(U,{color:"#10B981",onClick:()=>ke(e.id),children:"Serve All"})]})]},e.id)})})]})]})})]})}},8012:(e,t,i)=>{i.d(t,{Ay:()=>d});i(9950);var n=i(4752),r=i(4414);const s=n.Ay.div`
  background: white;
  padding: 16px 32px;
