...
`,x=e=>{let{isOpen:n,title:t,message:a,onConfirm:x,onCancel:h,confirmText:g="Confirm",cancelText:v="Cancel",type:f="warning"}=e;return n?r.createPortal((0,i.jsx)(o.mH,{onClick:e=>{e.target===e.currentTarget&&h()},style:{zIndex:1100},children:(0,i.jsxs)(s,{onClick:e=>e.stopPropagation(),children:[(0,i.jsxs)(c,{children:[(0,i.jsx)(l,{children:t}),(0,i.jsx)(d,{children:a})]}),(0,i.jsxs)(p,{children:[(0,i.jsx)(u,{variant:"secondary",onClick:h,children:v}),(0,i.jsx)(u,{variant:"primary",type:f,onClick:x,children:g})]})]})}),document.body):null}},7999:(e,n,t)=>{t.r(n),t.d(n,{default:()=>U});var r=t(9950),a=t(4492),o=t(4752),i=t(2853),s=t(3705),c=t(8409),l=t(1367),d=t(4021),p=t(6038),u=t(1840),x=t(7617),h=t(4414);const g=o.Ay.div`
  background: #F0F9FF;
