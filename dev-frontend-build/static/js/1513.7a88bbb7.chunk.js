...
`,f=t.Ay.span`
  ...
  font-size: 12px;
  font-weight: 700;
`,j=(0,a.forwardRef)((e,o)=>{let{children:n,onSave:t,type:r="input",debounceMs:s=2e3,style:l}=e;const[d,j]=(0,a.useState)("idle"),[v,b]=(0,a.useState)(!1),A=(0,a.useRef)(null),C=(0,a.useRef)(null),S=(0,a.useRef)(null),k=(0,a.useRef)(!0),T=(0,a.useRef)(t);T.current=t;const w=(0,a.useCallback)(()=>{A.current&&clearTimeout(A.current),C.current&&clearTimeout(C.current),S.current&&clearTimeout(S.current)},[]),N=2e3!==s?s:"toggle"===r||"select"===r||"list"===r||"image"===r?300:s,_=(0,a.useCallback)(()=>{w(),b(!1),A.current=setTimeout(async()=>{if(k.current){j("saving");try{if(await T.current(),!k.current)return;j("saved"),C.current=setTimeout(()=>{k.current&&(b(!0),S.current=setTimeout(()=>{k.current&&(j("idle"),b(!1))},300))},2e3)}catch{if(!k.current)return;j("error"),C.current=setTimeout(()=>{k.current&&(b(!0),S.current=setTimeout(()=>{k.current&&(j("idle"),b(!1))},300))},4e3)}}},N)},[N,w]);(0,a.useImperativeHandle)(o,()=>({triggerSave:_}),[_]),(0,a.useEffect)(()=>(k.current=!0,()=>{k.current=!1,w()}),[w]);const I=a.Children.map(n,e=>{if(!a.isValidElement(e))return e;const o=e.props.onChange;return"function"!==typeof o?e:a.cloneElement(e,{onChange:function(){o(...arguments),_()}})}),P="saving"===d?(0,i.jsx)(y,{}):"saved"===d?(0,i.jsx)(x,{children:"\u2713"}):"error"===d?(0,i.jsx)(f,{children:"!"}):null,M="select"===r?m:"toggle"===r?u:"image"===r?h:"list"===r?g:p;return(0,i.jsxs)(c,{$type:r,style:l,children:[I,"idle"!==d&&(0,i.jsx)(M,{$fading:v,children:P})]})});j.displayName="AutoSaveField";const v=j}}]);