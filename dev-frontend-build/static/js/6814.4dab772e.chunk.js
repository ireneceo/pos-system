"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[6814],{6814:(e,t,i)=>{i.r(t),i.d(t,{default:()=>ne});var s=i(9950),n=i(4752),r=i(3422),a=i(1367),o=i(8930),d=i(8012),p=i(8406),l=i(4414);const c=e=>{const t=new Date(e),i=new Date(t.getTime()+18e5),s=e=>{const t=e.getHours(),i=t>=12?"PM":"AM";return{time:`${t%12||12}:${e.getMinutes().toString().padStart(2,"0")}`,period:i}},n=s(t),r=s(i);return n.period===r.period?`${n.time} - ${r.time} ${r.period}`:`${n.time} ${n.period} - ${r.time} ${r.period}`},u=n.Ay.div`
  background: #F0F2F5;
  min-height: 100vh;
  color: #0A2540;
