...
`},4021:(e,r,n)=>{n.d(r,{i1:()=>o});var i=n(9950),t=n(1367),a=n(6038);const o=()=>{const{user:e}=(0,t.As)(),[r,n]=(0,i.useState)("RM"),[o]=(0,i.useState)(Object.keys(a.DL)),[s,d]=(0,i.useState)(!0),[l,c]=(0,i.useState)(null);return(0,i.useEffect)(()=>{(async()=>{const r=window.location.pathname.split("/"),i=r.indexOf("restaurant");let t=i>=0?r[i+1]:null;if(!t&&null!==e&&void 0!==e&&e.restaurant_id&&(t=e.restaurant_id.toString()),!t)return n("RM"),void d(!1);try{const e=localStorage.getItem("auth_token"),r=await fetch(`/api/restaurants/${t}`,{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"}});if(r.ok){var a;const e=await r.json(),i=e.currency||(null===(a=e.operation_settings)||void 0===a?void 0:a.currency)||"RM";n(i)}else n("RM")}catch(o){console.error("Failed to fetch restaurant currency:",o),c("Failed to load currency settings"),n("RM")}finally{d(!1)}})()},[null===e||void 0===e?void 0:e.restaurant_id]),{defaultCurrency:r,supportedCurrencies:o,loading:s,error:l}}},6152:(e,r,n)=>{n.r(r),n.d(r,{default:()=>G});var i=n(9950),t=n(4752),a=n(2853),o=n(3705),s=n(8409),d=n(2488),l=n(1367),c=n(9610),p=n(4021),x=n(6038),u=n(7617),g=n(4414);const h=t.Ay.div`
  display: grid;
