...
`,S=e=>{let{startDate:t,endDate:r,onRangeSelect:i,onClose:S,isOpen:D}=e;const E=new Date,[$,R]=(0,n.useState)(E.getMonth()),[B,z]=(0,n.useState)(E.getFullYear()),[M,O]=(0,n.useState)(null),[T,I]=(0,n.useState)(null),[P,L]=(0,n.useState)(null),[W,Y]=(0,n.useState)("start"),N=(0,n.useRef)(null);(0,n.useEffect)(()=>{t&&O(d(t)),r&&I(d(r))},[t,r]),(0,n.useEffect)(()=>{D&&Y("start")},[D]),(0,n.useEffect)(()=>{const e=e=>{N.current&&!N.current.contains(e.target)&&S()};return D&&document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[D,S]);const _=(0,n.useCallback)(()=>{0===$?(R(11),z(e=>e-1)):R(e=>e-1)},[$]),q=(0,n.useCallback)(()=>{11===$?(R(0),z(e=>e+1)):R(e=>e+1)},[$]),H=(e,t)=>{const r=((e,t)=>new Date(e,t+1,0).getDate())(e,t),n=((e,t)=>new Date(e,t,1).getDay())(e,t),d=[];for(let i=0;i<n;i++)d.push(null);for(let i=1;i<=r;i++)d.push(new Date(e,t,i));return(0,s.jsxs)(v,{children:[(0,s.jsx)(w,{children:x(e,t)}),(0,s.jsx)(b,{children:a.map(e=>(0,s.jsx)(F,{children:e},e))}),(0,s.jsx)(k,{children:d.map((e,t)=>{if(!e)return(0,s.jsx)(A,{},`e-${t}`);const{isStart:r,isEnd:n,isInRange:a,isHoverEnd:d}=(e=>{const t=M&&l(e,M),r=T&&l(e,T),n="end"===W&&P?P:T;let i=!1;if(M&&n){const[t,r]=M<=n?[M,n]:[n,M];i=((e,t,r)=>{const n=e.getTime();return n>t.getTime()&&n<r.getTime()})(e,t,r)}return{isStart:t,isEnd:r,isInRange:i,isHoverEnd:"end"===W&&P&&l(e,P)}})(e),x=l(e,E);return(0,s.jsx)(C,{$isStart:!!r,$isEnd:!!n,$isInRange:a,$isHoverEnd:!!d,$isToday:x,onClick:()=>(e=>{if("start"===W)O(e),I(null),Y("end");else{let t=M,r=e;r<t&&([t,r]=[r,t]),O(t),I(r),Y("start"),i(o(t),o(r)),setTimeout(S,200)}})(e),onMouseEnter:()=>L(e),onMouseLeave:()=>L(null),children:e.getDate()},e.getTime())})})]})},K=11===$?0:$+1,U=11===$?B+1:B,V=e=>{const t=new Date;let r;const n=t;switch(e){case"this_week":r=new Date(t),r.setDate(t.getDate()-t.getDay());break;case"this_month":r=new Date(t.getFullYear(),t.getMonth(),1);break;case"this_year":r=new Date(t.getFullYear(),0,1);break;default:return}O(r),I(n),Y("start"),i(o(r),o(n)),setTimeout(S,150)};return D?(0,s.jsx)(c,{ref:N,children:(0,s.jsxs)(h,{children:[(0,s.jsxs)(p,{children:[(0,s.jsx)(u,{onClick:()=>V("this_week"),children:"This Week"}),(0,s.jsx)(u,{onClick:()=>V("this_month"),children:"This Month"}),(0,s.jsx)(u,{onClick:()=>V("this_year"),children:"This Year"})]}),(0,s.jsxs)(m,{children:[(0,s.jsxs)(g,{children:[(0,s.jsx)(y,{onClick:_,"aria-label":"Previous month",children:(0,s.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,s.jsx)("polyline",{points:"15 18 9 12 15 6"})})}),(0,s.jsx)(y,{onClick:q,"aria-label":"Next month",children:(0,s.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,s.jsx)("polyline",{points:"9 6 15 12 9 18"})})})]}),(0,s.jsxs)(f,{children:[H(B,$),(0,s.jsx)(j,{children:H(U,K)})]})]})]})}):null},D=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,E=(e,t)=>{const r=(e=>{if(!e)return new Date;try{const t=new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date),[r,n,i]=t.split("-").map(Number);return new Date(r,n-1,i)}catch{return new Date}})(t);let n=new Date(r);const i=new Date(r);switch(e){case"today":break;case"yesterday":n.setDate(r.getDate()-1),i.setDate(r.getDate()-1);break;case"week":n.setDate(r.getDate()-6);break;case"month":n.setDate(r.getDate()-29);break;case"year":n.setDate(r.getDate()-364);break;case"all":n=new Date(2020,0,1)}return{start:D(n),end:D(i)}},$=i.Ay.div`
  margin-bottom: 24px;
`,R=i.Ay.div`
  display: flex;
  gap: 8px;
