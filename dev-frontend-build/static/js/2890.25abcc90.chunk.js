"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[2890],{2488:(e,t,n)=>{n.d(t,{DO:()=>d,Jt:()=>c,Qn:()=>l});n(9950);var i=n(4752),r=n(4414);const s=i.Ay.div`
  display: flex;
  gap: 16px;
  margin-bottom: 24px;
  flex-wrap: wrap;
...
`,L=r.Ay.div`
  ...
  color: #6B7280;
  font-size: 14px;
`,W=()=>{const{user:e}=(0,a.As)(),{defaultCurrency:t}=(0,l.i1)(),n=t||"MYR",r=localStorage.getItem("auth_token"),[W,U]=(0,i.useState)([]),[Y,J]=(0,i.useState)(!0),[q,H]=(0,i.useState)(""),[K,Q]=(0,i.useState)("active"),[G,V]=(0,i.useState)(!1),[X,Z]=(0,i.useState)(""),[ee,te]=(0,i.useState)(!1),[ne,ie]=(0,i.useState)([]),[re,se]=(0,i.useState)(null),[ae,oe]=(0,i.useState)([]),[le,de]=(0,i.useState)([]),[ce,pe]=(0,i.useState)({restaurantId:"",restaurantName:"",adminName:"",planType:"basic",customPlanName:"",status:"trial",billingCycle:"monthly",autoRenew:!1,monthlyFee:29,startDate:(new Date).toISOString().split("T")[0],endDate:""}),[xe,he]=(0,i.useState)(!1),[ue,me]=(0,i.useState)(null),[ye,ge]=(0,i.useState)(!1),[je,ve]=(0,i.useState)(null),[be,fe]=(0,i.useState)(!1),[we,Fe]=(0,i.useState)(null),[Ce,Se]=(0,i.useState)(null),[Ae,Be]=(0,i.useState)(!1),[ke,Ee]=(0,i.useState)(""),[Te,De]=(0,i.useState)([]);(0,i.useEffect)(()=>{ze(),_e()},[]);const ze=(0,i.useCallback)(async()=>{J(!0);try{const e=r?{Authorization:`Bearer ${r}`}:{},t=await fetch("/api/restaurants",{headers:e});if(!t.ok)throw new Error("Failed to fetch restaurants");const n=await t.json(),i=Array.isArray(n)?n:[];oe(i);const s=i.map(e=>{var t,n,i;const r=(null===(t=e.plan_type)||void 0===t?void 0:t.toLowerCase().replace(" plan",""))||"basic";let s="active";"active"===e.status?s="active":"trial"===e.status?s="trial":"inactive"===e.status?s="suspended":"expired"===e.status?s="expired":"cancelled"===e.status&&(s="cancelled");const a={basic:50,professional:200,enterprise:-1};return{id:`sub-${e.id}`,restaurantId:(null===(n=e.id)||void 0===n?void 0:n.toString())||"",restaurantName:e.name||"Restaurant Name",adminId:(null===(i=e.managerId||e.admin_id)||void 0===i?void 0:i.toString())||"",adminName:e.managerName||e.admin_name||"No Admin Assigned",planType:r,status:s,startDate:e.subscription_start?new Date(e.subscription_start).toISOString().split("T")[0]:"2024-01-01",endDate:e.subscription_end?new Date(e.subscription_end).toISOString().split("T")[0]:new Date(Date.now()+31536e6).toISOString().split("T")[0],monthlyFee:parseFloat(e.plan_amount)||29,billingCycle:e.billing_cycle||"monthly",menuItemLimit:e.menu_item_limit||a[r]||50,currentMenuItems:Math.floor(Math.random()*((e.menu_item_limit||a[r]||50)>0?.7*(e.menu_item_limit||a[r]||50):150))+10,autoRenew:void 0!==e.auto_renew?e.auto_renew:"active"===s,location:e.address||"Location not specified",email:e.email||"",phone:e.phone||""}});U(s)}catch(e){console.error("Error fetching subscriptions:",e),U([])}finally{J(!1)}},[r]),_e=async()=>{try{const e=await fetch("/api/plans");if(e.ok){const t=await e.json(),n=Array.isArray(t)?t.filter(e=>e.is_active):[];de(n);const i=n.filter(e=>"custom"===e.category);De(i)}}catch(e){console.error("Error fetching plans:",e)}},Ne=W.filter(e=>{const t=e.restaurantName.toLowerCase().includes(q.toLowerCase())||e.adminName.toLowerCase().includes(q.toLowerCase())||e.location.toLowerCase().includes(q.toLowerCase()),n="all"===K||e.status===K;return t&&n}),Ie=W.length,Pe=W.filter(e=>"active"===e.status).length,Me=W.filter(e=>"trial"===e.status).length,$e=W.filter(e=>"active"===e.status).reduce((e,t)=>e+t.monthlyFee,0),Re=e=>{if(Z(e),te(!0),e.length<1)return void ie(ae.slice(0,10));const t=ae.filter(t=>t.name&&t.name.toLowerCase().includes(e.toLowerCase())||t.address&&t.address.toLowerCase().includes(e.toLowerCase()));ie(t.slice(0,10))};return(0,x.jsx)(s.A,{children:(0,x.jsxs)(p.mc,{children:[(0,x.jsxs)(p.Y9,{children:[(0,x.jsx)(p.hE,{children:"Subscriptions"}),(0,x.jsxs)(p.ex,{children:[(0,x.jsx)(d.cc,{variant:"outline",onClick:()=>{const e=(e=>{if(0===e.length)return"";const t=Object.keys(e[0]);return[t.join(","),...e.map(e=>t.map(t=>{const n=e[t];return"string"===typeof n&&(n.includes(",")||n.includes('"')||n.includes("\n"))?`"${n.replace(/"/g,'""')}"`:n||""}).join(","))].join("\n")})(Ne.map(e=>({"Tenant Info":`${e.restaurantName} - ${e.adminName}`,Plan:e.planType,Status:e.status,"Menu Items":`${e.currentMenuItems}/${e.menuItemLimit}`,"Monthly Fee":(0,o.vv)(e.monthlyFee,n),"Next Payment":e.endDate||"N/A",Location:e.location,Admin:e.adminName}))),t=new Blob([e],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(t),r=document.createElement("a");r.href=i,r.download=`foodcourt-subscriptions-${(new Date).toISOString().split("T")[0]}.csv`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)},children:"Export"}),(0,x.jsx)(d.cc,{variant:"primary",onClick:()=>{const e=le.filter(e=>"restaurant"===e.plan_target),t=e.length>0?e[0]:null;pe({restaurantId:"",restaurantName:"",adminName:"",planType:t?t.display_name:"basic",customPlanName:"",status:"trial",billingCycle:"monthly",autoRenew:!1,monthlyFee:t?parseFloat(t.base_price_monthly):29,startDate:(new Date).toISOString().split("T")[0],endDate:""}),se(null),Z(""),V(!0)},children:"Add Subscription"})]})]}),(0,x.jsxs)(p.UC,{children:[(0,x.jsxs)(p.MD,{children:[(0,x.jsxs)(p.hI,{color:"#059669",children:[(0,x.jsx)(p.Os,{children:Ie}),(0,x.jsx)(p.v0,{children:"Total Subscriptions"}),(0,x.jsx)(p.d1,{children:"Across all tenants"})]}),(0,x.jsxs)(p.hI,{color:"#2563EB",children:[(0,x.jsx)(p.Os,{children:Pe}),(0,x.jsx)(p.v0,{children:"Active Subscriptions"}),(0,x.jsxs)(p.d1,{children:[Ie>0?Math.round(Pe/Ie*100):0,"% operational"]})]}),(0,x.jsxs)(p.hI,{color:"#7C3AED",children:[(0,x.jsx)(p.Os,{children:Me}),(0,x.jsx)(p.v0,{children:"Trial Subscriptions"}),(0,x.jsx)(p.d1,{children:"Currently evaluating"})]}),(0,x.jsxs)(p.hI,{color:"#D97706",children:[(0,x.jsx)(p.Os,{children:(0,o.vv)($e,n)}),(0,x.jsx)(p.v0,{children:"Monthly Revenue"}),(0,x.jsx)(p.d1,{children:"From active subscriptions"})]})]}),(0,x.jsxs)(c.Qn,{children:[(0,x.jsx)(c.DO,{placeholder:"Search subscriptions...",value:q,onChange:e=>H(e.target.value)}),(0,x.jsxs)(c.Jt,{value:K,onChange:e=>Q(e.target.value),children:[(0,x.jsx)("option",{value:"all",children:"All Status"}),(0,x.jsx)("option",{value:"active",children:"Active"}),(0,x.jsx)("option",{value:"trial",children:"Trial"}),(0,x.jsx)("option",{value:"expired",children:"Expired"}),(0,x.jsx)("option",{value:"suspended",children:"Suspended"}),(0,x.jsx)("option",{value:"cancelled",children:"Cancelled"})]})]}),Y?(0,x.jsx)(L,{children:"Loading subscription data..."}):0===Ne.length?(0,x.jsxs)(M,{children:[(0,x.jsx)($,{children:"\ud83c\udfea"}),(0,x.jsx)(R,{children:0===W.length?"No Subscriptions":"No Results"}),(0,x.jsx)(O,{children:0===W.length?"No tenants are assigned to this foodcourt yet.":"No subscriptions match your search criteria."})]}):(0,x.jsxs)(p.XI,{children:[(0,x.jsxs)(h,{columns:"2.5fr 1fr 1fr 1.2fr 1fr 1fr 1fr 220px",children:[(0,x.jsx)("span",{children:"Tenant Info"}),(0,x.jsx)("span",{children:"Plan"}),(0,x.jsx)("span",{children:"Status"}),(0,x.jsx)("span",{children:"Menu Items"}),(0,x.jsx)("span",{children:"Monthly Fee"}),(0,x.jsx)("span",{children:"Expires In"}),(0,x.jsx)("span",{children:"Auto-Renew"}),(0,x.jsx)("span",{children:"Actions"})]}),Ne.map(e=>(0,x.jsxs)(u,{columns:"2.5fr 1fr 1fr 1.2fr 1fr 1fr 1fr 220px",children:[(0,x.jsxs)(p.Np,{children:[(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Tenant Info"}),(0,x.jsxs)(m,{children:[(0,x.jsx)(y,{children:e.restaurantName}),(0,x.jsxs)(g,{children:[e.adminName," \u2022 ",e.location]})]})]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Plan"}),(0,x.jsx)(v,{planType:e.planType,children:e.planType.charAt(0).toUpperCase()+e.planType.slice(1)})]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Status"}),(0,x.jsx)(j,{status:e.status,children:e.status.charAt(0).toUpperCase()+e.status.slice(1)})]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Menu Items"}),e.currentMenuItems,"/",-1===e.menuItemLimit?"\u221e":e.menuItemLimit]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Monthly Fee"}),(0,o.vv)(e.monthlyFee,n)]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Expires In"}),(()=>{const t=new Date,n=new Date(e.endDate).getTime()-t.getTime(),i=Math.ceil(n/864e5);return i<0?(0,x.jsx)("span",{style:{color:"#DC2626",fontWeight:"500"},children:"Expired"}):0===i?(0,x.jsx)("span",{style:{color:"#DC2626",fontWeight:"500"},children:"Today"}):i<=7?(0,x.jsxs)("span",{style:{color:"#F59E0B",fontWeight:"500"},children:[i," days"]}):i<=30?(0,x.jsxs)("span",{style:{color:"#10B981",fontWeight:"500"},children:[i," days"]}):(0,x.jsxs)("span",{style:{color:"#6B7280"},children:[i," days"]})})()]}),(0,x.jsxs)(p.Uj,{children:[(0,x.jsx)(p.PM,{children:"Auto-Renew"}),e.autoRenew?(0,x.jsx)("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 8px",background:"#DCFCE7",color:"#15803D",borderRadius:"6px",fontSize:"12px",fontWeight:"500"},children:"\u2713 Auto"}):(0,x.jsx)("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 8px",background:"#FEF3C7",color:"#92400E",borderRadius:"6px",fontSize:"12px",fontWeight:"500"},children:"Manual"})]})]}),(0,x.jsxs)(p.wr,{children:[(0,x.jsx)(p.rA,{onClick:()=>{ve(e),ge(!0)},children:"View"}),"basic"!==e.planType&&"professional"!==e.planType&&"enterprise"!==e.planType&&(0,x.jsx)(p.rA,{onClick:()=>(e=>{me(e),he(!0)})(e),children:"Edit"}),(0,x.jsx)(p.K0,{onClick:()=>(e=>{Fe(e),Se("active"===e.status?"suspend":"activate"),fe(!0)})(e),title:"active"===e.status?"Suspend Subscription":"Activate Subscription",children:(0,x.jsx)(b,{children:"active"===e.status?"\u2297":"\u25c9"})}),(0,x.jsx)(p.K0,{onClick:()=>(e=>{Fe(e),Se("delete"),fe(!0)})(e),title:"Delete Subscription",children:(0,x.jsx)(b,{children:"\u2715"})})]})]},e.id))]}),G&&(0,x.jsx)(f,{show:G,onClick:()=>V(!1),children:(0,x.jsxs)(w,{onClick:e=>e.stopPropagation(),children:[(0,x.jsxs)(F,{children:[(0,x.jsx)(C,{children:"Add Subscription"}),(0,x.jsx)(S,{onClick:()=>V(!1),children:"\xd7"})]}),(0,x.jsx)(T,{children:(0,x.jsxs)(z,{children:[(0,x.jsxs)(_,{style:{gridColumn:"1 / -1",position:"relative",zIndex:100},children:[(0,x.jsx)(N,{children:"Search Tenant *"}),(0,x.jsxs)("div",{style:{position:"relative",width:"100%"},children:[(0,x.jsx)(I,{type:"text",value:X,onChange:e=>Re(e.target.value),onFocus:()=>{te(!0),X.length<1&&Re("")},onBlur:()=>setTimeout(()=>te(!1),200),placeholder:"Click to search tenants...",required:!0}),ee&&(0,x.jsxs)("div",{style:{position:"absolute",top:"calc(100% + 4px)",left:0,right:0,background:"white",border:"1px solid #E6EBF1",borderRadius:"8px",maxHeight:"300px",overflowY:"auto",zIndex:9999,boxShadow:"0 8px 16px rgba(0, 0, 0, 0.15)"},children:[(0,x.jsx)("div",{style:{padding:"8px 12px",background:"#F8FAFC",fontSize:"12px",fontWeight:"600",color:"#6B7280"},children:"TENANTS"}),ne.map(e=>(0,x.jsxs)("div",{onClick:()=>(e=>{var t;se(e),te(!1),Z(e.name),pe({...ce,restaurantId:(null===(t=e.id)||void 0===t?void 0:t.toString())||"",restaurantName:e.name||"",adminName:e.admin_name||e.managerName||"No Admin Assigned"})})(e),style:{padding:"12px",cursor:"pointer",borderBottom:"1px solid #F3F4F6",transition:"background 0.2s"},onMouseEnter:e=>e.currentTarget.style.background="#F8FAFC",onMouseLeave:e=>e.currentTarget.style.background="white",children:[(0,x.jsx)("div",{style:{fontWeight:"500",color:"#0A2540"},children:e.name}),(0,x.jsxs)("div",{style:{fontSize:"13px",color:"#6B7280"},children:["Admin: ",e.admin?`${e.admin.name} (${e.admin.email})`:e.admin_name||"No Admin"]})]},e.id))]})]}),re&&(0,x.jsxs)("div",{style:{marginTop:"8px",padding:"12px",background:"#F0F7FF",border:"1px solid #B3D9FF",borderRadius:"8px",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontWeight:"500",color:"#0A2540"},children:re.name}),(0,x.jsxs)("div",{style:{fontSize:"13px",color:"#6B7280"},children:[re.admin?`Admin: ${re.admin.name}`:"No Admin"," \u2022 ",re.address||"No address"]})]}),(0,x.jsx)("button",{onClick:()=>{se(null),Z("")},style:{background:"none",border:"none",color:"#6B7280",cursor:"pointer",fontSize:"18px",lineHeight:"1",padding:"4px"},title:"Remove selection",children:"\xd7"})]})]}),(0,x.jsxs)(_,{style:{gridColumn:"1 / -1"},children:[(0,x.jsx)(N,{children:"Subscription Plan *"}),(0,x.jsxs)(P,{value:ce.customPlanName||"",onChange:e=>{const t=e.target.value;if("others"===t)pe({...ce,planType:"custom",customPlanName:"others",monthlyFee:0});else if(t){const e=le.find(e=>e.display_name===t);pe({...ce,planType:"custom",customPlanName:t,monthlyFee:parseFloat(null===e||void 0===e?void 0:e.base_price_monthly)||0})}else pe({...ce,planType:"custom",customPlanName:"",monthlyFee:0})},children:[(0,x.jsx)("option",{value:"",children:"Select Plan"}),le.filter(e=>"restaurant"===e.plan_target).map(e=>(0,x.jsxs)("option",{value:e.display_name,children:[e.display_name," - ",(0,o.vv)(parseFloat(e.base_price_monthly),n)]},e.id)),(0,x.jsx)("option",{value:"others",children:"Others"})]})]}),"others"===ce.customPlanName&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(_,{style:{gridColumn:"1 / -1"},children:[(0,x.jsx)(N,{children:"Custom Plan Name *"}),(0,x.jsx)(I,{type:"text",value:"",onChange:e=>pe({...ce,customPlanName:e.target.value}),placeholder:"Enter custom plan name",required:!0})]}),(0,x.jsxs)(_,{children:[(0,x.jsxs)(N,{children:["Monthly Fee (",n,") *"]}),(0,x.jsx)(I,{type:"number",step:"0.01",min:"0",value:ce.monthlyFee,onChange:e=>pe({...ce,monthlyFee:parseFloat(e.target.value)||0}),placeholder:"0.00",required:!0})]})]}),(0,x.jsx)(_,{style:{gridColumn:"1 / -1"},children:(0,x.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"16px 20px",background:"trial"===ce.status?"#F0EFFF":"#F9FAFB",borderRadius:"12px",border:"trial"===ce.status?"2px solid #635BFF":"2px solid #E5E7EB",cursor:"pointer",transition:"all 0.2s"},children:[(0,x.jsx)("input",{type:"checkbox",checked:"trial"===ce.status,onChange:e=>{if(e.target.checked){const e=new Date,t=new Date;t.setDate(t.getDate()+7),pe({...ce,status:"trial",startDate:e.toISOString().split("T")[0],endDate:t.toISOString().split("T")[0],monthlyFee:0})}else pe({...ce,status:"active",monthlyFee:29})},style:{width:"20px",height:"20px",accentColor:"#635BFF",cursor:"pointer"}}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontWeight:"600",color:"#1F2937",fontSize:"15px"},children:"Apply 7-Day Free Trial"}),(0,x.jsx)("div",{style:{fontSize:"13px",color:"#6B7280",marginTop:"2px"},children:"Subscription will start with a 7-day free trial period"})]})]})}),(0,x.jsx)("div",{style:{gridColumn:"1 / -1",marginTop:"20px",marginBottom:"10px"},children:(0,x.jsx)("h3",{style:{margin:0,fontSize:"18px",fontWeight:"600",color:"#0A2540",borderBottom:"2px solid #635BFF",paddingBottom:"8px"},children:"Subscription Settings"})}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Billing Cycle *"}),(0,x.jsxs)(P,{value:ce.billingCycle||"monthly",onChange:e=>{const t=e.target.value,n={basic:{monthly:29,annual:290},professional:{monthly:99,annual:990},enterprise:{monthly:199,annual:2190}},i=n[ce.planType]||n.basic;pe({...ce,billingCycle:t,monthlyFee:i[t]})},children:[(0,x.jsx)("option",{value:"monthly",children:"Monthly"}),(0,x.jsx)("option",{value:"annual",children:"Annual (10% discount)"})]})]}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Subscription Start Date *"}),(0,x.jsx)(I,{type:"date",value:ce.startDate,onChange:e=>pe({...ce,startDate:e.target.value})})]}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Subscription End Date *"}),(0,x.jsx)(I,{type:"date",value:ce.endDate,onChange:e=>pe({...ce,endDate:e.target.value})})]}),(0,x.jsx)(_,{style:{gridColumn:"1 / -1"},children:(0,x.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer"},children:[(0,x.jsx)("input",{type:"checkbox",checked:ce.autoRenew||!1,onChange:e=>pe({...ce,autoRenew:e.target.checked}),style:{width:"16px",height:"16px"}}),(0,x.jsx)("span",{style:{fontSize:"14px",color:"#374151"},children:"Auto-renew subscription"})]})}),(0,x.jsxs)("div",{style:{gridColumn:"1 / -1",padding:"16px",background:"#F3F4F6",borderRadius:"8px",marginTop:"10px"},children:[(0,x.jsx)("div",{style:{fontSize:"14px",color:"#6B7280",marginBottom:"8px"},children:(0,x.jsx)("strong",{children:"Summary:"})}),(0,x.jsxs)("div",{style:{fontSize:"16px",fontWeight:"600",color:"#0A2540"},children:[ce.customPlanName||"Custom Plan"," - ",(0,o.vv)(ce.monthlyFee||29,n)," (",ce.billingCycle||"monthly",")"]}),(0,x.jsxs)("div",{style:{fontSize:"12px",color:"#6B7280",marginTop:"4px"},children:["Paid by: ",re?`${re.name} (Foodcourt General Manager)`:"Not selected"]})]})]})}),(0,x.jsxs)(D,{children:[(0,x.jsx)(d.cc,{variant:"cancel",onClick:()=>V(!1),children:"Cancel"}),(0,x.jsx)(d.cc,{variant:"primary",onClick:async()=>{try{if(!re)return;const e={plan_type:ce.customPlanName||"Custom Plan",plan_amount:ce.monthlyFee,billing_cycle:ce.billingCycle,subscription_start:ce.startDate,subscription_end:ce.endDate,status:"trial"===ce.status?"trial":"active",auto_renew:ce.autoRenew};if(!(await fetch(`/api/restaurants/${re.id}`,{method:"PUT",headers:{"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{}},body:JSON.stringify(e)})).ok)throw new Error("Failed to update restaurant subscription");const t=ce.customPlanName||"Custom Plan",i=new Date(new Date(ce.startDate).getTime()+12096e5).toISOString().split("T")[0],s={invoice_data:{restaurant_id:re.id,due_date:i,total_amount:ce.monthlyFee,currency:n||"MYR",status:"pending_payment",type:"manual",issuer_type:"system_admin",issuer_id:null,payer_type:"restaurant",payer_id:re.admin_id||null,invoice_category:"subscription",category_display_name:`Subscription - ${t}`,billing_period_start:ce.startDate,billing_period_end:ce.endDate||i,notes:`POS Subscription: ${t} (${ce.billingCycle})`},items:[{item_type:"subscription",description:`${t} - ${"annual"===ce.billingCycle?"Annual":"Monthly"} Subscription`,calculation_method:"fixed",fixed_amount:ce.monthlyFee,calculated_amount:ce.monthlyFee,tax_rate:0,tax_amount:0,total_amount:ce.monthlyFee}]},a=await fetch("/api/invoices",{method:"POST",headers:{"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{}},body:JSON.stringify(s)});if(!a.ok){const e=await a.json().catch(()=>({error:"Unknown error"}));throw new Error(e.error||"Failed to create invoice")}V(!1),Ee("Subscription added and invoice generated successfully!"),Be(!0),await ze()}catch(e){console.error("Error adding subscription:",e)}},children:"Add Subscription"})]})]})}),Ae&&(0,x.jsx)(f,{show:Ae,onClick:()=>Be(!1),children:(0,x.jsxs)(A,{onClick:e=>e.stopPropagation(),children:[(0,x.jsx)(B,{children:"\u2713"}),(0,x.jsx)(k,{children:"Success!"}),(0,x.jsx)(E,{children:ke}),(0,x.jsx)(d.cc,{variant:"primary",onClick:()=>Be(!1),children:"OK"})]})}),xe&&ue&&(0,x.jsx)(f,{show:xe,onClick:()=>he(!1),children:(0,x.jsxs)(w,{onClick:e=>e.stopPropagation(),children:[(0,x.jsxs)(F,{children:[(0,x.jsx)(C,{children:"Edit Custom Subscription"}),(0,x.jsx)(S,{onClick:()=>he(!1),children:"\xd7"})]}),(0,x.jsx)(T,{children:(0,x.jsxs)(z,{children:[(0,x.jsxs)(_,{style:{gridColumn:"1 / -1"},children:[(0,x.jsx)(N,{children:"Tenant *"}),(0,x.jsx)(I,{type:"text",value:ue.restaurantName,disabled:!0,style:{background:"#F8FAFC",cursor:"not-allowed"}})]}),(0,x.jsxs)(_,{style:{gridColumn:"1 / -1"},children:[(0,x.jsx)(N,{children:"Custom Subscription Plan *"}),(0,x.jsxs)(P,{value:ue.planType,onChange:e=>{const t=e.target.value;if("others"===t)me({...ue,planType:"custom",monthlyFee:0});else if(t){const e=Te.find(e=>e.name===t);me({...ue,planType:t,monthlyFee:(null===e||void 0===e?void 0:e.monthly_price)||0})}},children:[(0,x.jsx)("option",{value:"",children:"Select Plan"}),Te.map(e=>(0,x.jsxs)("option",{value:e.name,children:[e.display_name," - ",(0,o.vv)(e.monthly_price,n)]},e.id)),(0,x.jsx)("option",{value:"others",children:"Others"})]})]}),"others"===ue.planType&&(0,x.jsxs)(_,{style:{gridColumn:"1 / -1"},children:[(0,x.jsx)(N,{children:"Custom Plan Name *"}),(0,x.jsx)(I,{type:"text",value:"",onChange:e=>me({...ue,planType:e.target.value}),placeholder:"Enter custom plan name",required:!0})]}),(0,x.jsxs)(_,{children:[(0,x.jsxs)(N,{children:["Monthly Fee (",n,") *"]}),(0,x.jsx)(I,{type:"number",step:"0.01",min:"0",value:ue.monthlyFee,onChange:e=>me({...ue,monthlyFee:parseFloat(e.target.value)||0}),placeholder:"0.00",required:!0})]}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Status *"}),(0,x.jsxs)(P,{value:ue.status,onChange:e=>me({...ue,status:e.target.value}),children:[(0,x.jsx)("option",{value:"trial",children:"Trial"}),(0,x.jsx)("option",{value:"active",children:"Active"}),(0,x.jsx)("option",{value:"suspended",children:"Suspended"}),(0,x.jsx)("option",{value:"expired",children:"Expired"}),(0,x.jsx)("option",{value:"cancelled",children:"Cancelled"})]})]}),(0,x.jsx)("div",{style:{gridColumn:"1 / -1",marginTop:"20px",marginBottom:"10px"},children:(0,x.jsx)("h3",{style:{margin:0,fontSize:"18px",fontWeight:"600",color:"#0A2540",borderBottom:"2px solid #635BFF",paddingBottom:"8px"},children:"Subscription Settings"})}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Billing Cycle *"}),(0,x.jsxs)(P,{value:ue.billingCycle||"monthly",onChange:e=>me({...ue,billingCycle:e.target.value}),children:[(0,x.jsx)("option",{value:"monthly",children:"Monthly"}),(0,x.jsx)("option",{value:"annual",children:"Annual (10% discount)"})]})]}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Subscription Start Date *"}),(0,x.jsx)(I,{type:"date",value:ue.startDate,onChange:e=>me({...ue,startDate:e.target.value})})]}),(0,x.jsxs)(_,{children:[(0,x.jsx)(N,{children:"Subscription End Date *"}),(0,x.jsx)(I,{type:"date",value:ue.endDate,onChange:e=>me({...ue,endDate:e.target.value})})]}),(0,x.jsx)(_,{style:{gridColumn:"1 / -1"},children:(0,x.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer"},children:[(0,x.jsx)("input",{type:"checkbox",checked:ue.autoRenew||!1,onChange:e=>me({...ue,autoRenew:e.target.checked}),style:{width:"16px",height:"16px"}}),(0,x.jsx)("span",{style:{fontSize:"14px",color:"#374151"},children:"Auto-renew subscription"})]})})]})}),(0,x.jsxs)(D,{children:[(0,x.jsx)(d.cc,{variant:"cancel",onClick:()=>he(!1),children:"Cancel"}),(0,x.jsx)(d.cc,{variant:"primary",onClick:async()=>{if(ue)try{const e={name:ue.restaurantName,planType:"basic"===ue.planType?"Basic Plan":"professional"===ue.planType?"Professional Plan":"enterprise"===ue.planType?"Enterprise Plan":ue.planType,planAmount:ue.monthlyFee,status:"active"===ue.status?"active":"inactive",subscriptionStart:ue.startDate,subscriptionEnd:ue.endDate},t=await fetch(`/api/restaurants/${ue.restaurantId}`,{method:"PUT",headers:{"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{}},body:JSON.stringify(e)});if(t.ok)he(!1),me(null),await ze(),Ee("Subscription updated successfully!"),Be(!0);else{const e=await t.json().catch(()=>({error:"Unknown error"}));console.error("Failed to update subscription:",e)}}catch(e){console.error("Error updating subscription:",e)}},children:"Update Subscription"})]})]})}),ye&&je&&(0,x.jsx)(f,{show:ye,onClick:()=>ge(!1),children:(0,x.jsxs)(w,{onClick:e=>e.stopPropagation(),children:[(0,x.jsxs)(F,{children:[(0,x.jsx)(C,{children:"Subscription Details"}),(0,x.jsx)(S,{onClick:()=>ge(!1),children:"\xd7"})]}),(0,x.jsx)(T,{children:(0,x.jsxs)("div",{style:{display:"grid",gap:"20px"},children:[(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",fontWeight:"600",marginBottom:"8px",textTransform:"uppercase"},children:"Tenant Information"}),(0,x.jsxs)("div",{style:{background:"#F8FAFC",padding:"16px",borderRadius:"8px",border:"1px solid #E6EBF1"},children:[(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Tenant Name"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.restaurantName})]}),(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Admin"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.adminName})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Location"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.location})]})]})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",fontWeight:"600",marginBottom:"8px",textTransform:"uppercase"},children:"Subscription Details"}),(0,x.jsxs)("div",{style:{background:"#F8FAFC",padding:"16px",borderRadius:"8px",border:"1px solid #E6EBF1"},children:[(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Plan Type"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.planType.charAt(0).toUpperCase()+je.planType.slice(1)})]}),(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Status"}),(0,x.jsx)("div",{children:(0,x.jsx)("span",{style:{display:"inline-block",padding:"4px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"500",background:"active"===je.status?"#DCFCE7":"#FEF3C7",color:"active"===je.status?"#15803D":"#92400E"},children:je.status.charAt(0).toUpperCase()+je.status.slice(1)})})]}),(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Monthly Fee"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:(0,o.vv)(je.monthlyFee,n)})]}),(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Billing Cycle"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.billingCycle.charAt(0).toUpperCase()+je.billingCycle.slice(1)})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Auto-Renew"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.autoRenew?(0,x.jsx)("span",{style:{color:"#15803D"},children:"\u2713 Enabled"}):(0,x.jsx)("span",{style:{color:"#92400E"},children:"\u2715 Disabled"})})]})]})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",fontWeight:"600",marginBottom:"8px",textTransform:"uppercase"},children:"Dates"}),(0,x.jsxs)("div",{style:{background:"#F8FAFC",padding:"16px",borderRadius:"8px",border:"1px solid #E6EBF1"},children:[(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Start Date"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.startDate})]}),(0,x.jsxs)("div",{style:{marginBottom:"12px"},children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"End Date"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:je.endDate})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Expires In"}),(0,x.jsx)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:(()=>{const e=new Date,t=new Date(je.endDate).getTime()-e.getTime(),n=Math.ceil(t/864e5);return n<0?(0,x.jsx)("span",{style:{color:"#DC2626"},children:"Expired"}):0===n?(0,x.jsx)("span",{style:{color:"#DC2626"},children:"Today"}):n<=7?(0,x.jsxs)("span",{style:{color:"#F59E0B"},children:[n," days"]}):n<=30?(0,x.jsxs)("span",{style:{color:"#10B981"},children:[n," days"]}):(0,x.jsxs)("span",{style:{color:"#6B7280"},children:[n," days"]})})()})]})]})]}),(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",fontWeight:"600",marginBottom:"8px",textTransform:"uppercase"},children:"Usage"}),(0,x.jsx)("div",{style:{background:"#F8FAFC",padding:"16px",borderRadius:"8px",border:"1px solid #E6EBF1"},children:(0,x.jsxs)("div",{children:[(0,x.jsx)("div",{style:{fontSize:"12px",color:"#6B7280",marginBottom:"4px"},children:"Menu Items"}),(0,x.jsxs)("div",{style:{fontSize:"14px",fontWeight:"500",color:"#0A2540"},children:[je.currentMenuItems," / ",-1===je.menuItemLimit?"\u221e":je.menuItemLimit]})]})})]})]})}),(0,x.jsx)(D,{children:(0,x.jsx)(d.cc,{variant:"primary",onClick:()=>ge(!1),children:"Close"})})]})}),be&&(0,x.jsx)(f,{show:be,onClick:()=>fe(!1),children:(0,x.jsxs)(w,{onClick:e=>e.stopPropagation(),children:[(0,x.jsxs)(F,{children:[(0,x.jsx)(C,{children:"Confirm Action"}),(0,x.jsx)(S,{onClick:()=>fe(!1),children:"\xd7"})]}),(0,x.jsx)(T,{children:(0,x.jsxs)("p",{children:["delete"===Ce&&`Are you sure you want to delete subscription for ${null===we||void 0===we?void 0:we.restaurantName}?`,"suspend"===Ce&&`Are you sure you want to suspend subscription for ${null===we||void 0===we?void 0:we.restaurantName}?`,"activate"===Ce&&`Are you sure you want to activate subscription for ${null===we||void 0===we?void 0:we.restaurantName}?`]})}),(0,x.jsxs)(D,{children:[(0,x.jsx)(d.cc,{variant:"cancel",onClick:()=>fe(!1),children:"Cancel"}),(0,x.jsx)(d.cc,{variant:"delete"===Ce?"danger":"primary",onClick:async()=>{if(we&&Ce){try{const e={"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{}};if("delete"===Ce){if(!(await fetch(`/api/restaurants/${we.restaurantId}`,{method:"DELETE",headers:e})).ok)throw new Error("Failed to delete subscription");Ee("Subscription deleted successfully")}else if("suspend"===Ce){if(!(await fetch(`/api/restaurants/${we.restaurantId}`,{method:"PUT",headers:e,body:JSON.stringify({status:"inactive"})})).ok)throw new Error("Failed to suspend subscription");Ee("Subscription suspended successfully")}else if("activate"===Ce){if(!(await fetch(`/api/restaurants/${we.restaurantId}`,{method:"PUT",headers:e,body:JSON.stringify({status:"active"})})).ok)throw new Error("Failed to activate subscription");Ee("Subscription activated successfully")}Be(!0),await ze()}catch(e){console.error("Action failed:",e)}fe(!1),Fe(null),Se(null)}},children:"delete"===Ce?"Delete":"suspend"===Ce?"Suspend":"Activate"})]})]})})]})]})})}},3705:(e,t,n)=>{n.d(t,{cc:()=>r});var i=n(4752);const r=i.Ay.button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
