...
`},4021:(e,n,t)=>{t.d(n,{i1:()=>s});var r=t(9950),o=t(1367),a=t(6038),i=t(9955);const s=()=>{const{user:e}=(0,o.As)(),[n,t]=(0,r.useState)("RM"),[s]=(0,r.useState)(Object.keys(a.DL)),[c,l]=(0,r.useState)(!0),[d,p]=(0,r.useState)(null);return(0,r.useEffect)(()=>{(async()=>{const n=window.location.pathname.split("/"),r=n.indexOf("restaurant");let o=r>=0?n[r+1]:null;if(!o&&null!==e&&void 0!==e&&e.restaurant_id&&(o=e.restaurant_id.toString()),!o)return t("RM"),void l(!1);try{const e=(0,i.c4)(),n=await fetch(`/api/restaurants/${o}`,{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"}});if(n.ok){var a;const e=await n.json(),r=e.currency||(null===(a=e.operation_settings)||void 0===a?void 0:a.currency)||"MYR";t(r)}else t("MYR")}catch(s){console.error("Failed to fetch restaurant currency:",s),p("Failed to load currency settings"),t("MYR")}finally{l(!1)}})()},[null===e||void 0===e?void 0:e.restaurant_id]),{defaultCurrency:n,supportedCurrencies:s,loading:c,error:d}}},7617:(e,n,t)=>{t.d(n,{A:()=>x});t(9950);var r=t(7119),o=t(4752),a=t(9610),i=t(4414);const s=o.Ay.div`
  background: white;
  border-radius: 12px;
