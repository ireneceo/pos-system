...
`,f=r.Ay.span`
  ...
  font-size: 12px;
  font-weight: 700;
`,v=(0,i.forwardRef)((e,n)=>{let{children:t,onSave:r,type:a="input",debounceMs:o=2e3,style:l}=e;const[c,v]=(0,i.useState)("idle"),[b,j]=(0,i.useState)(!1),w=(0,i.useRef)(null),F=(0,i.useRef)(null),A=(0,i.useRef)(null),_=(0,i.useRef)(!0),C=(0,i.useRef)(r);C.current=r;const S=(0,i.useCallback)(()=>{w.current&&clearTimeout(w.current),F.current&&clearTimeout(F.current),A.current&&clearTimeout(A.current)},[]),B=2e3!==o?o:"toggle"===a||"select"===a||"list"===a||"image"===a?300:o,k=(0,i.useCallback)(()=>{S(),j(!1),v("saving"),w.current=setTimeout(async()=>{if(_.current)try{if(await C.current(),!_.current)return;v("saved"),F.current=setTimeout(()=>{_.current&&(j(!0),A.current=setTimeout(()=>{_.current&&(v("idle"),j(!1))},300))},2e3)}catch{if(!_.current)return;v("error"),F.current=setTimeout(()=>{_.current&&(j(!0),A.current=setTimeout(()=>{_.current&&(v("idle"),j(!1))},300))},4e3)}},B)},[B,S]);(0,i.useImperativeHandle)(n,()=>({triggerSave:k}),[k]),(0,i.useEffect)(()=>(_.current=!0,()=>{_.current=!1,S()}),[S]);const E=i.Children.map(t,e=>{if(!i.isValidElement(e))return e;const n=e.props.onChange;return"function"!==typeof n?e:i.cloneElement(e,{onChange:function(){n(...arguments),k()}})}),z="saving"===c?(0,s.jsx)(y,{}):"saved"===c?(0,s.jsx)(m,{children:"\u2713"}):"error"===c?(0,s.jsx)(f,{children:"!"}):null,P="select"===a?u:"toggle"===a?x:"image"===a?h:"list"===a?g:p;return(0,s.jsxs)(d,{$type:a,style:l,children:[E,"idle"!==c&&(0,s.jsx)(P,{$fading:b,children:z})]})});v.displayName="AutoSaveField";const b=v},9968:(e,n,t)=>{t.r(n),t.d(n,{default:()=>be});var i=t(9950),r=t(4752),s=t(5781),a=t(1367),o=t(9610),l=t(2597),d=t(2653),c=t(8666),p=t(8012),u=t(6038),x=t(5030),h=t(4414);const g=r.Ay.div`
  background: white;
  border-radius: 12px;
