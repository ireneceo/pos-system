...
`,o=e=>{let{children:t,className:r,style:i,...s}=e;return(0,n.jsx)(a,{className:r,style:i,...s,children:t})},d=e=>{let{placeholder:t="Search...",...r}=e;return(0,n.jsx)(s,{placeholder:t,...r})},c=e=>{let{children:t,...r}=e;return(0,n.jsx)(l,{...r,children:t})}},4021:(e,t,r)=>{r.d(t,{i1:()=>s});var i=r(9950),n=r(1367),a=r(6038);const s=()=>{const{user:e}=(0,n.As)(),[t,r]=(0,i.useState)("RM"),[s]=(0,i.useState)(Object.keys(a.DL)),[l,o]=(0,i.useState)(!0),[d,c]=(0,i.useState)(null);return(0,i.useEffect)(()=>{(async()=>{const t=window.location.pathname.split("/"),i=t.indexOf("restaurant");let n=i>=0?t[i+1]:null;if(!n&&null!==e&&void 0!==e&&e.restaurant_id&&(n=e.restaurant_id.toString()),!n)return r("RM"),void o(!1);try{const e=localStorage.getItem("auth_token"),t=await fetch(`/api/restaurants/${n}`,{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"}});if(t.ok){var a;const e=await t.json(),i=e.currency||(null===(a=e.operation_settings)||void 0===a?void 0:a.currency)||"RM";r(i)}else r("RM")}catch(s){console.error("Failed to fetch restaurant currency:",s),c("Failed to load currency settings"),r("RM")}finally{o(!1)}})()},[null===e||void 0===e?void 0:e.restaurant_id]),{defaultCurrency:t,supportedCurrencies:s,loading:l,error:d}}},7795:(e,t,r)=>{r.r(t),r.d(t,{default:()=>S});var i=r(9950),n=r(4752),a=r(2488),s=r(8409),l=r(4021),o=r(6038),d=r(4414);const c=n.Ay.div`
  min-height: 100vh;
  background: #FAFBFC;
`,x=n.Ay.div`
  background: white;
