"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[6814],{6814:(e,t,i)=>{i.r(t),i.d(t,{default:()=>ne});var r=i(9950),s=i(4752),n=i(3422),a=i(1367),o=i(8930),d=i(8012),p=i(8406),u=i(4414);const l=e=>{const t=new Date(e),i=new Date(t.getTime()+18e5),r=e=>{const t=e.getHours(),i=t>=12?"PM":"AM";return{time:`${t%12||12}:${e.getMinutes().toString().padStart(2,"0")}`,period:i}},s=r(t),n=r(i);return s.period===n.period?`${s.time} - ${n.time} ${n.period}`:`${s.time} ${s.period} - ${n.time} ${n.period}`},c=s.Ay.div`
  background: #F0F2F5;
  min-height: 100vh;
  color: #0A2540;
