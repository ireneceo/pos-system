...
`,T=e=>{let{entityType:r,entityId:t,currentUserId:n,onMarkRead:T}=e;const[$,D]=(0,i.useState)([]),[R,q]=(0,i.useState)(""),[P,O]=(0,i.useState)(!1),[L,M]=(0,i.useState)([]),[U,J]=(0,i.useState)(!1),[W,H]=(0,i.useState)(!1),K=(0,i.useRef)(null),Y=async()=>{try{const e=localStorage.getItem("auth_token"),i=await fetch(`/api/comments/${r}/${t}`,{headers:{Authorization:`Bearer ${e}`}});if(i.ok){const e=await i.json();e.success&&D(e.data)}}catch(e){console.error("Error fetching comments:",e)}};(0,i.useEffect)(()=>{t&&(Y(),(async()=>{try{const e=localStorage.getItem("auth_token");await fetch("/api/comments/mark-read",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:r,entity_id:t})}),T&&T()}catch(e){console.error("Error marking comments as read:",e)}})())},[r,t]);const G=async()=>{if(U)return;const e=R.trim(),i=L.length>0;if((e||i)&&!W){H(!0);try{const e=localStorage.getItem("auth_token");(await fetch("/api/comments",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:r,entity_id:t,content:R.trim(),attachments:i?L:void 0,is_internal:P||void 0})})).ok&&(q(""),M([]),O(!1),Y())}catch(n){console.error("Error adding comment:",n)}finally{H(!1)}}},Q=e=>{const r=new Date(e),t=(new Date).getTime()-r.getTime(),i=Math.floor(t/6e4);if(i<1)return"Just now";if(i<60)return`${i}m ago`;const n=Math.floor(i/60);if(n<24)return`${n}h ago`;const o=Math.floor(n/24);return o<7?`${o}d ago`:r.toLocaleDateString("en-US",{month:"short",day:"numeric"})};return(0,a.jsxs)(s,{children:[(0,a.jsxs)(l,{children:["Comments (",$.length,")"]}),$.length>0?(0,a.jsx)(d,{children:$.map(e=>{var r,t,i;return(0,a.jsxs)(c,{isInternal:e.is_internal,children:[(0,a.jsx)(p,{children:((null===(r=e.author)||void 0===r?void 0:r.full_name)||e.author_name||"?")[0].toUpperCase()}),(0,a.jsxs)(x,{children:[(0,a.jsxs)(h,{children:[(0,a.jsx)(u,{children:(null===(t=e.author)||void 0===t?void 0:t.full_name)||e.author_name}),(0,a.jsx)(g,{children:(null===(i=e.author)||void 0===i?void 0:i.role)||e.author_role}),e.is_internal&&(0,a.jsx)(m,{children:"Internal"}),(0,a.jsx)(y,{children:Q(e.createdAt)}),n&&e.author_id===n&&(0,a.jsx)(j,{onClick:()=>(async e=>{try{const r=localStorage.getItem("auth_token");(await fetch(`/api/comments/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${r}`}})).ok&&Y()}catch(r){console.error("Error deleting comment:",r)}})(e.id),children:"Delete"})]}),e.content&&(0,a.jsx)(f,{children:e.content}),e.attachments&&e.attachments.length>0&&(0,a.jsx)(o.A,{attachments:e.attachments})]})]},e.id)})}):(0,a.jsx)(E,{children:"No comments yet"}),(0,a.jsxs)(v,{children:[(0,a.jsxs)(b,{children:[(0,a.jsx)(A,{value:R,onChange:e=>q(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),G())},placeholder:P?"Write an internal note... (visible only to your role group)":"Add a comment... (Enter to send, Shift+Enter for newline)",rows:1}),(0,a.jsxs)(w,{children:[(0,a.jsx)(F,{onClick:()=>{var e;return null===(e=K.current)||void 0===e?void 0:e.click()},title:"Attach file",children:"\ud83d\udcce"}),(0,a.jsx)(k,{onClick:G,disabled:!R.trim()&&0===L.length||W||U,children:"Send"})]})]}),(0,a.jsx)(_,{children:(0,a.jsxs)(N,{children:[(0,a.jsx)("input",{type:"checkbox",checked:P,onChange:e=>O(e.target.checked)}),"Internal note (visible only to your role group)"]})}),(L.length>0||U)&&(0,a.jsxs)(C,{children:[U&&(0,a.jsx)(S,{children:"Uploading..."}),L.map((e,r)=>(0,a.jsxs)(B,{children:[e.originalName.length>20?e.originalName.slice(0,17)+"...":e.originalName,(0,a.jsx)(z,{onClick:()=>(e=>{const r=L[e],t=localStorage.getItem("auth_token");fetch("/api/upload/file",{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({url:r.url})}).catch(()=>{}),M(r=>r.filter((r,t)=>t!==e))})(r),children:"\u2715"})]},e.url))]})]}),(0,a.jsx)(I,{ref:K,type:"file",accept:".jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.xls,.xlsx,.zip",multiple:!0,onChange:async e=>{const r=e.target.files;if(!r||0===r.length)return;e.target.value="";const t=5-L.length,i=Array.from(r).slice(0,t);if(0!==i.length){J(!0);try{const e=new FormData;i.forEach(r=>e.append("files",r));const r=localStorage.getItem("auth_token"),t=await fetch("/api/upload/files",{method:"POST",headers:{Authorization:`Bearer ${r}`},body:e}),n=await t.json();n.success&&n.data&&M(e=>[...e,...n.data])}catch(n){console.error("File upload error:",n)}finally{J(!1)}}}})]})}}}]);