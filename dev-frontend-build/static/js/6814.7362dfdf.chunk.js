"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[6814],{6814:(e,t,i)=>{i.r(t),i.d(t,{default:()=>de});var n=i(9950),r=i(4752),s=i(3422),a=i(1367),o=i(8930),d=i(8012),p=i(8406),l=i(4414);const u=e=>{const t=new Date(e),i=new Date(t.getTime()+18e5),n=e=>{const t=e.getHours(),i=t>=12?"PM":"AM";return{time:`${t%12||12}:${e.getMinutes().toString().padStart(2,"0")}`,period:i}},r=n(t),s=n(i);return r.period===s.period?`${r.time} - ${s.time} ${s.period}`:`${r.time} ${r.period} - ${s.time} ${s.period}`},c=r.Ay.div`
  background: #F0F2F5;
  min-height: 100vh;
  color: #0A2540;
...
`,U=r.Ay.div`
  ...
  gap: 6px;
  margin-top: 8px;
`,Z={"#F59E0B":{bg:"#FFF7ED",text:"#D97706",hoverBg:"#FEF3C7"},"#3B82F6":{bg:"#EFF6FF",text:"#1D4ED8",hoverBg:"#DBEAFE"},"#10B981":{bg:"#ECFDF5",text:"#047857",hoverBg:"#D1FAE5"}},W=r.Ay.button`
  flex: 1;
  padding: 8px 12px;
