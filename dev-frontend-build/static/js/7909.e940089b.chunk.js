...
`,b=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",j=e=>{let{value:a,onChange:o,label:t="Logo Upload",helpText:j="Upload an image for your logo",maxSize:f=2,previewSize:A=150,showRemoveButton:C=!0,changeButtonText:w="Change Image",removeButtonText:F="Remove Image",imageAltText:T="Uploaded"}=e;const[S,k]=(0,n.useState)(!1),[B,z]=(0,n.useState)(!1),E=(0,n.useRef)(null),N=(0,n.useRef)(null),_=async e=>{try{const a=localStorage.getItem("auth_token"),o=await fetch(`${b()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify({image:e})}),n=await o.json();return n.success?n.data.original:(console.error("Image upload failed:",n.message),null)}catch(a){return console.error("Image upload error:",a),null}},D=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*f*1024)return void alert(`Image size should be less than ${f}MB`);if(z(!0),"image/svg+xml"===e.type){const a=new FileReader;return a.onload=async e=>{var a;const n=null===(a=e.target)||void 0===a?void 0:a.result,t=await _(n);z(!1),t?o(t):alert("Failed to upload image. Please try again.")},void a.readAsDataURL(e)}const a=new FileReader;a.onload=async a=>{var n;const t=new Image;t.onload=async()=>{const a=document.createElement("canvas"),n=a.getContext("2d");if(!n)return void z(!1);const i=1200;let r=t.width,s=t.height;(r>i||s>i)&&(r>s?(s=s/r*i,r=i):(r=r/s*i,s=i)),a.width=r,a.height=s,n.drawImage(t,0,0,r,s);const l="image/png"===e.type?a.toDataURL("image/png"):a.toDataURL("image/jpeg",.85),d=await _(l);z(!1),d?o(d):alert("Failed to upload image. Please try again.")},t.src=null===(n=a.target)||void 0===n?void 0:n.result},a.readAsDataURL(e)},M=e=>{if(B)return;const a=e.target.files;a&&a.length>0&&D(a[0]),e.target.value=""};return(0,i.jsxs)(r,{children:[t&&(0,i.jsx)(s,{children:t}),j&&(0,i.jsx)(l,{children:j}),(0,i.jsxs)(d,{children:[(0,i.jsx)(p,{ref:N,isDragging:S,hasImage:!!a,isUploading:B,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),B||k(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===N.current&&k(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),k(!1),B)return;const a=e.dataTransfer.files;a&&a.length>0&&D(a[0])},onClick:()=>{var e;a||B||(null===(e=E.current)||void 0===e||e.click())},children:B?(0,i.jsxs)(c,{children:[(0,i.jsx)(v,{}),(0,i.jsx)(g,{style:{marginTop:"12px"},children:"Uploading..."})]}):a?(0,i.jsx)("img",{src:(U=a,U?U.startsWith("http")?U:U.startsWith("/uploads/")?`${b()}${U}`:U:""),alt:T}):(0,i.jsxs)(c,{children:[(0,i.jsx)(g,{children:S?"Drop image here":"Drag & drop or click to upload"}),(0,i.jsxs)(h,{children:["PNG, JPG, GIF up to ",f,"MB"]})]})}),a&&!B&&(0,i.jsxs)(u,{children:[(0,i.jsxs)(x,{disabled:B,children:[w,(0,i.jsx)("input",{ref:E,type:"file",accept:"image/*",onChange:M,disabled:B})]}),C&&(0,i.jsx)(m,{onClick:()=>{o("")},disabled:B,children:F})]})]}),!a&&!B&&(0,i.jsx)(y,{ref:E,type:"file",accept:"image/*",onChange:M})]});var U}},7909:(e,a,o)=>{o.r(a),o.d(a,{default:()=>C});var n=o(9950),t=o(4752),i=o(2435),r=o(8666),s=o(4877),l=o(4414);const d=[{value:"Asia/Kuala_Lumpur",label:"Malaysia (GMT+8)"},{value:"Asia/Singapore",label:"Singapore (GMT+8)"},{value:"Asia/Bangkok",label:"Thailand (GMT+7)"},{value:"Asia/Jakarta",label:"Indonesia - Jakarta (GMT+7)"},{value:"Asia/Ho_Chi_Minh",label:"Vietnam (GMT+7)"},{value:"Asia/Manila",label:"Philippines (GMT+8)"},{value:"Asia/Tokyo",label:"Japan (GMT+9)"},{value:"Asia/Seoul",label:"South Korea (GMT+9)"},{value:"Asia/Shanghai",label:"China (GMT+8)"},{value:"Asia/Hong_Kong",label:"Hong Kong (GMT+8)"},{value:"Asia/Taipei",label:"Taiwan (GMT+8)"},{value:"Asia/Dubai",label:"UAE (GMT+4)"},{value:"Europe/London",label:"UK (GMT+0/+1)"},{value:"America/New_York",label:"US Eastern (GMT-5/-4)"},{value:"America/Los_Angeles",label:"US Pacific (GMT-8/-7)"},{value:"Australia/Sydney",label:"Australia - Sydney (GMT+10/+11)"}],p=t.Ay.div`
  background: #FAFBFC;
  min-height: 100vh;
`,c=t.Ay.div`
  background: white;
...
`,A=t.Ay.div`
  ...
  font-size: 14px;
`,C=()=>{const[e,a]=(0,n.useState)(!1),[o,t]=(0,n.useState)(!1),[C,w]=(0,n.useState)(null),[F,T]=(0,n.useState)({companyName:"",registrationNo:"",tradeName:"",address:"",city:"",state:"",postalCode:"",country:"MY",phone:"",email:"",website:"",taxNo:"",logoUrl:"",operationSettings:{openingTime:"09:00",closingTime:"22:00",timeZone:"Asia/Kuala_Lumpur"}});(0,n.useEffect)(()=>{S()},[]);const S=async()=>{try{const n=localStorage.getItem("auth_token"),t=await fetch("/api/brands/company-info",{headers:{Authorization:`Bearer ${n}`}});if(t.ok){const n=await t.json();var e,a,o;if(n)T({companyName:n.company_name||n.name||"",registrationNo:n.registration_no||"",tradeName:n.trade_name||"",address:n.address||"",city:n.city||"",state:n.state||"",postalCode:n.postal_code||"",country:n.country||"MY",phone:n.phone||"",email:n.email||"",website:n.website||"",taxNo:n.tax_no||"",logoUrl:n.logo_url||"",operationSettings:{openingTime:(null===(e=n.operation_settings)||void 0===e?void 0:e.openingTime)||"09:00",closingTime:(null===(a=n.operation_settings)||void 0===a?void 0:a.closingTime)||"22:00",timeZone:(null===(o=n.operation_settings)||void 0===o?void 0:o.timeZone)||"Asia/Kuala_Lumpur"}})}}catch(n){console.error("Error fetching company info:",n)}},k=(e,o)=>{T(a=>({...a,[e]:o})),a(!0),w(null)},B=(e,o)=>{T(a=>({...a,operationSettings:{...a.operationSettings,[e]:o}})),a(!0),w(null)};return(0,l.jsx)(l.Fragment,{children:(0,l.jsxs)(p,{children:[(0,l.jsxs)(c,{children:[(0,l.jsx)(g,{children:"Company Information"}),(0,l.jsx)(h,{hasChanges:e,onClick:async()=>{t(!0),w(null);try{const e=localStorage.getItem("auth_token");if(!(await fetch("/api/brands/company-info",{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({company_name:F.companyName,registration_no:F.registrationNo,trade_name:F.tradeName,address:F.address,city:F.city,state:F.state,postal_code:F.postalCode,country:F.country,phone:F.phone,email:F.email,website:F.website,tax_no:F.taxNo,logo_url:F.logoUrl,operation_settings:F.operationSettings})})).ok)throw new Error("Failed to save");w({type:"success",text:"Company information saved successfully!"}),a(!1)}catch(e){w({type:"error",text:"Failed to save company information. Please try again."})}finally{t(!1)}},disabled:!e||o,children:o?"Saving...":"Save Changes"})]}),(0,l.jsxs)(u,{children:[C&&(0,l.jsx)(A,{type:C.type,children:C.text}),(0,l.jsxs)(x,{children:[(0,l.jsx)(m,{children:"Basic Information"}),(0,l.jsxs)(y,{children:[(0,l.jsxs)(v,{children:[(0,l.jsxs)(b,{children:["Company Name ",(0,l.jsx)("span",{children:"*"})]}),(0,l.jsx)(j,{type:"text",value:F.companyName,onChange:e=>k("companyName",e.target.value),placeholder:"Enter company name"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Registration No."}),(0,l.jsx)(j,{type:"text",value:F.registrationNo,onChange:e=>k("registrationNo",e.target.value),placeholder:"e.g., 202001234567"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Trade Name"}),(0,l.jsx)(j,{type:"text",value:F.tradeName,onChange:e=>k("tradeName",e.target.value),placeholder:"Trading as..."})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Tax No. (SST/GST)"}),(0,l.jsx)(j,{type:"text",value:F.taxNo,onChange:e=>k("taxNo",e.target.value),placeholder:"e.g., W10-1234-56789012"})]})]})]}),(0,l.jsxs)(x,{children:[(0,l.jsx)(m,{children:"Address"}),(0,l.jsxs)(y,{children:[(0,l.jsxs)(v,{fullWidth:!0,children:[(0,l.jsxs)(b,{children:["Street Address ",(0,l.jsx)("span",{children:"*"})]}),(0,l.jsx)(j,{type:"text",value:F.address,onChange:e=>k("address",e.target.value),placeholder:"Enter street address"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"City"}),(0,l.jsx)(j,{type:"text",value:F.city,onChange:e=>k("city",e.target.value),placeholder:"e.g., Kuala Lumpur"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"State"}),(0,l.jsx)(j,{type:"text",value:F.state,onChange:e=>k("state",e.target.value),placeholder:"e.g., Wilayah Persekutuan"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Postal Code"}),(0,l.jsx)(j,{type:"text",value:F.postalCode,onChange:e=>k("postalCode",e.target.value),placeholder:"e.g., 50000"})]}),(0,l.jsxs)(v,{children:[(0,l.jsxs)(b,{children:["Country ",(0,l.jsx)("span",{children:"*"})]}),(0,l.jsx)(f,{value:F.country,onChange:e=>k("country",e.target.value),children:i.FS.map(e=>(0,l.jsx)("option",{value:e.code,children:e.name},e.code))})]})]})]}),(0,l.jsxs)(x,{children:[(0,l.jsx)(m,{children:"Contact Information"}),(0,l.jsxs)(y,{children:[(0,l.jsxs)(v,{children:[(0,l.jsxs)(b,{children:["Phone ",(0,l.jsx)("span",{children:"*"})]}),(0,l.jsx)(r.A,{value:F.phone,onChange:e=>k("phone",e),defaultCountry:F.country})]}),(0,l.jsxs)(v,{children:[(0,l.jsxs)(b,{children:["Email ",(0,l.jsx)("span",{children:"*"})]}),(0,l.jsx)(j,{type:"email",value:F.email,onChange:e=>k("email",e.target.value),placeholder:"company@example.com"})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Website"}),(0,l.jsx)(j,{type:"url",value:F.website,onChange:e=>k("website",e.target.value),placeholder:"https://www.example.com"})]})]})]}),(0,l.jsxs)(x,{children:[(0,l.jsx)(m,{children:"Operation Settings"}),(0,l.jsxs)(y,{children:[(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Opening Time"}),(0,l.jsx)(j,{type:"time",value:F.operationSettings.openingTime,onChange:e=>B("openingTime",e.target.value)})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Closing Time"}),(0,l.jsx)(j,{type:"time",value:F.operationSettings.closingTime,onChange:e=>B("closingTime",e.target.value)})]}),(0,l.jsxs)(v,{children:[(0,l.jsx)(b,{children:"Timezone"}),(0,l.jsx)(f,{value:F.operationSettings.timeZone,onChange:e=>B("timeZone",e.target.value),children:d.map(e=>(0,l.jsx)("option",{value:e.value,children:e.label},e.value))})]})]})]}),(0,l.jsxs)(x,{children:[(0,l.jsx)(m,{children:"Company Logo"}),(0,l.jsx)(s.A,{value:F.logoUrl,onChange:e=>k("logoUrl",e),imageAltText:"Company Logo"})]})]})]})})}}}]);