...
`,H=r.Ay.div`
  ...
  .rdp-root {
    ...
    --rdp-range_middle-color: #374151;
    --rdp-range_start-color: #374151;
    --rdp-range_start-background: #E8E5FF;
    --rdp-range_end-color: #374151;
    --rdp-range_end-background: #E8E5FF;
    --rdp-selected-font: 700 13px/1 system-ui;
    --rdp-day-height: 32px;
    --rdp-day-width: 32px;
    font-size: 13px;
  }
