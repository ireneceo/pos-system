...
`,f=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",v=e=>{let{value:t,onChange:r,label:n="Logo Upload",helpText:v="Upload an image for your logo",maxSize:j=2,previewSize:w=150,showRemoveButton:F=!0,changeButtonText:C="Change Image",removeButtonText:k="Remove Image",imageAltText:A="Uploaded"}=e;const[E,B]=(0,i.useState)(!1),[_,S]=(0,i.useState)(!1),z=(0,i.useRef)(null),$=(0,i.useRef)(null),D=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*j*1024)return void alert(`Image size should be less than ${j}MB`);S(!0);const t=new FileReader;t.onload=async e=>{var t;const i=new Image;i.onload=async()=>{const e=document.createElement("canvas"),t=e.getContext("2d");if(!t)return void S(!1);const n=1200;let o=i.width,a=i.height;(o>n||a>n)&&(o>a?(a=a/o*n,o=n):(o=o/a*n,a=n)),e.width=o,e.height=a,t.drawImage(i,0,0,o,a);const s=e.toDataURL("image/jpeg",.85),l=await(async e=>{try{const t=localStorage.getItem("auth_token"),r=await fetch(`${f()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({image:e})}),i=await r.json();return i.success?i.data.original:(console.error("Image upload failed:",i.message),null)}catch(t){return console.error("Image upload error:",t),null}})(s);S(!1),l?r(l):alert("Failed to upload image. Please try again.")},i.src=null===(t=e.target)||void 0===t?void 0:t.result},t.readAsDataURL(e)},L=e=>{if(_)return;const t=e.target.files;t&&t.length>0&&D(t[0]),e.target.value=""};return(0,o.jsxs)(a,{children:[n&&(0,o.jsx)(s,{children:n}),v&&(0,o.jsx)(l,{children:v}),(0,o.jsxs)(d,{children:[(0,o.jsx)(c,{ref:$,isDragging:E,hasImage:!!t,isUploading:_,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),_||B(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===$.current&&B(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),B(!1),_)return;const t=e.dataTransfer.files;t&&t.length>0&&D(t[0])},onClick:()=>{var e;t||_||(null===(e=z.current)||void 0===e||e.click())},children:_?(0,o.jsxs)(p,{children:[(0,o.jsx)(b,{}),(0,o.jsx)(x,{style:{marginTop:"12px"},children:"Uploading..."})]}):t?(0,o.jsx)("img",{src:(T=t,T?T.startsWith("http")?T:T.startsWith("/uploads/")?`${f()}${T}`:T:""),alt:A}):(0,o.jsxs)(p,{children:[(0,o.jsx)(x,{children:E?"Drop image here":"Drag & drop or click to upload"}),(0,o.jsxs)(u,{children:["PNG, JPG, GIF up to ",j,"MB"]})]})}),t&&!_&&(0,o.jsxs)(h,{children:[(0,o.jsxs)(g,{disabled:_,children:[C,(0,o.jsx)("input",{ref:z,type:"file",accept:"image/*",onChange:L,disabled:_})]}),F&&(0,o.jsx)(m,{onClick:()=>{r("")},disabled:_,children:k})]})]}),!t&&!_&&(0,o.jsx)(y,{ref:z,type:"file",accept:"image/*",onChange:L})]});var T}},7617:(e,t,r)=>{r.d(t,{A:()=>x});r(9950);var i=r(4752),n=r(9610),o=r(4414);const a=i.Ay.div`
  background: white;
  border-radius: 12px;
