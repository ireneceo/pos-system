...
`,c=a.Ay.div`
  ...
  color: ${e=>e.$textColor};
  margin-top: 3px;
`,h=i.memo(e=>{let{table:t,status:n="available",isSelected:i=!1,isEditing:a=!1,onClick:h,onMouseDown:u,onTouchStart:x,statusInfo:p,currency:g=""}=e;const b=a?{bg:"#F8F9FA",border:"#D1D9E0",text:"#374151"}:r.Ez[n];return(0,o.jsxs)(s,{$x:t.x,$y:t.y,$w:t.width,$h:t.height,$shape:t.shape,$rotation:t.rotation,$bgColor:b.bg,$borderColor:b.border,$textColor:b.text,$isSelected:i,$isEditing:a,onClick:e=>{!a&&h&&(e.stopPropagation(),h(t.tableNumber))},onMouseDown:e=>{a&&u&&u(e,t.id)},onTouchStart:e=>{a&&x&&x(e,t.id)},children:[(0,o.jsx)(l,{$textColor:b.text,children:t.label||t.tableNumber}),(0,o.jsx)(d,{$textColor:b.text,children:!a&&null!==p&&void 0!==p&&p.guestCount?`${p.guestCount} guests`:`${t.seats} seats`}),!a&&p&&"available"!==n&&(0,o.jsxs)(c,{$textColor:b.text,children:[g,p.totalAmount.toFixed(0)," \xb7 ",p.elapsedMinutes,"m"]})]})});h.displayName="TableNode";const u=h,x=a.Ay.div`
  width: 100%;
  flex: 1;
  display: flex;
  align-items: center;
...
`,f=a.Ay.div`
  ...
  font-size: 14px;
  gap: 8px;
`,m=e=>{let{floorPlan:t,tableStatuses:n={},isEditing:a=!1,selectedTableId:r,onTableClick:s,onTableMouseDown:l,onTableTouchStart:d,onCanvasClick:c,currency:h=""}=e;const m=(0,i.useRef)(null),v=(0,i.useRef)(null),[y,$]=(0,i.useState)(1),[w,j]=(0,i.useState)({x:0,y:0}),E=(0,i.useMemo)(()=>{if(a||0===t.tables.length)return{x:0,y:0,w:t.canvasWidth,h:t.canvasHeight};let e=1/0,n=1/0,i=-1/0,r=-1/0;for(const a of t.tables){const t=a.width/2,o=a.height/2;e=Math.min(e,a.x-t),n=Math.min(n,a.y-o),i=Math.max(i,a.x+t),r=Math.max(r,a.y+o)}const o=i-e,s=r-n,l=Math.max(.15*o,60),d=Math.max(.15*s,60),c=Math.max(0,e-l),h=Math.max(0,n-d);return{x:c,y:h,w:Math.min(t.canvasWidth-c,o+2*l),h:Math.min(t.canvasHeight-h,s+2*d)}},[t,a]),C=(0,i.useCallback)(()=>{if(!v.current)return;const e=v.current.getBoundingClientRect();if(0===e.width||0===e.height)return;const t=E.w/e.width,n=E.h/e.height,i=Math.max(t,n);$(i);const a=E.w/i,r=E.h/i;j({x:(e.width-a)/2,y:(e.height-r)/2})},[E]);(0,i.useEffect)(()=>{C();const e=new ResizeObserver(()=>C());return v.current&&e.observe(v.current),()=>e.disconnect()},[C]);const S=e=>{var t;return(null===(t=n[e])||void 0===t?void 0:t.status)||"available"},F=`${E.w} / ${E.h}`;return(0,o.jsx)(x,{ref:m,children:(0,o.jsxs)(p,{ref:v,$aspectRatio:F,onClick:e=>{(e.target===e.currentTarget||e.target.closest("[data-scaled-layer]"))&&(null===c||void 0===c||c())},children:[a&&t.showGrid&&(0,o.jsx)(g,{$gridSize:t.gridSize,$scale:y}),(0,o.jsx)(b,{"data-scaled-layer":!0,style:{transform:`scale(${1/y})`,left:a?0:w.x-E.x/y+"px",top:a?0:w.y-E.y/y+"px",width:a?`${t.canvasWidth}px`:`${E.w}px`,height:a?`${t.canvasHeight}px`:`${E.h}px`},onClick:e=>{e.target===e.currentTarget&&(null===c||void 0===c||c())},children:t.tables.map(e=>(0,o.jsx)(u,{table:e,status:S(e.tableNumber),isSelected:r===e.id,isEditing:a,onClick:s,onMouseDown:l,onTouchStart:d,statusInfo:n[e.tableNumber],currency:h},e.id))}),0===t.tables.length&&(0,o.jsxs)(f,{children:[(0,o.jsx)("span",{style:{fontSize:"32px"},children:"\u25a6"}),a?"Add tables using the toolbar above":"No floor plan configured yet"]})]})})}},7447:(e,t,n)=>{n.d(t,{Em:()=>a,Ez:()=>r,He:()=>i,Zt:()=>o});const i={version:1,canvasWidth:1200,canvasHeight:800,gridSize:20,showGrid:!0,tables:[]},a=[{value:"round",label:"Round",defaultWidth:70,defaultHeight:70},{value:"square",label:"Square",defaultWidth:70,defaultHeight:70},{value:"rectangle",label:"Rectangle",defaultWidth:110,defaultHeight:70}],r={available:{bg:"#ECFDF5",border:"#059669",text:"#059669"},occupied:{bg:"#EFF6FF",border:"#635BFF",text:"#635BFF"},ready:{bg:"#FEF3C7",border:"#D97706",text:"#D97706"},"needs-attention":{bg:"#FEE2E2",border:"#DC2626",text:"#DC2626"}},o={available:"Available",occupied:"Occupied",ready:"Ready","needs-attention":"Attention"}}}]);