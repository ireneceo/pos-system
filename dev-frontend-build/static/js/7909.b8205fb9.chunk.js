...
`,v=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",j=e=>{let{value:a,onChange:o,label:t="Logo Upload",helpText:j="Upload an image for your logo",maxSize:f=2,previewSize:A=150,showRemoveButton:C=!0,changeButtonText:w="Change Image",removeButtonText:F="Remove Image",imageAltText:T="Uploaded"}=e;const[S,k]=(0,n.useState)(!1),[z,B]=(0,n.useState)(!1),E=(0,n.useRef)(null),N=(0,n.useRef)(null),_=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*f*1024)return void alert(`Image size should be less than ${f}MB`);B(!0);const a=new FileReader;a.onload=async e=>{var a;const n=new Image;n.onload=async()=>{const e=document.createElement("canvas"),a=e.getContext("2d");if(!a)return void B(!1);const t=1200;let i=n.width,r=n.height;(i>t||r>t)&&(i>r?(r=r/i*t,i=t):(i=i/r*t,r=t)),e.width=i,e.height=r,a.drawImage(n,0,0,i,r);const s=e.toDataURL("image/jpeg",.85),l=await(async e=>{try{const a=localStorage.getItem("auth_token"),o=await fetch(`${v()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${a}`},body:JSON.stringify({image:e})}),n=await o.json();return n.success?n.data.original:(console.error("Image upload failed:",n.message),null)}catch(a){return console.error("Image upload error:",a),null}})(s);B(!1),l?o(l):alert("Failed to upload image. Please try again.")},n.src=null===(a=e.target)||void 0===a?void 0:a.result},a.readAsDataURL(e)},M=e=>{if(z)return;const a=e.target.files;a&&a.length>0&&_(a[0]),e.target.value=""};return(0,i.jsxs)(r,{children:[t&&(0,i.jsx)(s,{children:t}),j&&(0,i.jsx)(l,{children:j}),(0,i.jsxs)(d,{children:[(0,i.jsx)(p,{ref:N,isDragging:S,hasImage:!!a,isUploading:z,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),z||k(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===N.current&&k(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),k(!1),z)return;const a=e.dataTransfer.files;a&&a.length>0&&_(a[0])},onClick:()=>{var e;a||z||(null===(e=E.current)||void 0===e||e.click())},children:z?(0,i.jsxs)(c,{children:[(0,i.jsx)(b,{}),(0,i.jsx)(h,{style:{marginTop:"12px"},children:"Uploading..."})]}):a?(0,i.jsx)("img",{src:(D=a,D?D.startsWith("http")?D:D.startsWith("/uploads/")?`${v()}${D}`:D:""),alt:T}):(0,i.jsxs)(c,{children:[(0,i.jsx)(h,{children:S?"Drop image here":"Drag & drop or click to upload"}),(0,i.jsxs)(g,{children:["PNG, JPG, GIF up to ",f,"MB"]})]})}),a&&!z&&(0,i.jsxs)(x,{children:[(0,i.jsxs)(u,{disabled:z,children:[w,(0,i.jsx)("input",{ref:E,type:"file",accept:"image/*",onChange:M,disabled:z})]}),C&&(0,i.jsx)(m,{onClick:()=>{o("")},disabled:z,children:F})]})]}),!a&&!z&&(0,i.jsx)(y,{ref:E,type:"file",accept:"image/*",onChange:M})]});var D}},7909:(e,a,o)=>{o.r(a),o.d(a,{default:()=>C});var n=o(9950),t=o(4752),i=o(2435),r=o(8666),s=o(4877),l=o(4414);const d=[{value:"Asia/Kuala_Lumpur",label:"Malaysia (GMT+8)"},{value:"Asia/Singapore",label:"Singapore (GMT+8)"},{value:"Asia/Bangkok",label:"Thailand (GMT+7)"},{value:"Asia/Jakarta",label:"Indonesia - Jakarta (GMT+7)"},{value:"Asia/Ho_Chi_Minh",label:"Vietnam (GMT+7)"},{value:"Asia/Manila",label:"Philippines (GMT+8)"},{value:"Asia/Tokyo",label:"Japan (GMT+9)"},{value:"Asia/Seoul",label:"South Korea (GMT+9)"},{value:"Asia/Shanghai",label:"China (GMT+8)"},{value:"Asia/Hong_Kong",label:"Hong Kong (GMT+8)"},{value:"Asia/Taipei",label:"Taiwan (GMT+8)"},{value:"Asia/Dubai",label:"UAE (GMT+4)"},{value:"Europe/London",label:"UK (GMT+0/+1)"},{value:"America/New_York",label:"US Eastern (GMT-5/-4)"},{value:"America/Los_Angeles",label:"US Pacific (GMT-8/-7)"},{value:"Australia/Sydney",label:"Australia - Sydney (GMT+10/+11)"}],p=t.Ay.div`
  background: #FAFBFC;
  min-height: 100vh;
`,c=t.Ay.div`
  position: sticky;
