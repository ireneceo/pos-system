"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[3201],{3201:(e,t,r)=>{r.r(t),r.d(t,{default:()=>Y});var n=r(9950),i=r(4492),s=r(4752),a=r(3310),o=r(2674),c=r(6038),l=r(9018),d=r(4414);const p=e=>"MYR"===e||"RM"===e?"RM":e,u=e=>{const t={};return Object.entries(e).forEach(e=>{let[r,n]=e;const i=p(r);t[i]=(t[i]||0)+n}),t},h=e=>{const t=u(e),r=Object.entries(t).filter(e=>{let[,t]=e;return t>0});return 0===r.length?(0,c.vv)(0,"RM"):r.map(e=>{let[t,r]=e;return(0,c.vv)(r,t)}).join(" / ")},x=(e,t)=>u(e)[t]||0,g=(e,t)=>({lines:[{currency:t,amount:u(e)[t]||0}],single:!0}),m=e=>{const t=(new Date).toLocaleDateString("en-CA",{timeZone:e}),[r,n,i]=t.split("-").map(Number);return{year:r,month:n-1,day:i}},y=(e,t)=>{const r=new Date(e);if(isNaN(r.getTime()))return{year:0,month:-1,day:0};const n=r.toLocaleDateString("en-CA",{timeZone:t}),[i,s,a]=n.split("-").map(Number);return{year:i,month:s-1,day:a}},v=s.Ay.div`
  display: flex;
  align-items: center;
  gap: 6px;
  margin-bottom: 16px;
