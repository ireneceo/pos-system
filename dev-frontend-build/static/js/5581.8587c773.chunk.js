"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[5581],{5581:(e,r,s)=>{s.r(r),s.d(r,{default:()=>V});var n=s(9950),t=s(4752),i=s(3832),l=s(4728),a=s(1721),o=s(5665),d=s(7960),c=s(9610),p=s(4414);const h=t.Ay.div`
  background: white;
  border-radius: 12px;
