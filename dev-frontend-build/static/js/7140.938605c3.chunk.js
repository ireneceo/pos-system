...
`,q=i.Ay.div`
  ...
  font-size: 14px;
  color: #6B7280;
`,V=()=>{(0,a.g)();const[e,t]=(0,r.useState)([]),[n,i]=(0,r.useState)(!0),[V,X]=(0,r.useState)(""),[Z,ee]=(0,r.useState)("all"),[te,ne]=(0,r.useState)("all"),[re,ie]=(0,r.useState)("all"),[oe,ae]=(0,r.useState)(!1),[le,se]=(0,r.useState)(null),[de,pe]=(0,r.useState)(null),[ce,xe]=(0,r.useState)({}),{user:he}=(0,h.As)(),ue=localStorage.getItem("auth_token"),ge=async()=>{try{i(!0);const e=await fetch("/api/notices/received",{headers:{Authorization:`Bearer ${ue}`,"Content-Type":"application/json"}});if(e.ok){const n=await e.json(),r=n.data||n,i=Array.isArray(r)?r:[];t(i),(async e=>{if(0!==e.length)try{const t=e.map(e=>e.id).join(","),n=await fetch(`/api/comments/unread-counts?entity_type=notice&entity_ids=${t}`,{headers:{Authorization:`Bearer ${ue}`}});if(n.ok){const e=await n.json();if(e.success){const t={};e.data.forEach(e=>{t[e.entity_id]={total_comments:Number(e.total_comments),unread_count:Number(e.unread_count)}}),xe(t)}}}catch(t){}})(i)}}catch(e){console.error("Failed to fetch notices:",e)}finally{i(!1)}};(0,r.useEffect)(()=>{ge()},[]);const me=e=>{se(e),pe(null),ae(!0),(async e=>{try{const n=await fetch(`/api/notices/${e}`,{headers:{Authorization:`Bearer ${ue}`,"Content-Type":"application/json"}});if(n.ok){const r=await n.json(),i=r.data||r;pe(i),t(t=>t.map(t=>t.id===e?{...t,read_at:(new Date).toISOString()}:t)),window.dispatchEvent(new Event("refreshBadgeCounts"))}}catch(n){console.error("Failed to fetch notice detail:",n)}})(e.id)},fe=()=>{ae(!1),se(null),pe(null)},ye=e.filter(e=>{const t=e.title.toLowerCase().includes(V.toLowerCase())||e.content.toLowerCase().includes(V.toLowerCase())||e.author_name.toLowerCase().includes(V.toLowerCase()),n="all"===Z||e.priority===Z,r="all"===te||(e.category||"general")===te,i="all"===re||e.author_role===re;return t&&n&&r&&i}),we=e.length,be=e.filter(e=>!e.read_at).length,je=e.filter(e=>"important"===e.priority).length,ve=e.filter(e=>"urgent"===e.priority).length,Ae=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:120;return e.length<=t?e:e.substring(0,t)+"..."};return(0,u.jsxs)(l.mc,{children:[(0,u.jsx)(l.Y9,{children:(0,u.jsx)(l.hE,{children:"Notices"})}),(0,u.jsxs)(l.UC,{children:[(0,u.jsxs)(s.MD,{children:[(0,u.jsxs)(s.hI,{color:"#635BFF",children:[(0,u.jsx)(s.Os,{children:we}),(0,u.jsx)(s.v0,{children:"Total Received"})]}),(0,u.jsxs)(s.hI,{color:"#2563EB",children:[(0,u.jsx)(s.Os,{children:be}),(0,u.jsx)(s.v0,{children:"Unread"})]}),(0,u.jsxs)(s.hI,{color:"#D97706",children:[(0,u.jsx)(s.Os,{children:je}),(0,u.jsx)(s.v0,{children:"Important"})]}),(0,u.jsxs)(s.hI,{color:"#DC2626",children:[(0,u.jsx)(s.Os,{children:ve}),(0,u.jsx)(s.v0,{children:"Urgent"})]})]}),(0,u.jsx)("div",{style:{display:"flex",gap:"8px",marginBottom:"16px"},children:["all","general","guide"].map(e=>(0,u.jsx)("button",{onClick:()=>ne(e),style:{padding:"6px 16px",borderRadius:"20px",border:te===e?"1.5px solid #635BFF":"1px solid #E6EBF1",background:te===e?"#F0EFFF":"white",color:te===e?"#635BFF":"#6B7280",fontSize:"13px",fontWeight:te===e?600:400,cursor:"pointer",transition:"all 0.15s"},children:"all"===e?"All":"general"===e?"General":"Guide"},e))}),(0,u.jsxs)(g,{children:[(0,u.jsx)(d.DO,{type:"text",placeholder:"Search notices...",value:V,onChange:e=>X(e.target.value)}),(0,u.jsxs)(d.Jt,{value:re,onChange:e=>ie(e.target.value),children:[(0,u.jsx)("option",{value:"all",children:"All Senders"}),(0,u.jsx)("option",{value:"System Admin",children:"System Admin"}),(0,u.jsx)("option",{value:"Brand General",children:"Brand General"}),(0,u.jsx)("option",{value:"Foodcourt General",children:"Foodcourt General"}),(0,u.jsx)("option",{value:"Restaurant Owner",children:"Restaurant Owner"})]}),(0,u.jsxs)(d.Jt,{value:Z,onChange:e=>ee(e.target.value),children:[(0,u.jsx)("option",{value:"all",children:"All Priorities"}),(0,u.jsx)("option",{value:"normal",children:"Normal"}),(0,u.jsx)("option",{value:"important",children:"Important"}),(0,u.jsx)("option",{value:"urgent",children:"Urgent"})]})]}),n?(0,u.jsx)(q,{children:"Loading notices..."}):0===ye.length?(0,u.jsxs)(o.pp,{children:[(0,u.jsx)("h3",{children:"No notices found"}),(0,u.jsx)("p",{children:V||"all"!==Z?"Try adjusting your search or filter criteria.":"You have no notices yet."})]}):(0,u.jsx)(m,{children:ye.map(e=>{var t;const n=!e.read_at;return(0,u.jsx)(f,{isUnread:n,onClick:()=>me(e),style:"guide"===e.category?{borderLeft:"4px solid #10B981"}:void 0,children:(0,u.jsxs)(y,{children:[(0,u.jsxs)(w,{children:[(0,u.jsxs)(b,{isUnread:n,children:[n&&(0,u.jsx)(j,{}),e.title]}),(0,u.jsx)(v,{children:Ae(e.content)}),(0,u.jsxs)(A,{children:[(0,u.jsxs)(F,{children:[e.author_name,(0,u.jsx)(k,{role:e.author_role,children:e.author_role})]}),(0,u.jsx)(z,{children:(r=e.createdAt,new Date(r).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}))}),e.commentCount>0&&(0,u.jsxs)(C,{children:[e.commentCount," ",1===e.commentCount?"comment":"comments",(null===(t=ce[String(e.id)])||void 0===t?void 0:t.unread_count)>0&&(0,u.jsxs)("span",{style:{background:"#EF4444",color:"white",borderRadius:"10px",padding:"1px 7px",fontSize:"11px",fontWeight:600,marginLeft:"4px"},children:[ce[String(e.id)].unread_count," new"]})]})]})]}),(0,u.jsxs)(E,{children:["guide"===e.category&&(0,u.jsx)("span",{style:{display:"inline-block",padding:"4px 10px",borderRadius:"6px",fontSize:"11px",fontWeight:600,background:"#D1FAE5",color:"#065F46"},children:"Guide"}),(0,u.jsx)(B,{priority:e.priority,children:e.priority})]})]})},e.id);var r})}),oe&&le&&(0,u.jsx)(S,{onClick:fe,children:(0,u.jsxs)(_,{onClick:e=>e.stopPropagation(),children:[(0,u.jsxs)($,{children:[(0,u.jsx)(D,{children:"Notice Details"}),(0,u.jsx)(I,{onClick:fe,children:"\xd7"})]}),(0,u.jsxs)(T,{children:[(0,u.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"20px",gap:"16px"},children:[(0,u.jsx)("div",{style:{fontSize:"18px",fontWeight:"700",color:"#0A2540",lineHeight:"1.4",flex:1},children:le.title}),(0,u.jsx)(B,{priority:le.priority,children:le.priority})]}),(0,u.jsxs)(L,{children:[(0,u.jsx)(O,{children:"From"}),(0,u.jsxs)(G,{children:[(0,u.jsx)(J,{children:(ke=(null===de||void 0===de?void 0:de.author_name)||le.author_name,ke?ke.charAt(0).toUpperCase():"?")}),(0,u.jsxs)(M,{children:[(0,u.jsx)(P,{children:(null===de||void 0===de?void 0:de.author_name)||le.author_name}),(0,u.jsx)(W,{children:(null===de||void 0===de?void 0:de.author_role)||le.author_role})]})]})]}),(0,u.jsxs)(Y,{children:[(0,u.jsxs)(K,{children:[(0,u.jsx)(H,{children:"Date"}),(0,u.jsx)(Q,{children:(Fe=(null===de||void 0===de?void 0:de.createdAt)||le.createdAt,new Date(Fe).toLocaleString("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}))})]}),(0,u.jsxs)(K,{children:[(0,u.jsx)(H,{children:"Priority"}),(0,u.jsx)(Q,{style:{textTransform:"capitalize"},children:(null===de||void 0===de?void 0:de.priority)||le.priority})]}),(0,u.jsxs)(K,{children:[(0,u.jsx)(H,{children:"Status"}),(0,u.jsx)(Q,{style:{textTransform:"capitalize"},children:(null===de||void 0===de?void 0:de.status)||le.status})]})]}),(0,u.jsxs)(L,{children:[(0,u.jsx)(O,{children:"Content"}),(0,u.jsx)(R,{children:((null===de||void 0===de?void 0:de.content)||le.content).split("\n").map((e,t)=>(0,u.jsxs)(r.Fragment,{children:[t>0&&(0,u.jsx)("br",{}),(0,x.c)(e)]},t))})]}),((null===de||void 0===de?void 0:de.attachments)||(null===le||void 0===le?void 0:le.attachments))&&((null===de||void 0===de?void 0:de.attachments)||(null===le||void 0===le?void 0:le.attachments)||[]).length>0&&(0,u.jsxs)(L,{children:[(0,u.jsx)(O,{children:"Attachments"}),(0,u.jsx)(p.A,{attachments:(null===de||void 0===de?void 0:de.attachments)||(null===le||void 0===le?void 0:le.attachments)||[]})]}),(0,u.jsx)(c.A,{entityType:"notice",entityId:String(le.id),currentUserId:null===he||void 0===he?void 0:he.id,onMarkRead:()=>xe(e=>{const t={...e},n=String(le.id);return t[n]&&(t[n]={...t[n],unread_count:0}),t})})]}),(0,u.jsx)(N,{children:(0,u.jsx)(U,{variant:"secondary",onClick:fe,children:"Close"})})]})})]})]});var Fe,ke}},9061:(e,t,n)=>{n.d(t,{c:()=>a});var r=n(9950),i=n(4414);const o=/(https?:\/\/[^\s<]+)/g;function a(e){const t=e.split(o);return 1===t.length?e:t.map((e,t)=>o.test(e)?(0,i.jsx)("a",{href:e,target:"_blank",rel:"noopener noreferrer",style:{color:"#635BFF",wordBreak:"break-all"},children:e},t):(0,i.jsx)(r.Fragment,{children:e},t))}}}]);