...
`,A=a.Ay.div`
  ...
  font-weight: 500;
`,z=()=>{const{restaurantId:e}=(0,r.g)(),{user:t}=(0,o.As)(),n=(0,i.useRef)(null),[a,z]=(0,i.useState)(s.He),[T,B]=(0,i.useState)(null),[D,N]=(0,i.useState)(!1),[H,M]=(0,i.useState)({x:0,y:0}),[W,I]=(0,i.useState)([]),[R,L]=(0,i.useState)(!1),[X,P]=(0,i.useState)(!1),[Y,_]=(0,i.useState)(""),[G,O]=(0,i.useState)([]),[U,q]=(0,i.useState)(""),[J,K]=(0,i.useState)(!0);(0,i.useEffect)(()=>{(async()=>{try{var t;const n=localStorage.getItem("auth_token"),i=await fetch(`/api/restaurants/${e}`,{headers:{Authorization:`Bearer ${n}`}});if(!i.ok)return;const a=await i.json(),r=a.data||a;if(r.name&&q(r.name),r.floor_plan&&z(r.floor_plan),null!==(t=r.table_settings)&&void 0!==t&&t.enableTableNumbers){const{totalTables:e,tablePrefix:t}=r.table_settings,n=[];for(let i=1;i<=e;i++)n.push(`${t}${String(i).padStart(3,"0")}`);O(n)}}catch(n){console.error("Failed to load floor plan:",n)}finally{K(!1)}})()},[e]);const Z=a.tables.find(e=>e.id===T)||null,Q=a.tables.map(e=>e.tableNumber),V=G.filter(e=>!Q.includes(e)),ee=()=>{T&&(te(),z(e=>({...e,tables:e.tables.filter(e=>e.id!==T)})),B(null),L(!0))},te=()=>{I(e=>[...e.slice(-19),JSON.parse(JSON.stringify(a))])},ne=()=>{if(0===W.length)return;const e=W[W.length-1];I(e=>e.slice(0,-1)),z(e),B(null),L(!0)},ie=e=>{T&&(z(t=>({...t,tables:t.tables.map(t=>t.id===T?{...t,...e}:t)})),L(!0))},ae=(0,i.useCallback)(()=>{var e,t;const i=null===(e=n.current)||void 0===e||null===(t=e.querySelector("[data-scaled-layer]"))||void 0===t?void 0:t.parentElement;if(!i)return{x:1,y:1,rect:new DOMRect};const r=i.getBoundingClientRect();return{x:a.canvasWidth/r.width,y:a.canvasHeight/r.height,rect:r}},[a.canvasWidth,a.canvasHeight]),re=(e,t,n)=>{const i=a.tables.find(e=>e.id===n);if(!i)return;const{x:r,y:o,rect:s}=ae();M({x:(e-s.left)*r-i.x,y:(t-s.top)*o-i.y}),te(),N(!0),B(n)};return(0,i.useEffect)(()=>{if(!D||!T)return;const e=e=>{e.preventDefault();const{clientX:t,clientY:n}=(e=>"touches"in e&&e.touches.length>0?{clientX:e.touches[0].clientX,clientY:e.touches[0].clientY}:"clientX"in e?{clientX:e.clientX,clientY:e.clientY}:{clientX:0,clientY:0})(e),{x:i,y:r,rect:o}=ae();let s=(t-o.left)*i-H.x,l=(n-o.top)*r-H.y;a.gridSize>0&&(s=Math.round(s/a.gridSize)*a.gridSize,l=Math.round(l/a.gridSize)*a.gridSize),s=Math.max(0,Math.min(a.canvasWidth,s)),l=Math.max(0,Math.min(a.canvasHeight,l)),z(e=>({...e,tables:e.tables.map(e=>e.id===T?{...e,x:s,y:l}:e)})),L(!0)},t=()=>N(!1);return document.addEventListener("mousemove",e,{passive:!1}),document.addEventListener("mouseup",t),document.addEventListener("touchmove",e,{passive:!1}),document.addEventListener("touchend",t),()=>{document.removeEventListener("mousemove",e),document.removeEventListener("mouseup",t),document.removeEventListener("touchmove",e),document.removeEventListener("touchend",t)}},[D,T,H,ae,a.gridSize,a.canvasWidth,a.canvasHeight]),(0,i.useEffect)(()=>{const e=e=>{if("Delete"===e.key||"Backspace"===e.key){const t=e.target.tagName;if("INPUT"===t||"SELECT"===t||"TEXTAREA"===t)return;ee()}(e.metaKey||e.ctrlKey)&&"z"===e.key&&(e.preventDefault(),ne())};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[T,W]),J?(0,d.jsxs)(c,{children:[(0,d.jsx)(u,{children:(0,d.jsx)(h,{children:"Floor Plan Editor"})}),(0,d.jsx)(g,{children:(0,d.jsx)("div",{style:{color:"#6B7C93"},children:"Loading..."})})]}):(0,d.jsxs)(c,{children:[(0,d.jsxs)(u,{children:[(0,d.jsx)(h,{children:"Floor Plan Editor"}),(0,d.jsxs)(p,{children:[Y&&(0,d.jsx)(A,{$type:"success",children:Y}),R&&(0,d.jsx)(A,{$type:"info",children:"Unsaved changes"}),(0,d.jsx)(x,{$variant:"secondary",onClick:ne,disabled:0===W.length,children:"Undo"}),(0,d.jsx)(x,{$variant:"primary",onClick:async()=>{P(!0);try{const t=localStorage.getItem("auth_token");(await fetch(`/api/restaurants/${e}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({name:U,floor_plan:a})})).ok&&(L(!1),_("Saved"),setTimeout(()=>_(""),2e3))}catch(t){console.error("Failed to save:",t)}finally{P(!1)}},disabled:X||!R,children:X?"Saving...":"Save"})]})]}),(0,d.jsxs)(g,{children:[(0,d.jsxs)(b,{children:[(0,d.jsxs)(f,{children:[(0,d.jsxs)(v,{children:["Add Table (",V.length," left)"]}),(0,d.jsx)(m,{children:s.Em.map(e=>(0,d.jsxs)(y,{onClick:()=>(e=>{const t=V[0];if(!t)return;const n=s.Em.find(t=>t.value===e),i={id:`ft-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,tableNumber:t,label:t,shape:e,x:a.canvasWidth/2,y:a.canvasHeight/2,width:n.defaultWidth,height:n.defaultHeight,rotation:0,seats:4};te(),z(e=>({...e,tables:[...e.tables,i]})),B(i.id),L(!0)})(e.value),disabled:0===V.length,title:`Add ${e.label} table`,children:[(0,d.jsx)($,{$shape:e.value}),e.label]},e.value))}),T&&(0,d.jsx)(x,{$variant:"danger",onClick:ee,style:{width:"100%",justifyContent:"center",marginTop:"12px"},children:"Delete Table"})]}),Z&&(0,d.jsxs)(f,{children:[(0,d.jsx)(v,{children:"Properties"}),(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Table Number"}),(0,d.jsxs)(C,{value:Z.tableNumber,onChange:e=>ie({tableNumber:e.target.value,label:e.target.value}),children:[(0,d.jsx)("option",{value:Z.tableNumber,children:Z.tableNumber}),V.map(e=>(0,d.jsx)("option",{value:e,children:e},e))]})]}),(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Label"}),(0,d.jsx)(S,{value:Z.label,onChange:e=>ie({label:e.target.value})})]}),(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Shape"}),(0,d.jsx)(C,{value:Z.shape,onChange:e=>{const t=e.target.value,n=s.Em.find(e=>e.value===t);ie({shape:t,width:n.defaultWidth,height:n.defaultHeight})},children:s.Em.map(e=>(0,d.jsx)("option",{value:e.value,children:e.label},e.value))})]}),(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Seats"}),(0,d.jsx)(S,{type:"number",min:1,max:20,value:Z.seats,onChange:e=>ie({seats:parseInt(e.target.value)||1})})]}),(0,d.jsxs)(F,{children:[(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Width"}),(0,d.jsx)(S,{type:"number",min:40,max:200,value:Z.width,onChange:e=>{const t=parseInt(e.target.value)||60;ie({width:t,height:"round"===Z.shape||"square"===Z.shape?t:Z.height})}})]}),(0,d.jsxs)(j,{children:[(0,d.jsx)(E,{children:"Height"}),(0,d.jsx)(S,{type:"number",min:40,max:200,value:Z.height,onChange:e=>ie({height:parseInt(e.target.value)||60}),disabled:"rectangle"!==Z.shape})]})]})]}),(0,d.jsxs)(f,{children:[(0,d.jsx)(v,{children:"Canvas"}),(0,d.jsxs)(k,{children:[(0,d.jsx)("input",{type:"checkbox",checked:a.showGrid,onChange:e=>{z(t=>({...t,showGrid:e.target.checked})),L(!0)}}),"Show Grid"]}),(0,d.jsxs)(j,{style:{marginTop:"8px"},children:[(0,d.jsx)(E,{children:"Grid Size"}),(0,d.jsx)(S,{type:"number",min:10,max:50,step:5,value:a.gridSize,onChange:e=>{z(t=>({...t,gridSize:parseInt(e.target.value)||20})),L(!0)}})]})]})]}),(0,d.jsx)(w,{ref:n,children:(0,d.jsx)(l.A,{floorPlan:a,isEditing:!0,selectedTableId:T,onTableMouseDown:(e,t)=>{e.preventDefault(),e.stopPropagation(),re(e.clientX,e.clientY,t)},onTableTouchStart:(e,t)=>{e.stopPropagation();const n=e.touches[0];re(n.clientX,n.clientY,t)},onCanvasClick:()=>B(null)})})]})]})}},5783:(e,t,n)=>{n.d(t,{A:()=>v});var i=n(9950),a=n(4752),r=n(7447),o=n(4414);const s=a.Ay.div`
  position: absolute;
  left: ${e=>e.$x-e.$w/2}px;
  top: ${e=>e.$y-e.$h/2}px;
  width: ${e=>e.$w}px;
