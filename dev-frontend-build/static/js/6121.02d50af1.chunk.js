...
`,E=e=>{let{startDate:t,endDate:r,onRangeSelect:n,onClose:E,isOpen:D}=e;const C=new Date,[$,B]=(0,a.useState)(C.getMonth()),[R,z]=(0,a.useState)(C.getFullYear()),[O,T]=(0,a.useState)(null),[M,Y]=(0,a.useState)(null),[I,L]=(0,a.useState)(null),[W,_]=(0,a.useState)("start"),U=(0,a.useRef)(null);(0,a.useEffect)(()=>{t&&T(d(t)),r&&Y(d(r))},[t,r]),(0,a.useEffect)(()=>{D&&_("start")},[D]),(0,a.useEffect)(()=>{const e=e=>{U.current&&!U.current.contains(e.target)&&E()};return D&&document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[D,E]);const V=(0,a.useCallback)(()=>{0===$?(B(11),z(e=>e-1)):B(e=>e-1)},[$]),H=(0,a.useCallback)(()=>{11===$?(B(0),z(e=>e+1)):B(e=>e+1)},[$]),P=(e,t)=>{const r=((e,t)=>new Date(e,t+1,0).getDate())(e,t),a=((e,t)=>new Date(e,t,1).getDay())(e,t),d=[];for(let n=0;n<a;n++)d.push(null);for(let n=1;n<=r;n++)d.push(new Date(e,t,n));return(0,i.jsxs)(F,{children:[(0,i.jsx)(w,{children:c(e,t)}),(0,i.jsx)(v,{children:o.map(e=>(0,i.jsx)(j,{children:e},e))}),(0,i.jsx)(k,{children:d.map((e,t)=>{if(!e)return(0,i.jsx)(S,{},`e-${t}`);const{isStart:r,isEnd:a,isInRange:o,isHoverEnd:d}=(e=>{const t=O&&l(e,O),r=M&&l(e,M),a="end"===W&&I?I:M;let n=!1;if(O&&a){const[t,r]=O<=a?[O,a]:[a,O];n=((e,t,r)=>{const a=e.getTime();return a>t.getTime()&&a<r.getTime()})(e,t,r)}return{isStart:t,isEnd:r,isInRange:n,isHoverEnd:"end"===W&&I&&l(e,I)}})(e),c=l(e,C);return(0,i.jsx)(A,{$isStart:!!r,$isEnd:!!a,$isInRange:o,$isHoverEnd:!!d,$isToday:c,onClick:()=>(e=>{if("start"===W)T(e),Y(null),_("end");else{let t=O,r=e;r<t&&([t,r]=[r,t]),T(t),Y(r),_("start"),n(s(t),s(r)),setTimeout(E,200)}})(e),onMouseEnter:()=>L(e),onMouseLeave:()=>L(null),children:e.getDate()},e.getTime())})})]})},N=11===$?0:$+1,J=11===$?R+1:R,Z=e=>{const t=new Date;let r;const a=t;switch(e){case"this_week":r=new Date(t),r.setDate(t.getDate()-t.getDay());break;case"this_month":r=new Date(t.getFullYear(),t.getMonth(),1);break;case"this_year":r=new Date(t.getFullYear(),0,1);break;default:return}T(r),Y(a),_("start"),n(s(r),s(a)),setTimeout(E,150)};return D?(0,i.jsx)(p,{ref:U,children:(0,i.jsxs)(x,{children:[(0,i.jsxs)(h,{children:[(0,i.jsx)(g,{onClick:()=>Z("this_week"),children:"This Week"}),(0,i.jsx)(g,{onClick:()=>Z("this_month"),children:"This Month"}),(0,i.jsx)(g,{onClick:()=>Z("this_year"),children:"This Year"})]}),(0,i.jsxs)(u,{children:[(0,i.jsxs)(y,{children:[(0,i.jsx)(m,{onClick:V,"aria-label":"Previous month",children:(0,i.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("polyline",{points:"15 18 9 12 15 6"})})}),(0,i.jsx)(m,{onClick:H,"aria-label":"Next month",children:(0,i.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("polyline",{points:"9 6 15 12 9 18"})})})]}),(0,i.jsxs)(b,{children:[P(R,$),(0,i.jsx)(f,{children:P(J,N)})]})]})]})}):null},D=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,C=(e,t)=>{const r=(e=>{if(!e)return new Date;try{const t=new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date),[r,a,n]=t.split("-").map(Number);return new Date(r,a-1,n)}catch{return new Date}})(t);let a=new Date(r);const n=new Date(r);switch(e){case"today":break;case"yesterday":a.setDate(r.getDate()-1),n.setDate(r.getDate()-1);break;case"week":a.setDate(r.getDate()-6);break;case"month":a.setDate(r.getDate()-29);break;case"year":a.setDate(r.getDate()-364);break;case"all":a=new Date(2020,0,1)}return{start:D(a),end:D(n)}},$=n.Ay.div`
  margin-bottom: 24px;
`,B=n.Ay.div`
  display: flex;
  gap: 8px;
