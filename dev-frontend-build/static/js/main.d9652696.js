/*! For license information please see main.d9652696.js.LICENSE.txt */
...
`,y=o.Ay.div`
  ...
  font-size: 14px;
  line-height: 1.5;
`,b=()=>{const{restaurantId:e}=(0,i.g)(),{showCustomerModal:t,setShowCustomerModal:n,setGuestInfo:o,loginCustomer:b,registerCustomer:v,customerModalMode:w}=(0,a.c)(),[j,k]=(0,r.useState)("login"),[S,A]=(0,r.useState)({name:"",phone:""}),[C,F]=(0,r.useState)({phone:"",password:""}),[E,_]=(0,r.useState)({name:"",phone:"",email:"",password:""}),[P,z]=(0,r.useState)(""),[B,T]=(0,r.useState)(""),[R,O]=(0,r.useState)(!1);(0,r.useEffect)(()=>{t||(k("login"),A({name:"",phone:""}),F({phone:"",password:""}),_({name:"",phone:"",email:"",password:""}),z(""),T(""),O(!1))},[t]);const $=()=>{n(!1)},I=()=>{S.name&&S.phone&&(o({name:S.name,phone:S.phone}),$())},D=async()=>{if(C.phone){z(""),O(!0);try{await b(C.phone,C.password)?$():z("Login failed. Please check your phone number and password.")}catch(e){z(e.message||"Login failed. Please try again.")}finally{O(!1)}}else z("Phone number is required")},N=async()=>{if(E.name&&E.phone)if("member"!==w||E.password&&!(E.password.length<6))if(E.password&&E.password.length>0&&E.password.length<6)T("Password must be at least 6 characters");else{T(""),O(!0);try{await v(E,e),$()}catch(t){T(t.message||"Registration failed. Please try again.")}finally{O(!1)}}else T("Password must be at least 6 characters");else T("Name and phone number are required")};return(0,c.jsxs)(s.aF,{isOpen:t,onClose:$,title:"guest"===w?"Guest Order":"register"===w?"Add New Customer":"login"===j?"Member Login":"Create Account",footer:"guest"===w?(0,c.jsxs)(f,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(s.yl,{variant:"secondary",onClick:$,children:"Cancel"}),(0,c.jsx)(s.yl,{variant:"primary",disabled:!S.name||!S.phone,onClick:I,children:"Continue"})]}),(0,c.jsx)(x,{show:!1})]}):"register"===w?(0,c.jsxs)(f,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(s.yl,{variant:"secondary",onClick:$,children:"Cancel"}),(0,c.jsx)(s.yl,{variant:"primary",disabled:!E.name||!E.phone||R,onClick:N,children:R?"Adding...":"Add Customer"})]}),(0,c.jsx)(x,{show:!!B,children:B&&(0,c.jsx)(y,{children:B})})]}):"member"===w?"login"===j?(0,c.jsxs)(f,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(s.yl,{variant:"secondary",onClick:$,children:"Cancel"}),(0,c.jsx)(s.yl,{variant:"primary",disabled:!C.phone||R,onClick:D,children:R?"Logging in...":"Login"})]}),(0,c.jsx)(x,{show:!!P,children:P&&(0,c.jsx)(y,{children:P})})]}):(0,c.jsxs)(f,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(s.yl,{variant:"secondary",onClick:$,children:"Cancel"}),(0,c.jsx)(s.yl,{variant:"primary",disabled:!E.name||!E.phone||R,onClick:N,children:R?"Creating...":"Create Account"})]}),(0,c.jsx)(x,{show:!!B,children:B&&(0,c.jsx)(y,{children:B})})]}):null,children:["guest"===w&&(0,c.jsxs)(p,{children:[(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Your Name *"}),(0,c.jsx)(m,{type:"text",placeholder:"Enter your name",value:S.name,onChange:e=>A({...S,name:e.target.value})})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Phone Number *"}),(0,c.jsx)(l.A,{value:S.phone,onChange:e=>A({...S,phone:e}),required:!0})]})]}),"register"===w&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Full Name *"}),(0,c.jsx)(m,{type:"text",placeholder:"Enter customer's full name",value:E.name,onChange:e=>{_({...E,name:e.target.value}),T("")},disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Phone Number *"}),(0,c.jsx)(l.A,{value:E.phone,onChange:e=>{_({...E,phone:e}),T("")},required:!0,disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Email Address"}),(0,c.jsx)(m,{type:"email",placeholder:"Enter email (optional)",value:E.email,onChange:e=>{_({...E,email:e.target.value}),T("")},disabled:R})]})]}),"member"===w&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)(d,{children:[(0,c.jsx)(u,{active:"login"===j,onClick:()=>k("login"),children:"Login"}),(0,c.jsx)(u,{active:"register"===j,onClick:()=>k("register"),children:"Sign Up"})]}),"login"===j&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Phone Number *"}),(0,c.jsx)(l.A,{value:C.phone,onChange:e=>{F({...C,phone:e}),z("")},required:!0,disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Password *"}),(0,c.jsx)(m,{type:"password",placeholder:"Enter your password",value:C.password,onChange:e=>{F({...C,password:e.target.value}),z("")},disabled:R})]})]}),"register"===j&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Full Name *"}),(0,c.jsx)(m,{type:"text",placeholder:"Enter your full name",value:E.name,onChange:e=>{_({...E,name:e.target.value}),T("")},disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Phone Number *"}),(0,c.jsx)(l.A,{value:E.phone,onChange:e=>{_({...E,phone:e}),T("")},required:!0,disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Email Address"}),(0,c.jsx)(m,{type:"email",placeholder:"Enter your email (optional)",value:E.email,onChange:e=>{_({...E,email:e.target.value}),T("")},disabled:R})]}),(0,c.jsxs)(h,{children:[(0,c.jsx)(s.lR,{children:"Password *"}),(0,c.jsx)(m,{type:"password",placeholder:"Create a password (min 6 characters)",value:E.password,onChange:e=>{_({...E,password:e.target.value}),T("")},disabled:R})]})]})]})]})}},2853:(e,t,n)=>{"use strict";n.d(t,{A0:()=>i,Hj:()=>a,K0:()=>p,Np:()=>c,PM:()=>s,Uj:()=>l,XI:()=>o,pp:()=>h,rA:()=>u,wr:()=>d});var r=n(4752);const o=r.Ay.div`
  background: white;
  border-radius: 12px;
  border: 1px solid #E6EBF1;
  overflow: hidden;
