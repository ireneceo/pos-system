...
`,N=e=>{let{entityType:n,entityId:r,currentUserId:i,onMarkRead:N}=e;const[P,q]=(0,t.useState)([]),[O,L]=(0,t.useState)(""),[R,U]=(0,t.useState)(!1),[H,W]=(0,t.useState)([]),[M,J]=(0,t.useState)(!1),[Q,K]=(0,t.useState)(""),[Y,Z]=(0,t.useState)(!1),G=(0,t.useRef)(null),V=async()=>{try{const e=localStorage.getItem("auth_token"),t=await fetch(`/api/comments/${n}/${r}`,{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const e=await t.json();e.success&&q(e.data)}}catch(e){console.error("Error fetching comments:",e)}};(0,t.useEffect)(()=>{r&&(V(),(async()=>{try{const e=localStorage.getItem("auth_token");await fetch("/api/comments/mark-read",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:n,entity_id:r})}),N&&N(),window.dispatchEvent(new Event("refreshBadgeCounts"))}catch(e){console.error("Error marking comments as read:",e)}})())},[n,r]);const X=async()=>{if(M)return;const e=O.trim(),t=H.length>0;if((e||t)&&!Y){Z(!0);try{const e=localStorage.getItem("auth_token");(await fetch("/api/comments",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:n,entity_id:r,content:O.trim(),attachments:t?H:void 0,is_internal:R||void 0})})).ok&&(L(""),W([]),U(!1),V())}catch(i){console.error("Error adding comment:",i)}finally{Z(!1)}}},ee=e=>{const n=new Date(e),r=(new Date).getTime()-n.getTime(),t=Math.floor(r/6e4);if(t<1)return"Just now";if(t<60)return`${t}m ago`;const i=Math.floor(t/60);if(i<24)return`${i}h ago`;const o=Math.floor(i/24);return o<7?`${o}d ago`:n.toLocaleDateString("en-US",{month:"short",day:"numeric"})};return(0,s.jsxs)(l,{children:[(0,s.jsxs)(d,{children:["Comments (",P.length,")"]}),P.length>0?(0,s.jsx)(c,{children:P.map(e=>{var n,r,l;return(0,s.jsxs)(p,{isInternal:e.is_internal,children:[(0,s.jsx)(h,{children:((null===(n=e.author)||void 0===n?void 0:n.full_name)||e.author_name||"?")[0].toUpperCase()}),(0,s.jsxs)(x,{children:[(0,s.jsxs)(u,{children:[(0,s.jsx)(g,{children:(null===(r=e.author)||void 0===r?void 0:r.full_name)||e.author_name}),(0,s.jsx)(m,{children:(null===(l=e.author)||void 0===l?void 0:l.role)||e.author_role}),e.is_internal&&(0,s.jsx)(v,{children:"Internal"}),(0,s.jsx)(f,{children:ee(e.createdAt)}),i&&e.author_id===i&&(0,s.jsx)(j,{onClick:()=>(async e=>{try{const n=localStorage.getItem("auth_token");(await fetch(`/api/comments/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${n}`}})).ok&&V()}catch(n){console.error("Error deleting comment:",n)}})(e.id),children:"Delete"})]}),e.content&&(0,s.jsx)(y,{children:e.content.split("\n").map((e,n)=>(0,s.jsxs)(t.Fragment,{children:[n>0&&(0,s.jsx)("br",{}),(0,a.c)(e)]},n))}),e.attachments&&e.attachments.length>0&&(0,s.jsx)(o.A,{attachments:e.attachments})]})]},e.id)})}):(0,s.jsx)(_,{children:"No comments yet"}),(0,s.jsxs)(b,{children:[(0,s.jsxs)(F,{children:[(0,s.jsx)(w,{value:O,onChange:e=>L(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),X())},placeholder:R?"Write an internal note... (visible only to your role group)":"Add a comment... (Enter to send, Shift+Enter for newline)",rows:1}),(0,s.jsxs)(A,{children:[(0,s.jsx)(k,{onClick:()=>{var e;return null===(e=G.current)||void 0===e?void 0:e.click()},title:"Attach file",children:"\ud83d\udcce"}),(0,s.jsx)(C,{onClick:X,disabled:!O.trim()&&0===H.length||Y||M,children:"Send"})]})]}),(0,s.jsx)(D,{children:(0,s.jsxs)(I,{children:[(0,s.jsx)("input",{type:"checkbox",checked:R,onChange:e=>U(e.target.checked)}),"Internal note (visible only to your role group)"]})}),(H.length>0||M||Q)&&(0,s.jsxs)(B,{children:[M&&(0,s.jsx)(z,{children:"Uploading..."}),Q&&(0,s.jsx)(T,{children:Q}),H.map((e,n)=>(0,s.jsxs)(E,{children:[e.originalName.length>20?e.originalName.slice(0,17)+"...":e.originalName,(0,s.jsx)(S,{onClick:()=>(e=>{const n=H[e],r=localStorage.getItem("auth_token");fetch("/api/upload/file",{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({url:n.url})}).catch(()=>{}),W(n=>n.filter((n,r)=>r!==e))})(n),children:"\u2715"})]},e.url))]})]}),(0,s.jsx)($,{ref:G,type:"file",accept:".jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.xls,.xlsx,.zip",multiple:!0,onChange:async e=>{const n=e.target.files;if(!n||0===n.length)return;const r=5-H.length,t=Array.from(n).slice(0,r);if(e.target.value="",0!==t.length){J(!0),K("");try{const e=new FormData;t.forEach(n=>e.append("files",n));const n=localStorage.getItem("auth_token"),r=await fetch("/api/upload/files",{method:"POST",headers:{Authorization:`Bearer ${n}`},body:e}),i=await r.json();i.success&&i.data?W(e=>[...e,...i.data]):K(i.message||"Upload failed")}catch(i){console.error("File upload error:",i),K("File upload failed. Please try again.")}finally{J(!1)}}}})]})}},8744:(e,n,r)=>{r.r(n),r.d(n,{default:()=>le});var t=r(9950),i=r(4752),o=r(2853),a=r(8409),s=r(2597),l=r(2653),d=r(6038),c=r(4302),p=r(1367),h=r(4414);const x=i.Ay.div`
  display: grid;
