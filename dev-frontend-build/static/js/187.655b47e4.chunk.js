"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[187],{187:(e,n,r)=>{r.r(n),r.d(n,{default:()=>V});var i=r(9950),t=r(4752),a=r(9163),o=r(3310),s=r(7492),l=r(1367),d=r(9018),c=r(8930),p=r(755),x=r(3705),h=r(4669),g=r(4492);var u=r(5863),y=r(4414);const m=t.Ay.div`
...
`},4669:(e,n,r)=>{r.d(n,{A:()=>v});var i=r(9950),t=r(4752),a=r(4414);const o=t.Ay.div`
  margin-top: 24px;
  padding-top: 24px;
  border-top: 1px solid #E6EBF1;
`,s=t.Ay.label`
...
`,m=t.Ay.input`
  display: none;
`,v=e=>{let{value:n,onChange:r,label:t="Logo Upload",helpText:v="Upload an image for your logo",maxSize:j=2,previewSize:b=150,showRemoveButton:C=!0,changeButtonText:f="Change Image",removeButtonText:S="Remove Image",imageAltText:T="Uploaded"}=e;const[k,B]=(0,i.useState)(!1),F=(0,i.useRef)(null),w=(0,i.useRef)(null),A=e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*j*1024)return void alert(`Image size should be less than ${j}MB`);const n=new FileReader;n.onload=e=>{var n;const i=new Image;i.onload=()=>{const e=document.createElement("canvas"),n=e.getContext("2d");if(!n)return;const t=800;let a=i.width,o=i.height;(a>t||o>t)&&(a>o?(o=o/a*t,a=t):(a=a/o*t,o=t)),e.width=a,e.height=o,n.drawImage(i,0,0,a,o);const s=e.toDataURL("image/jpeg",.85);r(s)},i.src=null===(n=e.target)||void 0===n?void 0:n.result},n.readAsDataURL(e)},P=e=>{const n=e.target.files;n&&n.length>0&&A(n[0])};return(0,a.jsxs)(o,{children:[t&&(0,a.jsx)(s,{children:t}),v&&(0,a.jsx)(l,{children:v}),(0,a.jsxs)(d,{children:[(0,a.jsx)(c,{ref:w,isDragging:k,hasImage:!!n,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),B(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===w.current&&B(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{e.preventDefault(),e.stopPropagation(),B(!1);const n=e.dataTransfer.files;n&&n.length>0&&A(n[0])},onClick:()=>{var e;n||(null===(e=F.current)||void 0===e||e.click())},children:n?(0,a.jsx)("img",{src:n,alt:T}):(0,a.jsxs)(p,{children:[(0,a.jsx)(x,{children:k?"Drop image here":"Drag & drop or click to upload"}),(0,a.jsxs)(h,{children:["PNG, JPG, GIF up to ",j,"MB"]})]})}),n&&(0,a.jsxs)(g,{children:[(0,a.jsxs)(u,{children:[f,(0,a.jsx)("input",{ref:F,type:"file",accept:"image/*",onChange:P})]}),C&&(0,a.jsx)(y,{onClick:()=>{r("")},children:S})]})]}),!n&&(0,a.jsx)(m,{ref:F,type:"file",accept:"image/*",onChange:P})]})}}}]);