...
`,D=e=>{let{entityType:t,entityId:n,currentUserId:r,onMarkRead:D}=e;const[T,N]=(0,i.useState)([]),[U,L]=(0,i.useState)(""),[O,M]=(0,i.useState)(!1),[J,P]=(0,i.useState)([]),[R,W]=(0,i.useState)(!1),[Y,K]=(0,i.useState)(!1),H=(0,i.useRef)(null),Q=async()=>{try{const e=localStorage.getItem("auth_token"),i=await fetch(`/api/comments/${t}/${n}`,{headers:{Authorization:`Bearer ${e}`}});if(i.ok){const e=await i.json();e.success&&N(e.data)}}catch(e){console.error("Error fetching comments:",e)}};(0,i.useEffect)(()=>{n&&(Q(),(async()=>{try{const e=localStorage.getItem("auth_token");await fetch("/api/comments/mark-read",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:t,entity_id:n})}),D&&D()}catch(e){console.error("Error marking comments as read:",e)}})())},[t,n]);const q=async()=>{if(R)return;const e=U.trim(),i=J.length>0;if((e||i)&&!Y){K(!0);try{const e=localStorage.getItem("auth_token");(await fetch("/api/comments",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({entity_type:t,entity_id:n,content:U.trim(),attachments:i?J:void 0,is_internal:O||void 0})})).ok&&(L(""),P([]),M(!1),Q())}catch(r){console.error("Error adding comment:",r)}finally{K(!1)}}},G=e=>{const t=new Date(e),n=(new Date).getTime()-t.getTime(),i=Math.floor(n/6e4);if(i<1)return"Just now";if(i<60)return`${i}m ago`;const r=Math.floor(i/60);if(r<24)return`${r}h ago`;const o=Math.floor(r/24);return o<7?`${o}d ago`:t.toLocaleDateString("en-US",{month:"short",day:"numeric"})};return(0,a.jsxs)(l,{children:[(0,a.jsxs)(d,{children:["Comments (",T.length,")"]}),T.length>0?(0,a.jsx)(s,{children:T.map(e=>{var t,n,i;return(0,a.jsxs)(p,{isInternal:e.is_internal,children:[(0,a.jsx)(c,{children:((null===(t=e.author)||void 0===t?void 0:t.full_name)||e.author_name||"?")[0].toUpperCase()}),(0,a.jsxs)(x,{children:[(0,a.jsxs)(h,{children:[(0,a.jsx)(u,{children:(null===(n=e.author)||void 0===n?void 0:n.full_name)||e.author_name}),(0,a.jsx)(g,{children:(null===(i=e.author)||void 0===i?void 0:i.role)||e.author_role}),e.is_internal&&(0,a.jsx)(m,{children:"Internal"}),(0,a.jsx)(f,{children:G(e.createdAt)}),r&&e.author_id===r&&(0,a.jsx)(w,{onClick:()=>(async e=>{try{const t=localStorage.getItem("auth_token");(await fetch(`/api/comments/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${t}`}})).ok&&Q()}catch(t){console.error("Error deleting comment:",t)}})(e.id),children:"Delete"})]}),e.content&&(0,a.jsx)(y,{children:e.content}),e.attachments&&e.attachments.length>0&&(0,a.jsx)(o.A,{attachments:e.attachments})]})]},e.id)})}):(0,a.jsx)(E,{children:"No comments yet"}),(0,a.jsxs)(b,{children:[(0,a.jsxs)(v,{children:[(0,a.jsx)(j,{value:U,onChange:e=>L(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),q())},placeholder:O?"Write an internal note... (visible only to your role group)":"Add a comment... (Enter to send, Shift+Enter for newline)",rows:1}),(0,a.jsxs)(A,{children:[(0,a.jsx)(F,{onClick:()=>{var e;return null===(e=H.current)||void 0===e?void 0:e.click()},title:"Attach file",children:"\ud83d\udcce"}),(0,a.jsx)(k,{onClick:q,disabled:!U.trim()&&0===J.length||Y||R,children:"Send"})]})]}),(0,a.jsx)($,{children:(0,a.jsxs)(I,{children:[(0,a.jsx)("input",{type:"checkbox",checked:O,onChange:e=>M(e.target.checked)}),"Internal note (visible only to your role group)"]})}),(J.length>0||R)&&(0,a.jsxs)(B,{children:[R&&(0,a.jsx)(S,{children:"Uploading..."}),J.map((e,t)=>(0,a.jsxs)(z,{children:[e.originalName.length>20?e.originalName.slice(0,17)+"...":e.originalName,(0,a.jsx)(C,{onClick:()=>(e=>{const t=J[e],n=localStorage.getItem("auth_token");fetch("/api/upload/file",{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({url:t.url})}).catch(()=>{}),P(t=>t.filter((t,n)=>n!==e))})(t),children:"\u2715"})]},e.url))]})]}),(0,a.jsx)(_,{ref:H,type:"file",accept:".jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.xls,.xlsx,.zip",multiple:!0,onChange:async e=>{const t=e.target.files;if(!t||0===t.length)return;e.target.value="";const n=5-J.length,i=Array.from(t).slice(0,n);if(0!==i.length){W(!0);try{const e=new FormData;i.forEach(t=>e.append("files",t));const t=localStorage.getItem("auth_token"),n=await fetch("/api/upload/files",{method:"POST",headers:{Authorization:`Bearer ${t}`},body:e}),r=await n.json();r.success&&r.data&&P(e=>[...e,...r.data])}catch(r){console.error("File upload error:",r)}finally{W(!1)}}}})]})}},7140:(e,t,n)=>{n.r(t),n.d(t,{default:()=>G});var i=n(9950),r=n(4752),o=n(4492),a=n(3832),l=n(5665),d=n(2488),s=n(4185),p=n(4302),c=n(1367),x=n(4414);const h=r.Ay.div`
  display: flex;
  gap: 16px;
  margin-bottom: 24px;
  flex-wrap: wrap;
