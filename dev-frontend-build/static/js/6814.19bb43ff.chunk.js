...
`,b=r.Ay.div`
  ...
  border-radius: 8px;
  margin-bottom: 10px;
  background: ${e=>{switch(e.status){case"pending":return"#FDE68A";case"preparing":return"#93C5FD";case"ready":return"#6EE7B7";default:return"#F6F9FC"}}};
  border: 2px solid ${e=>{switch(e.status){case"pending":return"#F59E0B";case"preparing":return"#3B82F6";case"ready":return"#10B981";default:return"#E6EBF1"}}};
`,_=r.Ay.div`
  display: flex;
  align-items: center;
  gap: 8px;
