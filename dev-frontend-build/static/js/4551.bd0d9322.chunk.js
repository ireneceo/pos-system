...
`,v=o.Ay.span`
  ...
  font-size: 12px;
  font-weight: 700;
`,j=(0,i.forwardRef)((e,n)=>{let{children:t,onSave:o,type:r="input",debounceMs:s=2e3,style:d}=e;const[c,j]=(0,i.useState)("idle"),[b,f]=(0,i.useState)(!1),A=(0,i.useRef)(null),C=(0,i.useRef)(null),w=(0,i.useRef)(null),S=(0,i.useRef)(!0),F=(0,i.useRef)(o);F.current=o;const k=(0,i.useCallback)(()=>{A.current&&clearTimeout(A.current),C.current&&clearTimeout(C.current),w.current&&clearTimeout(w.current)},[]),z=2e3!==s?s:"toggle"===r||"select"===r||"list"===r||"image"===r?300:s,E=(0,i.useCallback)(()=>{k(),f(!1),A.current=setTimeout(async()=>{if(S.current){j("saving");try{if(await F.current(),!S.current)return;j("saved"),C.current=setTimeout(()=>{S.current&&(f(!0),w.current=setTimeout(()=>{S.current&&(j("idle"),f(!1))},300))},2e3)}catch{if(!S.current)return;j("error"),C.current=setTimeout(()=>{S.current&&(f(!0),w.current=setTimeout(()=>{S.current&&(j("idle"),f(!1))},300))},4e3)}}},z)},[z,k]);(0,i.useImperativeHandle)(n,()=>({triggerSave:E}),[E]),(0,i.useEffect)(()=>(S.current=!0,()=>{S.current=!1,k()}),[k]);const B=i.Children.map(t,e=>{if(!i.isValidElement(e))return e;const n=e.props.onChange;return"function"!==typeof n?e:i.cloneElement(e,{onChange:function(){n(...arguments),E()}})}),N="saving"===c?(0,a.jsx)(y,{}):"saved"===c?(0,a.jsx)(g,{children:"\u2713"}):"error"===c?(0,a.jsx)(v,{children:"!"}):null,P="select"===r?u:"toggle"===r?h:"image"===r?x:"list"===r?m:p;return(0,a.jsxs)(l,{$type:r,style:d,children:[B,"idle"!==c&&(0,a.jsx)(P,{$fading:b,children:N})]})});j.displayName="AutoSaveField";const b=j}}]);