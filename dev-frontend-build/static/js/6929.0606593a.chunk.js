...
`},6929:(e,n,r)=>{r.r(n),r.d(n,{default:()=>I});var t=r(9950),o=r(4752),i=r(8409),s=r(3705),a=r(7617),d=r(2597),c=r(2653),l=r(4414);const p=o.Ay.div`
  min-height: 100vh;
...
`,u=e=>{let{isOpen:n,title:r,message:o,onConfirm:u,onCancel:h,confirmText:g="Confirm",cancelText:b="Cancel",type:m="warning"}=e;return n?t.createPortal((0,s.jsx)(i.mH,{onClick:e=>{e.target===e.currentTarget&&h()},style:{zIndex:1100},children:(0,s.jsxs)(a,{onClick:e=>e.stopPropagation(),children:[(0,s.jsxs)(d,{children:[(0,s.jsx)(c,{children:r}),(0,s.jsx)(l,{children:o})]}),(0,s.jsxs)(p,{children:[(0,s.jsx)(x,{variant:"secondary",onClick:h,children:b}),(0,s.jsx)(x,{variant:"primary",type:m,onClick:u,children:g})]})]})}),document.body):null}}}]);