...
`,v=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",j=e=>{let{value:t,onChange:n,label:r="Logo Upload",helpText:j="Upload an image for your logo",maxSize:b=2,previewSize:F=150,showRemoveButton:C=!0,changeButtonText:w="Change Image",removeButtonText:k="Remove Image",imageAltText:A="Uploaded"}=e;const[E,B]=(0,i.useState)(!1),[S,_]=(0,i.useState)(!1),I=(0,i.useRef)(null),z=(0,i.useRef)(null),$=async e=>{try{const t=localStorage.getItem("auth_token"),n=await fetch(`${v()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({image:e})}),i=await n.json();return i.success?i.data.original:(console.error("Image upload failed:",i.message),null)}catch(t){return console.error("Image upload error:",t),null}},R=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*b*1024)return void alert(`Image size should be less than ${b}MB`);if(_(!0),"image/svg+xml"===e.type){const t=new FileReader;return t.onload=async e=>{var t;const i=null===(t=e.target)||void 0===t?void 0:t.result,r=await $(i);_(!1),r?n(r):alert("Failed to upload image. Please try again.")},void t.readAsDataURL(e)}const t=new FileReader;t.onload=async t=>{var i;const r=new Image;r.onload=async()=>{const t=document.createElement("canvas"),i=t.getContext("2d");if(!i)return void _(!1);const o=1200;let a=r.width,s=r.height;(a>o||s>o)&&(a>s?(s=s/a*o,a=o):(a=a/s*o,s=o)),t.width=a,t.height=s,i.drawImage(r,0,0,a,s);const l="image/png"===e.type?t.toDataURL("image/png"):t.toDataURL("image/jpeg",.85),d=await $(l);_(!1),d?n(d):alert("Failed to upload image. Please try again.")},r.src=null===(i=t.target)||void 0===i?void 0:i.result},t.readAsDataURL(e)},M=e=>{if(S)return;const t=e.target.files;t&&t.length>0&&R(t[0]),e.target.value=""};return(0,o.jsxs)(a,{children:[r&&(0,o.jsx)(s,{children:r}),j&&(0,o.jsx)(l,{children:j}),(0,o.jsxs)(d,{children:[(0,o.jsx)(c,{ref:z,isDragging:E,hasImage:!!t,isUploading:S,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),S||B(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===z.current&&B(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),B(!1),S)return;const t=e.dataTransfer.files;t&&t.length>0&&R(t[0])},onClick:()=>{var e;t||S||(null===(e=I.current)||void 0===e||e.click())},children:S?(0,o.jsxs)(p,{children:[(0,o.jsx)(y,{}),(0,o.jsx)(u,{style:{marginTop:"12px"},children:"Uploading..."})]}):t?(0,o.jsx)("img",{src:(O=t,O?O.startsWith("http")?O:O.startsWith("/uploads/")?`${v()}${O}`:O:""),alt:A}):(0,o.jsxs)(p,{children:[(0,o.jsx)(u,{children:E?"Drop image here":"Drag & drop or click to upload"}),(0,o.jsxs)(x,{children:["PNG, JPG, GIF up to ",b,"MB"]})]})}),t&&!S&&(0,o.jsxs)(h,{children:[(0,o.jsxs)(g,{disabled:S,children:[w,(0,o.jsx)("input",{ref:I,type:"file",accept:"image/*",onChange:M,disabled:S})]}),C&&(0,o.jsx)(m,{onClick:()=>{n("")},disabled:S,children:k})]})]}),!t&&!S&&(0,o.jsx)(f,{ref:I,type:"file",accept:"image/*",onChange:M})]});var O}},9194:(e,t,n)=>{n.d(t,{A:()=>m});var i=n(9950),r=n(4752),o=n(4414);const a=r.Ay.div`
  position: relative;
  width: 100%;
`,s=r.Ay.div`
  display: flex;
