...
`,u=new Set(["kitchen","entrance"]),x={kitchen:{bg:"transparent",border:"transparent",text:"#6B7280"},counter:{bg:"#FEF3C7",border:"#D97706",text:"#92400E"},entrance:{bg:"transparent",border:"transparent",text:"#6B7280"}},h=r.memo(e=>{let{table:t,status:n="available",isSelected:r=!1,isEditing:o=!1,onClick:h,onMouseDown:g,onTouchStart:m,statusInfo:b,currency:y=""}=e;const f=t.tableType||"table",v="table"!==f,j=u.has(f),C=v?x[f]||x.kitchen:o?{bg:"#F8F9FA",border:"#D1D9E0",text:"#374151"}:!o&&null!==b&&void 0!==b&&b.orderStatus&&i.v[b.orderStatus]?i.v[b.orderStatus]:i.Ez[n],A=v?{...j?{background:"transparent",border:r&&o?"1.5px dashed #635BFF":"none",boxShadow:r&&o?"0 0 0 2px rgba(99, 91, 255, 0.2)":"none",borderRadius:"4px"}:{border:`2.5px solid ${r?"#635BFF":C.border}`},cursor:o?"grab":"default",opacity:o?1:.85}:void 0,w="counter"===f&&t.width<t.height,F=!o&&"staffMeal"===(null===b||void 0===b?void 0:b.paymentMethod);return(0,a.jsxs)(s,{$x:t.x,$y:t.y,$w:t.width,$h:t.height,$shape:j?"square":t.shape,$rotation:t.rotation,$bgColor:j?"transparent":C.bg,$borderColor:j?"transparent":C.border,$textColor:C.text,$isSelected:r&&!j,$isEditing:o,onClick:e=>{o||!h||v||(e.stopPropagation(),h(t.tableNumber))},onMouseDown:e=>{o&&g&&g(e,t.id)},onTouchStart:e=>{o&&m&&m(e,t.id)},style:A,children:[F&&(0,a.jsx)(p,{children:"STAFF"}),(0,a.jsx)(d,{$textColor:C.text,style:j?{fontSize:"14px",fontWeight:600,whiteSpace:"nowrap"}:w?{writingMode:"vertical-rl",textOrientation:"mixed",letterSpacing:"1px"}:void 0,children:t.label||t.tableNumber}),!v&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(l,{$textColor:C.text,children:!o&&null!==b&&void 0!==b&&b.guestCount?`${b.guestCount} guests`:`${t.seats} seats`}),!o&&b&&"available"!==n&&(0,a.jsx)(c,{$textColor:C.text,children:F?"Staff Meal":{pending:"Pending",preparing:"Preparing",ready:"Ready",served:"Served",awaiting_payment:"Awaiting Pay",outstanding:"Outstanding"}[b.orderStatus||""]||"Occupied"})]})]})});h.displayName="TableNode";const g=h,m=o.Ay.div`
  width: 100%;
  flex: 1;
  overflow: hidden;
  background: white;
