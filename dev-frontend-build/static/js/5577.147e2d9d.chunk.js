"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[5577],{4021:(a,e,r)=>{r.d(e,{i1:()=>o});var t=r(9950),n=r(1367),s=r(6038),i=r(9955);const o=()=>{const{user:a}=(0,n.As)(),[e,r]=(0,t.useState)("RM"),[o]=(0,t.useState)(Object.keys(s.DL)),[d,c]=(0,t.useState)(!0),[l,h]=(0,t.useState)(null);return(0,t.useEffect)(()=>{(async()=>{const e=window.location.pathname.split("/"),t=e.indexOf("restaurant");let n=t>=0?e[t+1]:null;if(!n&&null!==a&&void 0!==a&&a.restaurant_id&&(n=a.restaurant_id.toString()),!n)return r("RM"),void c(!1);try{const a=(0,i.c4)(),e=await fetch(`/api/restaurants/${n}`,{headers:{Authorization:`Bearer ${a}`,"Content-Type":"application/json"}});if(e.ok){var s;const a=await e.json(),t=a.currency||(null===(s=a.operation_settings)||void 0===s?void 0:s.currency)||"MYR";r(t)}else r("MYR")}catch(o){console.error("Failed to fetch restaurant currency:",o),h("Failed to load currency settings"),r("MYR")}finally{c(!1)}})()},[null===a||void 0===a?void 0:a.restaurant_id]),{defaultCurrency:e,supportedCurrencies:o,loading:d,error:l}}},5577:(a,e,r)=>{r.r(e),r.d(e,{default:()=>H});var t=r(9950),n=r(4752),s=r(4492),i=r(8409),o=r(4021),d=r(6038),c=r(5030),l=r(4414);const h=n.Ay.div`
  min-height: 100vh;
