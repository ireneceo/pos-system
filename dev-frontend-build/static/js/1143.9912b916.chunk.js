"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[1143],{1143:(e,r,t)=>{t.r(r),t.d(r,{default:()=>B});var s=t(9950),a=t(4752),n=t(2674),i=t(6038),o=t(4414);const d=a.Ay.div`
  background: #FAFBFC;
  padding: 24px 0;
  margin-bottom: 24px;
  display: flex;
