...
`,S=()=>{const{user:e}=(0,d.As)(),{restaurantId:i}=(0,r.g)(),{defaultCurrency:t}=(0,l.i1)(),[a,S]=(0,n.useState)("RM"),[A,_]=(0,n.useState)(!0),[E,R]=(0,n.useState)([]),[$,P]=(0,n.useState)(""),[N,z]=(0,n.useState)("all"),[B,M]=(0,n.useState)("all"),[I,L]=(0,n.useState)([]),[O,D]=(0,n.useState)(!1),[T,U]=(0,n.useState)(!1),[q,W]=(0,n.useState)(null),[J,Q]=(0,n.useState)([]),[Y,H]=(0,n.useState)(""),[X,Z]=(0,n.useState)([]),[V,G]=(0,n.useState)([]),[K,ee]=(0,n.useState)(""),[ie,te]=(0,n.useState)(""),[ne,re]=(0,n.useState)(""),[ae,se]=(0,n.useState)(!1),oe=i?parseInt(i,10):null===e||void 0===e?void 0:e.restaurant_id;(0,n.useEffect)(()=>{t&&S(t)},[t]);const de=(0,n.useCallback)(async()=>{if(oe)try{_(!0);const e=await(0,x.ff)(`/api/restaurants/${oe}/products/recipe-status`);if(e.success){R(e.data||[]);const i=[];e.data.forEach(e=>{e.category&&!i.includes(e.category)&&i.push(e.category)}),L(i)}}catch(e){console.error("Failed to fetch products:",e)}finally{_(!1)}},[oe]);(0,n.useEffect)(()=>{de()},[de]);const ce=async e=>{W(e),await(async()=>{try{const e=await(0,x.ff)(`/api/restaurants/${oe}/ingredients`);e.success&&Z(e.data||[])}catch(e){console.error("Failed to fetch ingredients:",e)}})(),e.has_recipe?await(async e=>{try{const i=await(0,x.ff)(`/api/restaurants/${oe}/products/${e}/recipe`);i.success&&i.data.recipe?G(i.data.recipe.ingredients||[]):G([])}catch(i){console.error("Failed to fetch product recipe:",i),G([])}})(e.id):G([]),D(!0)},le=async e=>{var i;W(e),H((null===(i=e.recipe_id)||void 0===i?void 0:i.toString())||""),await(async()=>{try{const e=await(0,x.ff)(`/api/restaurants/${oe}/recipes/available`);e.success&&Q(e.data||[])}catch(e){console.error("Failed to fetch recipes:",e)}})(),U(!0)},pe=()=>V.reduce((e,i)=>e+(i.total_cost||0),0),xe=E.filter(e=>{var i;const t=e.name.toLowerCase().includes($.toLowerCase())||(null===(i=e.code)||void 0===i?void 0:i.toLowerCase().includes($.toLowerCase())),n="all"===N||"with"===N&&e.has_recipe||"without"===N&&!e.has_recipe,r="all"===B||e.category===B;return t&&n&&r});return oe?(0,h.jsxs)(h.Fragment,{children:[(0,h.jsxs)(s.mc,{children:[(0,h.jsxs)(s.Y9,{children:[(0,h.jsx)(s.hE,{children:"Product Recipes"}),(0,h.jsx)(s.ex,{children:(0,h.jsx)(s.$n,{variant:"secondary",onClick:()=>window.location.href=`/restaurant/${oe}/recipe-management`,children:"Manage Recipes"})})]}),(0,h.jsxs)(s.UC,{children:[(0,h.jsx)(u,{children:"Link recipes to your menu items to track ingredient costs and manage inventory deduction when products are sold."}),(0,h.jsxs)(o.Qn,{children:[(0,h.jsx)(o.DO,{type:"text",placeholder:"Search products...",value:$,onChange:e=>P(e.target.value)}),(0,h.jsxs)(o.Jt,{value:N,onChange:e=>z(e.target.value),children:[(0,h.jsx)("option",{value:"all",children:"All Products"}),(0,h.jsx)("option",{value:"with",children:"With Recipe"}),(0,h.jsx)("option",{value:"without",children:"Without Recipe"})]}),(0,h.jsxs)(o.Jt,{value:B,onChange:e=>M(e.target.value),children:[(0,h.jsx)("option",{value:"all",children:"All Categories"}),I.map(e=>(0,h.jsx)("option",{value:e,children:e},e))]})]}),A?(0,h.jsx)(s.pp,{children:"Loading..."}):0===xe.length?(0,h.jsxs)(s.pp,{children:[(0,h.jsx)("div",{style:{fontSize:"16px",fontWeight:"600",marginBottom:"8px"},children:"No products found"}),(0,h.jsx)("div",{style:{fontSize:"14px"},children:"Add products in the Menu page first."})]}):(0,h.jsxs)(s.XI,{children:[(0,h.jsxs)(s.A0,{columns:"2fr 1fr 1fr 1fr 1fr 150px",children:[(0,h.jsx)("span",{className:"col-info",children:"Product"}),(0,h.jsx)("span",{className:"col-price",children:"Price"}),(0,h.jsx)("span",{children:"Recipe Status"}),(0,h.jsx)("span",{className:"col-cost",children:"Ingredient Cost"}),(0,h.jsx)("span",{className:"col-money",children:"Profit Margin"}),(0,h.jsx)("span",{className:"col-action",children:"Actions"})]}),xe.map(e=>(0,h.jsxs)(s.Hj,{columns:"2fr 1fr 1fr 1fr 1fr 150px",children:[(0,h.jsxs)(s.Np,{children:[(0,h.jsxs)(s.Uj,{className:"col-info",children:[(0,h.jsx)(s.PM,{children:"Product"}),(0,h.jsxs)(f,{children:[(0,h.jsx)(y,{children:e.name}),(0,h.jsxs)(j,{children:[e.category," ",e.code&&`- ${e.code}`]})]})]}),(0,h.jsxs)(s.Uj,{className:"col-price",children:[(0,h.jsx)(s.PM,{children:"Price"}),(0,h.jsx)("div",{style:{fontWeight:600,color:"#0A2540"},children:(0,p.vv)(e.price,a)})]}),(0,h.jsxs)(s.Uj,{children:[(0,h.jsx)(s.PM,{children:"Recipe Status"}),(0,h.jsx)(g,{hasRecipe:e.has_recipe,children:e.has_recipe?"Linked":"No Recipe"})]}),(0,h.jsxs)(s.Uj,{className:"col-cost",children:[(0,h.jsx)(s.PM,{children:"Ingredient Cost"}),(0,h.jsx)("div",{style:{color:e.has_recipe?"#0A2540":"#9CA3AF"},children:e.has_recipe?(0,p.vv)(e.ingredient_cost,a):"-"})]}),(0,h.jsxs)(s.Uj,{className:"col-money",children:[(0,h.jsx)(s.PM,{children:"Profit Margin"}),e.profit_margin?(0,h.jsxs)(m,{profit:parseFloat(e.profit_margin),children:[e.profit_margin,"%"]}):(0,h.jsx)("span",{style:{color:"#9CA3AF"},children:"-"})]})]}),(0,h.jsxs)(s.wr,{children:[(0,h.jsx)(s.$n,{variant:"primary",onClick:()=>ce(e),style:{padding:"6px 12px",fontSize:"12px"},children:e.has_recipe?"Edit":"Create"}),(0,h.jsx)(s.$n,{variant:"secondary",onClick:()=>le(e),style:{padding:"6px 12px",fontSize:"12px"},children:"Link"})]})]},e.id))]})]})]}),(0,h.jsx)(c.aF,{isOpen:O,onClose:()=>D(!1),title:`Recipe: ${(null===q||void 0===q?void 0:q.name)||""}`,size:"large",children:q&&(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(u,{children:"Add ingredients required to make this product. Costs are calculated automatically."}),(0,h.jsxs)("div",{style:{marginBottom:"16px"},children:[(0,h.jsx)("strong",{children:"Product Price:"})," ",(0,p.vv)(q.price,a)]}),V.length>0&&(0,h.jsx)(v,{children:V.map((e,i)=>(0,h.jsxs)(w,{children:[(0,h.jsxs)(b,{children:[(0,h.jsx)("div",{style:{fontWeight:600},children:e.ingredient_name}),(0,h.jsxs)("div",{style:{fontSize:"13px",color:"#6B7280"},children:[e.quantity," ",e.unit," x ",(0,p.vv)(e.unit_cost||0,a)]})]}),(0,h.jsx)("div",{style:{fontWeight:600,marginRight:"16px"},children:(0,p.vv)(e.total_cost||0,a)}),(0,h.jsx)(s.$n,{variant:"danger",onClick:()=>(e=>{G(V.filter((i,t)=>t!==e))})(i),style:{padding:"4px 8px",fontSize:"12px"},children:"Remove"})]},i))}),(0,h.jsxs)(F,{children:[(0,h.jsxs)(c.FX,{value:K,onChange:e=>{ee(e.target.value);const i=X.find(i=>i.id===parseInt(e.target.value));i&&re(i.unit)},children:[(0,h.jsx)("option",{value:"",children:"Select Ingredient"}),X.map(e=>{const i=e.unit_cost/(e.base_quantity||1);return(0,h.jsxs)("option",{value:e.id,children:[e.name," (",(0,p.vv)(i,a),"/",e.unit,")"]},e.id)})]}),(0,h.jsx)(c.ZQ,{type:"number",step:"0.01",min:"0",placeholder:"Quantity",value:ie,onChange:e=>te(e.target.value)}),(0,h.jsx)(c.ZQ,{type:"text",placeholder:"Unit",value:ne,onChange:e=>re(e.target.value)}),(0,h.jsx)(s.$n,{variant:"primary",onClick:()=>{if(!K||!ie||!ne)return;const e=X.find(e=>e.id===parseInt(K));if(!e)return;const i=parseFloat(ie),t=e.base_quantity||1,n=e.unit_cost/t,r={ingredient_id:e.id,ingredient_name:e.name,quantity:i,unit:ne,unit_cost:n,total_cost:n*i};G([...V,r]),ee(""),te(""),re("")},children:"Add"})]}),(0,h.jsxs)(C,{children:[(0,h.jsxs)(k,{children:[(0,h.jsx)("span",{children:"Total Ingredient Cost:"}),(0,h.jsx)("span",{children:(0,p.vv)(pe(),a)})]}),(0,h.jsxs)(k,{children:[(0,h.jsx)("span",{children:"Product Price:"}),(0,h.jsx)("span",{children:(0,p.vv)(q.price,a)})]}),(0,h.jsxs)(k,{children:[(0,h.jsx)("span",{children:"Profit Margin:"}),(0,h.jsx)("span",{children:q.price>0?`${((q.price-pe())/q.price*100).toFixed(1)}%`:"0%"})]})]}),(0,h.jsxs)("div",{style:{display:"flex",justifyContent:"flex-end",gap:"12px",marginTop:"24px"},children:[(0,h.jsx)(c.yl,{variant:"secondary",onClick:()=>D(!1),children:"Cancel"}),(0,h.jsx)(c.yl,{variant:"primary",onClick:async()=>{if(q)try{if(se(!0),q.has_recipe&&q.recipe_id){const e=await(0,x.ff)(`/api/restaurants/${oe}/products/${q.id}/recipe/ingredients`,{method:"PUT",body:JSON.stringify({ingredients:V.map(e=>({ingredient_id:e.ingredient_id,quantity:e.quantity,unit:e.unit,notes:e.notes}))})});e.success?(alert("Recipe updated successfully"),D(!1),de()):alert(e.message||"Failed to update recipe")}else{const e=await(0,x.ff)(`/api/restaurants/${oe}/products/${q.id}/recipe`,{method:"POST",body:JSON.stringify({name:`${q.name} Recipe`,ingredients:V.map(e=>({ingredient_id:e.ingredient_id,quantity:e.quantity,unit:e.unit,notes:e.notes}))})});e.success?(alert("Recipe created and linked successfully"),D(!1),de()):alert(e.message||"Failed to create recipe")}}catch(e){console.error("Failed to save recipe:",e),alert("Failed to save recipe")}finally{se(!1)}},disabled:ae,children:ae?"Saving...":"Save Recipe"})]})]})}),(0,h.jsx)(c.aF,{isOpen:T,onClose:()=>U(!1),title:`Link Recipe: ${(null===q||void 0===q?void 0:q.name)||""}`,size:"medium",children:q&&(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(u,{children:'Select an existing recipe to link to this product, or choose "No Recipe" to remove the current link.'}),(0,h.jsxs)(c.gE,{children:[(0,h.jsx)(c.lR,{children:"Select Recipe"}),(0,h.jsxs)(c.FX,{value:Y,onChange:e=>H(e.target.value),children:[(0,h.jsx)("option",{value:"",children:"No Recipe"}),J.map(e=>(0,h.jsxs)("option",{value:e.id,children:[e.name," ","brand"===e.owner_type?"(Brand)":""," - ",(0,p.vv)(e.total_ingredient_cost,a)]},e.id))]})]}),(0,h.jsxs)("div",{style:{display:"flex",justifyContent:"flex-end",gap:"12px",marginTop:"24px"},children:[(0,h.jsx)(c.yl,{variant:"secondary",onClick:()=>U(!1),children:"Cancel"}),(0,h.jsx)(c.yl,{variant:"primary",onClick:async()=>{if(q)try{se(!0);const e=await(0,x.ff)(`/api/restaurants/${oe}/products/${q.id}/recipe`,{method:"PUT",body:JSON.stringify({recipe_id:Y?parseInt(Y):null})});e.success?(alert(Y?"Recipe linked successfully":"Recipe unlinked successfully"),U(!1),de()):alert(e.message||"Failed to update recipe link")}catch(e){console.error("Failed to link recipe:",e),alert("Failed to update recipe link")}finally{se(!1)}},disabled:ae,children:ae?"Saving...":"Save"})]})]})})]}):(0,h.jsx)(h.Fragment,{children:(0,h.jsx)(s.mc,{children:(0,h.jsx)(s.pp,{children:(0,h.jsx)("p",{children:"Restaurant not found. Please log in with a restaurant account."})})})})}}}]);