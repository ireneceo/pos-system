...
`,b=r.Ay.div`
  ...
  border-bottom: 2px solid ${e=>{switch(e.status){case"pending":return"#F59E0B";case"preparing":return"#3B82F6";case"ready":return"#10B981";default:return"#E6EBF1"}}};
`,v=r.Ay.div`
  display: flex;
  align-items: center;
  gap: 8px;
...
`,V=r.Ay.div`
  margin-bottom: 4px;
`,W=()=>{const{user:e}=(0,a.As)(),{menuItems:t}=(0,o.b)(),[i,r]=(0,n.useState)([]),[W,Q]=(0,n.useState)(new Date),[,G]=(0,n.useState)(null),[X,ee]=(0,n.useState)(!1),[te,ie]=(0,n.useState)(null),ne=(0,n.useCallback)(async()=>{if(null!==e&&void 0!==e&&e.restaurantId)try{const t=localStorage.getItem("auth_token"),i=await fetch(`/api/orders/restaurant/${e.restaurantId}`,{credentials:"include",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}}),n=await i.json();if(n.success&&n.data){const e=n.data.filter(e=>["pending","preparing","ready"].includes(e.status)).map(e=>{let t=e.order_items||[];if("string"===typeof t)try{t=JSON.parse(t)}catch{t=[]}const i=[];return t.forEach((t,n)=>{if(t.is_set_menu&&t.set_items&&t.set_items.length>0){var r;const s=t.set_items.map((i,r)=>({...i,id:`item-${e.id}-${n}-set-${r}`,name:i.name,quantity:i.quantity*(t.quantity||1),status:i.status||"pending"}));i.push({...t,id:`item-${e.id}-${n}`,name:t.name||(null===(r=t.menuItem)||void 0===r?void 0:r.name)||"Set Menu",quantity:t.quantity,options:t.options||[],special_instructions:t.special_instructions||t.specialInstructions||"",status:t.status||"pending",is_set_menu:!0,set_items:s})}else{var s;i.push({...t,id:`item-${e.id}-${n}`,name:t.name||(null===(s=t.menuItem)||void 0===s?void 0:s.name)||"Item",quantity:t.quantity,options:t.options||[],special_instructions:t.special_instructions||t.specialInstructions||"",status:t.status||"pending",is_set_menu:!1})}}),{id:e.id.toString(),orderNumber:e.order_number,pickupNumber:e.order_number.split("-")[1]||e.order_number.slice(-3),pagerNumber:e.pager_number||void 0,items:i,status:e.status,orderTime:new Date(e.createdAt),paymentStatus:e.payment_status,customerName:e.customer_name||void 0,tableNumber:e.table_number||void 0,orderType:e.order_type||"dine-in",source:e.source||"pos",scheduledPickupTime:e.scheduled_pickup_time||null}});r(t=>{const i=new Set(t.map(e=>e.id));return e.filter(e=>!i.has(e.id)).length>0&&re(),e})}}catch(t){console.error("Failed to fetch orders:",t)}},[null===e||void 0===e?void 0:e.restaurantId]);(0,n.useEffect)(()=>{(async()=>{if(null!==e&&void 0!==e&&e.restaurantId)try{const t=localStorage.getItem("auth_token"),i=await fetch(`/api/restaurants/${e.restaurantId}`,{credentials:"include",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}});if(i.ok){const e=await i.json();ie(e.operation_settings)}}catch(t){console.error("Failed to load operation settings:",t)}})()},[null===e||void 0===e?void 0:e.restaurantId]),(0,n.useEffect)(()=>{ne();const e=setInterval(ne,3e4);return()=>clearInterval(e)},[ne]),(0,n.useEffect)(()=>{if(null===e||void 0===e||!e.restaurantId)return;const t=(0,s.Ay)("/orders",{transports:["websocket","polling"],reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10});return t.on("connect",()=>{ee(!0),t.emit("join-restaurant",e.restaurantId),ne()}),t.on("disconnect",()=>ee(!1)),t.on("connect_error",()=>ee(!1)),t.on("reconnect",()=>{ee(!0),ne()}),t.on("order-created",t=>{if(t.restaurant_id!==e.restaurantId)return;let i=t.order_items||[];if("string"===typeof i)try{i=JSON.parse(i)}catch{i=[]}const n=[];i.forEach((e,i)=>{const r=(e.special_instructions||"").match(/^\[(.*?)\]/);if(r){r[1].split(",").map(e=>e.trim()).forEach((r,s)=>{const a=r.match(/^(.*?)\s+x(\d+)$/);if(a){const[,r,o]=a;n.push({id:`item-${t.id}-${i}-set-${s}`,name:r.trim(),quantity:parseInt(o)*e.quantity,options:[],status:e.status||"pending",isSetItem:!0,parentSetName:e.name})}}),e.options&&e.options.length>0&&n.push({id:`item-${t.id}-${i}`,name:`${e.name} (Options)`,quantity:e.quantity,options:e.options,status:e.status||"pending"})}else{var s;n.push({id:`item-${t.id}-${i}`,name:e.name||(null===(s=e.menuItem)||void 0===s?void 0:s.name)||"Item",quantity:e.quantity,options:e.options||[],status:e.status||"pending"})}});const s={id:t.id.toString(),orderNumber:t.order_number,pickupNumber:t.order_number.split("-")[1]||t.order_number.slice(-3),items:n,status:t.status||"pending",orderTime:new Date(t.createdAt||Date.now()),tableNumber:t.table_number,customerName:t.customer_name,orderType:t.order_type||"dine-in",source:t.source||"pos",scheduledPickupTime:t.scheduled_pickup_time||null};r(e=>[s,...e]),re()}),t.on("order-updated",t=>{t.restaurant_id===e.restaurantId&&r(e=>e.map(e=>e.id===t.id.toString()?{...e,status:t.status,orderTime:new Date(t.createdAt)}:e).filter(e=>["pending","preparing","ready"].includes(e.status)))}),t.on("order-deleted",e=>{let{id:t}=e;r(e=>e.filter(e=>e.id!==t.toString()))}),G(t),()=>{t.disconnect()}},[null===e||void 0===e?void 0:e.restaurantId]),(0,n.useEffect)(()=>{const e=setInterval(()=>Q(new Date),1e3);return()=>clearInterval(e)},[]);const re=()=>{new Audio("/notification.mp3").play().catch(()=>{})},se=e=>{const i=(e=>{const i=t.find(t=>t.name===e);return(null===i||void 0===i?void 0:i.code)||""})(e);return i?`${i} ${e}`:e},ae=async function(e,t){(!(arguments.length>2&&void 0!==arguments[2])||arguments[2])&&r(i=>i.map(i=>i.id===e?{...i,status:t}:i).filter(e=>["pending","preparing","ready"].includes(e.status)));try{const i=localStorage.getItem("auth_token"),n=await fetch(`/api/orders/${e}/status`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{}},body:JSON.stringify({status:t})});(await n.json()).success||ne()}catch{ne()}},oe=e=>i.filter(t=>t.status===e).sort((e,t)=>e.orderTime.getTime()-t.orderTime.getTime()),de={pending:oe("pending").length,preparing:oe("preparing").length,ready:oe("ready").length},ce=e=>{const t=(s=e.orderTime,Math.floor((W.getTime()-s.getTime())/1e3/60));var s;const a=t>15&&"pending"===e.status,o=e.items.filter(e=>"completed"===e.status).length,d=e.items.length,c=d>0?o/d*100:0,u=(e=>{switch(e){case"pending":return"#F59E0B";case"preparing":return"#3B82F6";case"ready":return"#10B981";default:return"#6B7C93"}})(e.status);return(0,l.jsxs)($,{children:[(0,l.jsxs)(_,{children:[(0,l.jsxs)(k,{children:[(0,l.jsx)(F,{children:e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pagerNumber?`P${e.pagerNumber}`:`#${e.pickupNumber}`}),"takeaway"===e.orderType&&(0,l.jsx)(C,{children:"TAKEAWAY"}),"pickup"===e.orderType&&(0,l.jsxs)(C,{variant:"pickup",children:["PICKUP ",e.scheduledPickupTime?p(e.scheduledPickupTime):"ASAP"]}),"delivery"===e.orderType&&(0,l.jsx)(C,{variant:"delivery",children:"DELIVERY"})]}),(0,l.jsxs)(D,{children:[(0,l.jsx)(B,{children:e.orderNumber}),(0,l.jsxs)(S,{urgent:a,children:[t,"m"]})]})]}),"ready"!==e.status&&(0,l.jsxs)(E,{children:[(0,l.jsx)(I,{children:(0,l.jsx)(T,{percent:c,color:u})}),(0,l.jsxs)(z,{children:[o,"/",d]})]}),(0,l.jsx)(V,{children:e.items.map(t=>(0,l.jsxs)(n.Fragment,{children:[(0,l.jsxs)(N,{done:"completed"===t.status,children:[(0,l.jsxs)(q,{children:[(0,l.jsx)(P,{done:"completed"===t.status,children:se(t.name)}),t.options&&t.options.length>0&&(()=>{const e=[],i=[];return t.options.forEach(t=>{/^.+\sx\d+$/.test(t)?e.push(t):i.push(t)}),(0,l.jsxs)(l.Fragment,{children:[e.length>0&&(0,l.jsx)(M,{style:{fontWeight:600},children:e.join(", ")}),i.length>0&&(0,l.jsx)(M,{children:i.join(", ")})]})})(),t.special_instructions&&(0,l.jsx)(O,{children:t.special_instructions})]}),(0,l.jsxs)(J,{children:["x",t.quantity]}),!t.is_set_menu&&"ready"!==e.status&&(0,l.jsx)(K,{done:"completed"===t.status,statusColor:u,onClick:()=>(async(e,t)=>{try{const n=i.find(t=>t.id===e);if(!n)return;const s=n.items.map(e=>e.id===t?{...e,status:"completed"===e.status?"pending":"completed"}:e),a=s.every(e=>"completed"===e.status),o=localStorage.getItem("auth_token"),d=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...o?{Authorization:`Bearer ${o}`}:{}},body:JSON.stringify({order_items:s.map(e=>({...e,status:e.status}))})});if(!(await d.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:s}:t)),a&&"preparing"===n.status&&await ae(e,"ready",!0)}catch{ne()}})(e.id,t.id),children:(t.status,"Done")})]}),t.is_set_menu&&t.set_items&&t.set_items.length>0&&(0,l.jsx)(L,{children:t.set_items.map(n=>(0,l.jsxs)(H,{done:"completed"===n.status,children:[(0,l.jsxs)(Y,{done:"completed"===n.status,children:[se(n.name)," x",n.quantity]}),"ready"!==e.status&&(0,l.jsx)(K,{done:"completed"===n.status,statusColor:u,onClick:()=>(async(e,t,n)=>{try{const s=i.find(t=>t.id===e);if(!s)return;const a=s.items.map(e=>{if(e.id===t&&e.set_items){const t=e.set_items.map(e=>e.id===n?{...e,status:"completed"===e.status?"pending":"completed"}:e),i=t.every(e=>"completed"===e.status);return{...e,set_items:t,status:i?"completed":"pending"}}return e}),o=a.every(e=>"completed"===e.status),d=localStorage.getItem("auth_token"),c=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...d?{Authorization:`Bearer ${d}`}:{}},body:JSON.stringify({order_items:a.map(e=>({...e,status:e.status}))})});if(!(await c.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:a}:t)),o&&"preparing"===s.status&&await ae(e,"ready",!0)}catch{ne()}})(e.id,t.id,n.id),style:{padding:"2px 8px",fontSize:"10px"},children:(n.status,"Done")})]},n.id))})]},t.id))}),"pending"===e.status&&(0,l.jsx)(R,{children:(0,l.jsx)(U,{color:"#F59E0B",onClick:()=>ae(e.id,"preparing"),children:"Start Cooking"})}),"preparing"===e.status&&(0,l.jsxs)(R,{children:[(0,l.jsx)(U,{color:"#3B82F6",onClick:()=>(async e=>{try{const t=i.find(t=>t.id===e);if(!t)return;const n=t.items.map(e=>{const t={...e,status:"completed"};return e.set_items&&e.set_items.length>0&&(t.set_items=e.set_items.map(e=>({...e,status:"completed"}))),t}),s=localStorage.getItem("auth_token"),a=await fetch(`/api/orders/${e}/items`,{method:"PATCH",credentials:"include",headers:{"Content-Type":"application/json",...s?{Authorization:`Bearer ${s}`}:{}},body:JSON.stringify({order_items:n.map(e=>({...e,status:e.status}))})});if(!(await a.json()).success)return;r(t=>t.map(t=>t.id===e?{...t,items:n}:t)),await ae(e,"ready",!0)}catch{ne()}})(e.id),children:"Mark Ready"}),(0,l.jsx)(Z,{onClick:()=>ae(e.id,"pending"),children:"\u21ba"})]}),"ready"===e.status&&(0,l.jsxs)(R,{children:[(0,l.jsx)(U,{color:"#10B981",onClick:()=>ae(e.id,"served"),children:"Served"}),(0,l.jsx)(Z,{onClick:()=>ae(e.id,"preparing"),children:"\u21ba"})]})]},e.id)};return(0,l.jsxs)(u,{children:[(0,l.jsx)(d.Ay,{title:"Kitchen Display",children:(0,l.jsxs)(m,{children:[(0,l.jsxs)(g,{connected:X,children:[(0,l.jsx)(x,{connected:X}),X?"Live":"Offline"]}),(0,l.jsx)(h,{children:(0,c.fU)(W,te)})]})}),(0,l.jsxs)(y,{children:[(0,l.jsxs)(f,{children:[(0,l.jsxs)(b,{status:"pending",children:[(0,l.jsx)(v,{children:(0,l.jsx)(w,{children:"Pending"})}),(0,l.jsx)(j,{color:"#F59E0B",children:de.pending})]}),(0,l.jsx)(A,{children:oe("pending").map(ce)})]}),(0,l.jsxs)(f,{children:[(0,l.jsxs)(b,{status:"preparing",children:[(0,l.jsx)(v,{children:(0,l.jsx)(w,{children:"Preparing"})}),(0,l.jsx)(j,{color:"#3B82F6",children:de.preparing})]}),(0,l.jsx)(A,{children:oe("preparing").map(ce)})]}),(0,l.jsxs)(f,{children:[(0,l.jsxs)(b,{status:"ready",children:[(0,l.jsx)(v,{children:(0,l.jsx)(w,{children:"Ready"})}),(0,l.jsx)(j,{color:"#10B981",children:de.ready})]}),(0,l.jsx)(A,{children:oe("ready").map(ce)})]})]})]})}},8012:(e,t,i)=>{i.d(t,{Ay:()=>d});i(9950);var n=i(4752),r=i(4414);const s=n.Ay.div`
  background: white;
  padding: 16px 32px;
