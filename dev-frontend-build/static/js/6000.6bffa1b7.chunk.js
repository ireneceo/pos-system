"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[6e3],{6e3:(t,e,r)=>{r.r(e),r.d(e,{default:()=>W});var a=r(9950),o=r(4752),s=r(8819),n=r(1367),i=r(9018),d=r(3422),c=r(8406),l=r(5030),u=r(9955),p=r(4414);const g=o.i7`
  from {
    opacity: 0;
...
`,A=o.Ay.div`
  ...
  animation: ${t=>t.isNew?o.AH`${g} 0.5s ease-out`:"none"};
...
`,C=o.Ay.div`
  ...
  color: ${s.w.colors.text.secondary};
  font-size: ${s.w.typography.fontSize.lg};
`,W=()=>{const{t:t}=(0,l.Bd)("pos"),{user:e}=(0,n.As)(),{operationSettings:r}=(0,i.Pj)(),[o,s]=(0,a.useState)([]),[g,m]=(0,a.useState)([]),[W,L]=(0,a.useState)(new Set),[,R]=(0,a.useState)(null),[Y,Z]=(0,a.useState)({date:"",time:""}),F=(0,c.ng)(r);(0,a.useEffect)(()=>{const t=()=>{const t=new Date,e=t.toLocaleDateString("en-US",{timeZone:F,weekday:"short",year:"numeric",month:"short",day:"numeric"}),r=t.toLocaleTimeString("en-US",{timeZone:F,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});Z({date:e,time:r})};t();const e=setInterval(t,1e3);return()=>clearInterval(e)},[F]);const B=(0,a.useCallback)(async()=>{if(null!==e&&void 0!==e&&e.restaurantId)try{const t=(0,u.c4)(),r={credentials:"include",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}},a=(0,c.oB)(F),[o,n]=await Promise.all([fetch(`/api/orders/restaurant/${e.restaurantId}?status=preparing&limit=100&startDate=${a}&endDate=${a}`,r),fetch(`/api/orders/restaurant/${e.restaurantId}?status=ready&limit=100&startDate=${a}&endDate=${a}`,r)]),i=await o.json(),d=await n.json(),l=[...i.success?i.data:[],...d.success?d.data:[]];s(l)}catch(t){console.error("Failed to fetch orders:",t)}},[null===e||void 0===e?void 0:e.restaurantId,F]);(0,a.useEffect)(()=>{if(null===e||void 0===e||!e.restaurantId)return;const t=(0,d.io)("/orders",{transports:["websocket","polling"]});return t.on("connect",()=>{console.log("Connected to /orders namespace"),t.emit("join-restaurant",e.restaurantId)}),t.on("order-created",t=>{console.log("New order received:",t),s(e=>[t,...e])}),t.on("order-updated",t=>{console.log("Order updated:",t),s(e=>e.map(e=>e.id===t.id?t:e))}),t.on("order-deleted",t=>{let{id:e}=t;console.log("Order deleted:",e),s(t=>t.filter(t=>t.id!==e))}),R(t),()=>{t.disconnect()}},[null===e||void 0===e?void 0:e.restaurantId]),(0,a.useEffect)(()=>{B()},[B]),(0,a.useEffect)(()=>{const t=(t=>t.filter(t=>("preparing"===t.status||"ready"===t.status)&&"delivery"!==t.order_type).map(t=>({id:String(t.id),orderNumber:t.order_number,pickupNumber:t.order_number.split("-")[1]||String(t.id).padStart(3,"0"),tableNumber:t.table_number,orderType:t.order_type,status:t.status,customerName:t.customer_name||"Guest",items:Array.isArray(t.order_items)?t.order_items.map(t=>{var e;return{name:t.name||(null===(e=t.menuItem)||void 0===e?void 0:e.name)||"Item",quantity:t.quantity||1}}):[],createdAt:t.createdAt,estimatedTime:15})))(o);m(e=>{const r=new Set(e.map(t=>t.id)),a=t.filter(t=>!r.has(t.id)).map(t=>t.id);return a.length>0&&(L(new Set(a)),setTimeout(()=>{L(new Set)},1e3)),t})},[o]);const E=t=>{let e;if(t.includes(":")&&!t.includes("T")){const r=new Date,a=t.replace(/\s*(AM|PM)/i," $1");e=new Date(`${r.toDateString()} ${a}`)}else e=new Date(t);return e.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0,timeZone:F})},U=t=>{if("ready"===t.status)return"Ready for Pickup";const e=new Date(t.createdAt),r=new Date,a=Math.floor((r.getTime()-e.getTime())/1e3/60),o=t.estimatedTime||15,s=Math.max(0,o-a);return 0===s?"Almost Ready":`About ${s} min wait`},q=t=>{switch(t){case"dine_in":return"Dine In";case"takeaway":return"Takeaway";case"pickup":return"Pre-order";default:return""}},K=[...g.filter(t=>"ready"===t.status),...g.filter(t=>"preparing"===t.status)];return(0,p.jsxs)(y,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)("div",{style:{minWidth:180}}),(0,p.jsxs)(h,{children:[(0,p.jsx)(b,{children:t("pos:customerDisplayPage.orderStatus")}),(0,p.jsx)(S,{children:t("pos:customerDisplayPage.pleaseCheckYourPickupNumber")})]}),(0,p.jsxs)(f,{children:[(0,p.jsx)($,{children:Y.date}),(0,p.jsx)(x,{children:Y.time})]})]}),(0,p.jsx)(v,{children:0===K.length?(0,p.jsx)(C,{children:"No orders in progress"}):K.map(e=>(0,p.jsxs)(A,{status:e.status,isNew:W.has(e.id),children:[(0,p.jsxs)(j,{children:[(0,p.jsx)(D,{status:e.status,children:e.tableNumber?`T${e.tableNumber.replace(/^T/i,"")}`:e.pickupNumber}),(0,p.jsx)(z,{status:e.status,children:e.tableNumber?"ready"===e.status?"Ready - Table Service":"Preparing":"ready"===e.status?"Ready for Pickup":"preparing"===e.status?"Preparing":"Completed"})]}),(0,p.jsxs)(k,{children:[e.customerName&&(0,p.jsx)(T,{children:e.customerName}),(0,p.jsxs)(N,{children:[E(e.createdAt),e.orderType&&q(e.orderType)&&(0,p.jsxs)(p.Fragment,{children:[" / ",q(e.orderType)]})]})]}),(0,p.jsx)(M,{status:e.status,children:U(e)}),(0,p.jsxs)(I,{children:[(0,p.jsx)(P,{children:t("pos:customerDisplayPage.orderItems")}),e.items.map((t,e)=>(0,p.jsxs)(_,{children:[(0,p.jsx)("span",{children:t.name}),(0,p.jsxs)("span",{children:[t.quantity,"x"]})]},e))]})]},e.id))})]})}},8406:(t,e,r)=>{r.d(e,{MQ:()=>d,Vp:()=>i,fU:()=>s,ng:()=>a,oB:()=>n,r6:()=>o});const a=t=>(null===t||void 0===t?void 0:t.timeZone)||"Asia/Kuala_Lumpur",o=(t,e,r)=>{if(!t)return"";const o=new Date(t);if(isNaN(o.getTime()))return"";const s={year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!0,timeZone:a(e)};return o.toLocaleString("en-MY",{...s,...r})},s=(t,e)=>o(t,e,{year:void 0,month:void 0,day:void 0}),n=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Asia/Kuala_Lumpur";try{const e=new Date;return new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).format(e)}catch{const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`}},i=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"Asia/Kuala_Lumpur";try{const r=new Date;r.setDate(r.getDate()+t);return new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(r)}catch{const e=new Date;return e.setDate(e.getDate()+t),`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}},d=t=>{if(!t)return"just now";const e=new Date(t).getTime();if(isNaN(e))return"just now";const r=Date.now()-e,a=Math.floor(r/6e4),o=Math.floor(r/36e5),s=Math.floor(r/864e5);return a<1?"just now":1===a?"1 min ago":a<60?`${a} mins ago`:1===o?"1 hour ago":o<24?`${o} hours ago`:1===s?"1 day ago":`${s} days ago`}}}]);