...
`,f=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",j=e=>{let{value:t,onChange:r,label:a="Logo Upload",helpText:j="Upload an image for your logo",maxSize:v=2,previewSize:k=150,showRemoveButton:w=!0,changeButtonText:C="Change Image",removeButtonText:F="Remove Image",imageAltText:A="Uploaded"}=e;const[S,B]=(0,n.useState)(!1),[E,D]=(0,n.useState)(!1),P=(0,n.useRef)(null),z=(0,n.useRef)(null),N=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*v*1024)return void alert(`Image size should be less than ${v}MB`);D(!0);const t=new FileReader;t.onload=async e=>{var t;const n=new Image;n.onload=async()=>{const e=document.createElement("canvas"),t=e.getContext("2d");if(!t)return void D(!1);const a=1200;let i=n.width,o=n.height;(i>a||o>a)&&(i>o?(o=o/i*a,i=a):(i=i/o*a,o=a)),e.width=i,e.height=o,t.drawImage(n,0,0,i,o);const s=e.toDataURL("image/jpeg",.85),l=await(async e=>{try{const t=localStorage.getItem("auth_token"),r=await fetch(`${f()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({image:e})}),n=await r.json();return n.success?n.data.original:(console.error("Image upload failed:",n.message),null)}catch(t){return console.error("Image upload error:",t),null}})(s);D(!1),l?r(l):alert("Failed to upload image. Please try again.")},n.src=null===(t=e.target)||void 0===t?void 0:t.result},t.readAsDataURL(e)},I=e=>{if(E)return;const t=e.target.files;t&&t.length>0&&N(t[0]),e.target.value=""};return(0,i.jsxs)(o,{children:[a&&(0,i.jsx)(s,{children:a}),j&&(0,i.jsx)(l,{children:j}),(0,i.jsxs)(c,{children:[(0,i.jsx)(d,{ref:z,isDragging:S,hasImage:!!t,isUploading:E,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),E||B(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===z.current&&B(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),B(!1),E)return;const t=e.dataTransfer.files;t&&t.length>0&&N(t[0])},onClick:()=>{var e;t||E||(null===(e=P.current)||void 0===e||e.click())},children:E?(0,i.jsxs)(p,{children:[(0,i.jsx)(y,{}),(0,i.jsx)(h,{style:{marginTop:"12px"},children:"Uploading..."})]}):t?(0,i.jsx)("img",{src:(T=t,T?T.startsWith("http")?T:T.startsWith("/uploads/")?`${f()}${T}`:T:""),alt:A}):(0,i.jsxs)(p,{children:[(0,i.jsx)(h,{children:S?"Drop image here":"Drag & drop or click to upload"}),(0,i.jsxs)(x,{children:["PNG, JPG, GIF up to ",v,"MB"]})]})}),t&&!E&&(0,i.jsxs)(g,{children:[(0,i.jsxs)(u,{disabled:E,children:[C,(0,i.jsx)("input",{ref:P,type:"file",accept:"image/*",onChange:I,disabled:E})]}),w&&(0,i.jsx)(m,{onClick:()=>{r("")},disabled:E,children:F})]})]}),!t&&!E&&(0,i.jsx)(b,{ref:P,type:"file",accept:"image/*",onChange:I})]});var T}},8012:(e,t,r)=>{r.d(t,{Ay:()=>l});r(9950);var n=r(4752),a=r(4414);const i=n.Ay.div`
  background: white;
  padding: 16px 32px;
  border-bottom: 1px solid #E6EBF1;
  margin-bottom: 0;
...
`,l=e=>{let{title:t,children:r}=e;return(0,a.jsxs)(i,{children:[(0,a.jsx)(o,{children:t}),r&&(0,a.jsx)(s,{children:r})]})}},9133:(e,t,r)=>{r.r(t),r.d(t,{default:()=>U});var n=r(9950),a=r(4752),i=r(8012),o=r(8409),s=r(2597),l=r(9610),c=r(4877),d=r(1367),p=r(4414);const h=a.Ay.div`
  min-height: 100vh;
`,x=a.Ay.div`
  padding: 32px;
