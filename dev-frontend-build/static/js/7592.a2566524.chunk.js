...
`,j=()=>"localhost"===window.location.hostname?"http://localhost:3000":"dev.purplehere.com"===window.location.hostname?"https://dev.purplehere.com":"https://purplehere.com",v=e=>{let{value:n,onChange:r,label:i="Logo Upload",helpText:v="Upload an image for your logo",maxSize:f=2,previewSize:C=150,showRemoveButton:w=!0,changeButtonText:k="Change Image",removeButtonText:_="Remove Image",imageAltText:F="Uploaded"}=e;const[A,B]=(0,t.useState)(!1),[S,P]=(0,t.useState)(!1),T=(0,t.useRef)(null),z=(0,t.useRef)(null),R=async e=>{try{const n=localStorage.getItem("auth_token"),r=await fetch(`${j()}/api/upload/image`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({image:e})}),t=await r.json();return t.success?t.data.original:(console.error("Image upload failed:",t.message),null)}catch(n){return console.error("Image upload error:",n),null}},I=async e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*f*1024)return void alert(`Image size should be less than ${f}MB`);if(P(!0),"image/svg+xml"===e.type){const n=new FileReader;return n.onload=async e=>{var n;const t=null===(n=e.target)||void 0===n?void 0:n.result,i=await R(t);P(!1),i?r(i):alert("Failed to upload image. Please try again.")},void n.readAsDataURL(e)}const n=new FileReader;n.onload=async n=>{var t;const i=new Image;i.onload=async()=>{const n=document.createElement("canvas"),t=n.getContext("2d");if(!t)return void P(!1);const o=1200;let a=i.width,s=i.height;(a>o||s>o)&&(a>s?(s=s/a*o,a=o):(a=a/s*o,s=o)),n.width=a,n.height=s,t.drawImage(i,0,0,a,s);const l="image/png"===e.type?n.toDataURL("image/png"):n.toDataURL("image/jpeg",.85),d=await R(l);P(!1),d?r(d):alert("Failed to upload image. Please try again.")},i.src=null===(t=n.target)||void 0===t?void 0:t.result},n.readAsDataURL(e)},E=e=>{if(S)return;const n=e.target.files;n&&n.length>0&&I(n[0]),e.target.value=""};return(0,o.jsxs)(a,{children:[i&&(0,o.jsx)(s,{children:i}),v&&(0,o.jsx)(l,{children:v}),(0,o.jsxs)(d,{children:[(0,o.jsx)(c,{ref:z,isDragging:A,hasImage:!!n,isUploading:S,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),S||B(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===z.current&&B(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{if(e.preventDefault(),e.stopPropagation(),B(!1),S)return;const n=e.dataTransfer.files;n&&n.length>0&&I(n[0])},onClick:()=>{var e;n||S||(null===(e=T.current)||void 0===e||e.click())},children:S?(0,o.jsxs)(p,{children:[(0,o.jsx)(b,{}),(0,o.jsx)(g,{style:{marginTop:"12px"},children:"Uploading..."})]}):n?(0,o.jsx)("img",{src:(D=n,D?D.startsWith("http")?D:D.startsWith("/uploads/")?`${j()}${D}`:D:""),alt:F}):(0,o.jsxs)(p,{children:[(0,o.jsx)(g,{children:A?"Drop image here":"Drag & drop or click to upload"}),(0,o.jsxs)(x,{children:["PNG, JPG, GIF up to ",f,"MB"]})]})}),n&&!S&&(0,o.jsxs)(h,{children:[(0,o.jsxs)(u,{disabled:S,children:[k,(0,o.jsx)("input",{ref:T,type:"file",accept:"image/*",onChange:E,disabled:S})]}),w&&(0,o.jsx)(m,{onClick:()=>{r("")},disabled:S,children:_})]})]}),!n&&!S&&(0,o.jsx)(y,{ref:T,type:"file",accept:"image/*",onChange:E})]});var D}},7592:(e,n,r)=>{r.r(n),r.d(n,{default:()=>H});var t=r(9950),i=r(4752),o=r(9163),a=r(8409),s=r(1367),l=r(9018),d=r(8930),c=r(755),p=r(3705),g=r(4877),x=r(8666),h=r(8012),u=r(2653),m=r(5863),y=r(6038),b=r(4414);const j=i.Ay.div`
