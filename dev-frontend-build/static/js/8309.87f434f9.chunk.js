"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[8309],{8285:(e,r,n)=>{n.d(r,{MA:()=>h});const t="cash",i="card",s="ewallet",o="bank_transfer",a="qr",d="counter",l="online",c="fpx",x={[t]:"Cash",[i]:"Credit/Debit Card",[s]:"E-Wallet",[o]:"Bank Transfer",[a]:"QR Payment",[d]:"Pay at Counter",[l]:"Online Payment",[c]:"FPX Online Banking"};const p={visa:"Visa",master:"Master",amex:"Amex",other:"Other"};function h(e,r){return e?"card"===e&&r?`Card(${p[r]||r})`:function(e){return x[e]||e}(e):"N/A"}},8309:(e,r,n)=>{n.r(r),n.d(r,{default:()=>V});var t=n(9950),i=n(4492),s=n(4752),o=n(8409),a=n(3224),d=n(1367),l=n(4021),c=n(8608),x=n(6038),p=n(8285),h=n(4414);const u=s.Ay.div`
  min-height: 100vh;
