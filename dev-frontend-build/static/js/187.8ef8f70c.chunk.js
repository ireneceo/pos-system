"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[187],{187:(e,n,r)=>{r.r(n),r.d(n,{default:()=>V});var t=r(9950),i=r(4752),a=r(9163),o=r(3310),s=r(7492),l=r(1367),d=r(9018),c=r(8930),p=r(755),x=r(3705),g=r(4669),h=r(4492);var u=r(5863),y=r(4414);const m=i.Ay.div`
...
`,m=i.Ay.input`
  display: none;
`,v=e=>{let{value:n,onChange:r,label:i="Logo Upload",helpText:v="Upload an image for your logo",maxSize:j=2,previewSize:b=150,showRemoveButton:C=!0,changeButtonText:f="Change Image",removeButtonText:S="Remove Image",imageAltText:T="Uploaded"}=e;const[k,F]=(0,t.useState)(!1),B=(0,t.useRef)(null),w=(0,t.useRef)(null),A=e=>{if(!e.type.startsWith("image/"))return void alert("Please upload an image file");if(e.size>1024*j*1024)return void alert(`Image size should be less than ${j}MB`);const n=new FileReader;n.onload=e=>{var n;const t=new Image;t.onload=()=>{const e=document.createElement("canvas"),n=e.getContext("2d");if(!n)return;const i=800;let a=t.width,o=t.height;(a>i||o>i)&&(a>o?(o=o/a*i,a=i):(a=a/o*i,o=i)),e.width=a,e.height=o,n.drawImage(t,0,0,a,o);const s=e.toDataURL("image/jpeg",.85);r(s)},t.src=null===(n=e.target)||void 0===n?void 0:n.result},n.readAsDataURL(e)},P=e=>{const n=e.target.files;n&&n.length>0&&A(n[0])};return(0,a.jsxs)(o,{children:[i&&(0,a.jsx)(s,{children:i}),v&&(0,a.jsx)(l,{children:v}),(0,a.jsxs)(d,{children:[(0,a.jsx)(c,{ref:w,isDragging:k,hasImage:!!n,onDragEnter:e=>{e.preventDefault(),e.stopPropagation(),F(!0)},onDragLeave:e=>{e.preventDefault(),e.stopPropagation(),e.currentTarget===w.current&&F(!1)},onDragOver:e=>{e.preventDefault(),e.stopPropagation()},onDrop:e=>{e.preventDefault(),e.stopPropagation(),F(!1);const n=e.dataTransfer.files;n&&n.length>0&&A(n[0])},onClick:()=>{var e;n||(null===(e=B.current)||void 0===e||e.click())},children:n?(0,a.jsx)("img",{src:n,alt:T}):(0,a.jsxs)(p,{children:[(0,a.jsx)(x,{children:k?"Drop image here":"Drag & drop or click to upload"}),(0,a.jsxs)(g,{children:["PNG, JPG, GIF up to ",j,"MB"]})]})}),n&&(0,a.jsxs)(h,{children:[(0,a.jsxs)(u,{children:[f,(0,a.jsx)("input",{ref:B,type:"file",accept:"image/*",onChange:P})]}),C&&(0,a.jsx)(y,{onClick:()=>{r("")},children:S})]})]}),!n&&(0,a.jsx)(m,{ref:B,type:"file",accept:"image/*",onChange:P})]})}}}]);