"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[5747],{5747:(e,t,r)=>{r.r(t),r.d(t,{default:()=>Ne});var n=r(9950),o=r(4752),i=r(4492),a=r(1367),s=r(7447),d=r(5783),l=r(6038),c=r(8285),p=r(9018),u=r(5863),x=r(9189),h=r(8409),g=r(4414);const m=o.Ay.div`
  width: 380px;
  min-width: 380px;
  background: white;
...
`,xe=e=>{let{tables:t,tableStatuses:r,currency:n}=e;const o=t.length,i={available:0,occupied:0,ready:0,"needs-attention":0};let a=0,d=0,c=0;t.forEach(e=>{const t=r[e.tableNumber],n=(null===t||void 0===t?void 0:t.status)||"available";i[n]++,"available"!==n&&t&&(a+=t.totalAmount,d+=t.elapsedMinutes,c++)});const p=c>0?Math.round(d/c):0;return(0,g.jsxs)(ae,{children:[(0,g.jsx)(se,{children:Object.keys(s.Ez).map(e=>(0,g.jsxs)(de,{children:[(0,g.jsx)(le,{$color:s.Ez[e].border}),s.Zt[e]]},e))}),(0,g.jsx)(ce,{}),(0,g.jsxs)(pe,{children:[(0,g.jsxs)(ue,{children:["Tables: ",(0,g.jsx)("span",{children:o})]}),(0,g.jsxs)(ue,{children:["Avail: ",(0,g.jsx)("span",{children:i.available})]}),(0,g.jsxs)(ue,{children:["Occupied: ",(0,g.jsx)("span",{children:i.occupied})]}),i.ready>0&&(0,g.jsxs)(ue,{children:["Ready: ",(0,g.jsx)("span",{children:i.ready})]}),i["needs-attention"]>0&&(0,g.jsxs)(ue,{children:["Attn: ",(0,g.jsx)("span",{children:i["needs-attention"]})]}),(0,g.jsx)(ce,{}),(0,g.jsxs)(ue,{children:["Today: ",(0,g.jsx)("span",{children:(0,l.vv)(a,n)})]}),p>0&&(0,g.jsxs)(ue,{children:["Avg: ",(0,g.jsxs)("span",{children:[p,"min"]})]})]})]})};var he=r(2966),ge=r(8406),me=r(3577),ye=r(3422);const be=o.Ay.div`
...
`,De=o.Ay.iframe`
  ...
  width: 100%;
  border: none;
`,Ne=()=>{var e;const{restaurantId:t}=(0,i.g)(),r=(0,i.Zp)(),{user:o}=(0,a.As)(),[l,c]=(0,n.useState)(s.He),[p,u]=(0,n.useState)({}),[x,h]=(0,n.useState)(!1),[m,y]=(0,n.useState)(""),[b,f]=(0,n.useState)(!0),[v,j]=(0,n.useState)(""),[C,A]=(0,n.useState)("Asia/Kuala_Lumpur"),w=(0,n.useRef)(null),F=(0,n.useRef)(null),k=(0,n.useRef)(null),[S,$]=(0,n.useState)(null),[E,B]=(0,n.useState)(0),[I,z]=(0,n.useState)(!1),[_,T]=(0,n.useState)(null),[D,N]=(0,n.useState)(null),[O,P]=(0,n.useState)(!1),[R,M]=(0,n.useState)(!1),[W,H]=(0,n.useState)(""),[L,q]=(0,n.useState)(null);(0,n.useEffect)(()=>{const e=()=>{const e=new Date;y(e.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:C}))};e();const t=setInterval(e,3e4);return()=>clearInterval(t)},[C]);const J=(0,n.useCallback)(async()=>{try{const e=localStorage.getItem("auth_token"),r=await fetch(`/api/restaurants/${t}/table-status`,{headers:{Authorization:`Bearer ${e}`}});if(r.ok){const e=await r.json();u(e.data||{})}}catch(e){console.error("Failed to fetch table statuses:",e)}},[t]),V=(0,n.useCallback)(()=>{w.current&&clearTimeout(w.current),w.current=setTimeout(()=>J(),2e3)},[J]);(0,n.useEffect)(()=>{(async()=>{try{const e=localStorage.getItem("auth_token"),r=await fetch(`/api/restaurants/${t}`,{headers:{Authorization:`Bearer ${e}`}});if(!r.ok)return;const n=await r.json(),o=n.data||n;if(o.floor_plan&&c(o.floor_plan),o.currency&&j(o.currency),o.operation_settings){const e="string"===typeof o.operation_settings?JSON.parse(o.operation_settings):o.operation_settings;A((0,ge.ng)(e))}o.payment_settings&&T(o.payment_settings)}catch(e){console.error("Failed to load floor plan:",e)}finally{f(!1)}})(),(async()=>{try{const e=localStorage.getItem("auth_token"),r=await fetch(`/api/membership/settings/${t}`,{headers:{Authorization:`Bearer ${e}`}}),n=await r.json();n.success&&n.data&&N(n.data)}catch(e){}})(),J()},[t,J]),(0,n.useEffect)(()=>{if(!t)return;const e=(0,ye.Ay)("/orders",{transports:["websocket","polling"],reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10});return e.on("connect",()=>{h(!0),e.emit("join-restaurant",t),J()}),e.on("disconnect",()=>h(!1)),e.on("order-updated",()=>V()),e.on("order-created",()=>V()),e.on("order-items-added",e=>{V(),q({isVisible:!0,orderId:e.orderId,orderNumber:e.orderNumber,tableNumber:e.tableNumber,orderGroup:e.orderGroup,itemCount:e.itemCount})}),e.on("new-order",()=>V()),F.current=e,()=>{e.disconnect(),F.current=null}},[t,J,V]),(0,n.useEffect)(()=>{if(!t)return;const e=(0,ye.Ay)("/checkout-display",{transports:["websocket","polling"]});return e.on("connect",()=>e.emit("join-restaurant",t)),e.on("customer-checkin",e=>{}),k.current=e,()=>{e.disconnect(),k.current=null}},[t]),(0,n.useEffect)(()=>{const e=setInterval(()=>J(),3e4);return()=>clearInterval(e)},[J]),(0,n.useEffect)(()=>{const e=e=>{var t,r;"pos-order-complete"!==(null===(t=e.data)||void 0===t?void 0:t.type)&&"pos-close"!==(null===(r=e.data)||void 0===r?void 0:r.type)||(M(!1),H(""),J())};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[J]);const U=S?p[S]:void 0,G=(null===U||void 0===U?void 0:U.orders)||(U?[U]:[]),Z=Math.min(E,Math.max(G.length-1,0)),Y=G.length>0?G[Z]:U,K=S?l.tables.find(e=>e.tableNumber===S):void 0;return b?(0,g.jsxs)(be,{children:[(0,g.jsx)(fe,{children:(0,g.jsx)(ve,{children:(0,g.jsx)(je,{children:"Floor Plan"})})}),(0,g.jsx)(Be,{children:"Loading floor plan..."})]}):(0,g.jsxs)(be,{children:[(null===L||void 0===L?void 0:L.isVisible)&&(0,g.jsxs)("div",{style:{position:"fixed",top:"20px",right:"20px",background:"#FEF3C7",border:"2px solid #F59E0B",borderRadius:"12px",padding:"16px 20px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",zIndex:1e4,maxWidth:"320px",animation:"slideInRight 0.3s ease-out"},children:[(0,g.jsx)("style",{children:"@keyframes slideInRight { from { transform: translateX(100%); opacity: 0; } to { transform: translateX(0); opacity: 1; } }"}),(0,g.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},children:[(0,g.jsx)("div",{style:{fontWeight:700,fontSize:"15px",color:"#92400E"},children:"New Items Added"}),(0,g.jsx)("button",{onClick:()=>q(null),style:{background:"none",border:"none",fontSize:"20px",cursor:"pointer",color:"#92400E",padding:"0",lineHeight:1},children:"\xd7"})]}),(0,g.jsxs)("div",{style:{color:"#78350F",fontSize:"14px",marginBottom:"12px"},children:[(0,g.jsxs)("strong",{children:["Order ",L.orderNumber]}),L.tableNumber&&` (Table ${L.tableNumber})`,(0,g.jsx)("br",{}),(0,g.jsxs)("span",{style:{background:"#FCD34D",padding:"2px 8px",borderRadius:"4px",fontWeight:600},children:["+Order ",L.orderGroup]})," ",L.itemCount," item",L.itemCount>1?"s":""," added"]}),(0,g.jsx)("button",{onClick:()=>{L.tableNumber&&$(L.tableNumber),q(null)},style:{width:"100%",padding:"10px",background:"#F59E0B",color:"white",border:"none",borderRadius:"8px",fontWeight:600,cursor:"pointer",fontSize:"14px"},children:"View Table"})]}),(0,g.jsxs)(fe,{children:[(0,g.jsxs)(ve,{children:[(0,g.jsx)(Se,{onClick:()=>r(`/restaurant/${t}/dashboard`),children:"\u2190 Back"}),(0,g.jsx)(je,{children:"Floor Plan"}),(0,g.jsxs)(Ae,{children:[(0,g.jsx)(Ce,{$connected:x}),x?"Live":"Offline"]})]}),(0,g.jsxs)(we,{children:[(0,g.jsx)(Fe,{children:m}),(0,g.jsxs)(ke,{onClick:()=>P(!0),children:[(0,g.jsx)("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{width:"14px",height:"14px",verticalAlign:"middle",marginRight:"4px"},children:(0,g.jsx)("path",{d:"M6 9V2H18V9M6 18H4C2.89543 18 2 17.1046 2 16V11C2 9.89543 2.89543 9 4 9H20C21.1046 9 22 9.89543 22 11V16C22 17.1046 21.1046 18 20 18H18M6 14H18V22H6V14Z",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),"Daily Settlement"]}),"Restaurant Admin"===(null===o||void 0===o?void 0:o.role)&&(0,g.jsx)(ke,{onClick:()=>r(`/restaurant/${t}/floor-plan-editor`),children:"Edit Layout"})]})]}),(0,g.jsxs)($e,{children:[(0,g.jsx)(Ee,{children:(0,g.jsx)(d.A,{floorPlan:l,tableStatuses:p,onTableClick:e=>{$(t=>t===e?null:e),B(0)},selectedTableId:S?null===(e=l.tables.find(e=>e.tableNumber===S))||void 0===e?void 0:e.id:null,currency:v})}),S&&(0,g.jsx)(ie,{tableNumber:S,statusInfo:Y,tableInfo:K,currency:v,timezone:C,restaurantId:Number(t),onClose:()=>$(null),onNewOrder:()=>{if(!S)return;const e=new URLSearchParams;e.set("table",S),e.set("from","floor-plan-overlay"),H(`/restaurant/${t}/pos-terminal?${e.toString()}`),M(!0)},onStatusChange:async(e,t)=>{try{const r=localStorage.getItem("auth_token");(await fetch(`/api/orders/${e}/status`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({status:t})})).ok&&await J()}catch(r){console.error("Failed to update order status:",r)}},onPayment:()=>{if(z(!0),k.current&&S){const r=p[S];if(r){var e;const n=(null===(e=r.items)||void 0===e?void 0:e.map(e=>({name:e.name||e.menu_item_name||"Item",quantity:e.quantity||1,price:parseFloat(e.price)||0,options:e.options||[]})))||[];k.current.emit("cart-update",{restaurantId:t,items:n,subtotal:parseFloat(r.subtotal||r.totalAmount)||0,tax:parseFloat(r.tax)||0,taxRate:0,serviceCharge:parseFloat(r.serviceCharge)||0,serviceChargeRate:0,discount:parseFloat(r.discount)||0,total:parseFloat(r.totalAmount)||0,currency:"MYR"})}}},onNavigateToPOS:()=>{S&&r(`/restaurant/${t}/pos-terminal?table=${S}&from=floor-plan`)},onOrderUpdated:J,onClearTable:async e=>{try{const t=localStorage.getItem("auth_token");await fetch(`/api/orders/${e}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({table_number:null})}),$(null),await J()}catch(t){console.error("Failed to clear table:",t)}},onClearAllCompleted:async()=>{if(S)try{const e=localStorage.getItem("auth_token"),t=G.filter(e=>"completed"===e.orderStatus);await Promise.all(t.map(t=>fetch(`/api/orders/${t.orderId}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({table_number:null})}))),$(null),await J()}catch(e){console.error("Failed to clear table:",e)}},orders:G,selectedOrderIndex:Z,onOrderIndexChange:B})]}),(0,g.jsx)(xe,{tables:l.tables,tableStatuses:p,currency:v}),I&&Y&&(0,g.jsx)(he.A,{isOpen:I,onClose:()=>z(!1),total:Number(Y.totalAmount||0),subtotal:Number(Y.subtotal||Y.totalAmount||0),tax:Number(Y.tax||0),serviceCharge:Number(Y.serviceCharge||0),discountAmount:Number(Y.discount||0),couponDiscount:Number(Y.couponDiscount||0),onConfirmPayment:async(e,r,n,o,i,a)=>{if(!S)return;const s=p[S];if(null!==s&&void 0!==s&&s.orderId)try{const r=localStorage.getItem("auth_token"),n={payment_status:"completed",payment_method:e,card_type:"card"===e&&a||null};o&&o>0&&i&&i>0&&(n.points_used=o,n.point_discount=i,n.total_amount=(s.totalAmount||0)-i);(await fetch(`/api/orders/${s.orderId}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify(n)})).ok&&("outstanding"===s.orderStatus?await fetch(`/api/orders/${s.orderId}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({status:"pending"})}):"served"===s.orderStatus&&await fetch(`/api/orders/${s.orderId}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({status:"completed"})}),z(!1),await J(),k.current&&k.current.emit("checkout-complete",{restaurantId:t,orderNumber:s.orderNumber||"",total:parseFloat(s.totalAmount)||0,currency:"MYR"}))}catch(d){console.error("Failed to process payment:",d)}},paymentMethods:_,customerId:Y.customerId||void 0,restaurantId:Number(t),membershipSettings:D}),(0,g.jsxs)(Ie,{$isOpen:R,children:[(0,g.jsxs)(ze,{children:[(0,g.jsxs)(_e,{children:["POS Terminal \u2014 Table ",S]}),(0,g.jsx)(Te,{onClick:()=>{M(!1),H(""),J()},children:"\xd7 Close"})]}),R&&W&&(0,g.jsx)(De,{src:W,title:"POS Terminal"})]}),(0,g.jsx)(me.A,{isOpen:O,onClose:()=>P(!1)})]})}},5783:(e,t,r)=>{r.d(t,{A:()=>C});var n=r(9950),o=r(4752),i=r(7447),a=r(4414);const s=o.Ay.div`
  position: absolute;
  left: ${e=>e.$x-e.$w/2}px;
  top: ${e=>e.$y-e.$h/2}px;
  width: ${e=>e.$w}px;
