    ...
    const loadQRCode = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Get QR code image from payment settings (ewallet key, with legacy fallback)
          const qrSettings = restaurant.payment_settings?.ewallet || restaurant.payment_settings?.qrPayment || restaurant.payment_settings?.qr;
