...
const SystemLogsPage: React.FC = () => {
  ...
  useEffect(() => {
    const sampleLogs: SystemLog[] = [
      {
        id: 'log-001',
        timestamp: '2025-01-21 16:45:23.425',
        level: 'error',
        category: 'database',
      ...
      {
        id: 'log-002',
        timestamp: '2025-01-21 16:44:58.123',
        level: 'warning',
        category: 'auth',
      ...
      {
        id: 'log-003',
        timestamp: '2025-01-21 16:44:45.891',
        level: 'info',
        category: 'api',
        service: 'pos-api',
      ...
      {
        id: 'log-004',
        timestamp: '2025-01-21 16:44:32.567',
        level: 'critical',
        category: 'payment',
        service: 'payment-service',
        message: 'Payment processing failure: Gateway timeout',
        requestId: 'req_a9b8c7d6e5f4',
        details: {
      ...
      {
        id: 'log-005',
        timestamp: '2025-01-21 16:44:15.234',
        level: 'info',
        category: 'system',
        ...
        details: {
          ...
          size: '145MB',
          duration: '4m 32s',
          location: 's3://orderhere-backups/incremental-2025-01-21-16.sql.gz',
          tables: ['orders', 'payments', 'order_items']
        }
      },
      {
        id: 'log-006',
        timestamp: '2025-01-21 16:43:58.789',
        level: 'debug',
        category: 'api',
        service: 'kitchen-display-service',
        message: 'Kitchen display updated with new order',
        requestId: 'req_b9c8d7e6f5g4',
        details: {
      ...
      {
        id: 'log-007',
        timestamp: '2025-01-21 16:43:42.345',
        level: 'warning',
        category: 'security',
        service: 'auth-service',
