...
const BackupRestorePage: React.FC = () => {
  ...
  useEffect(() => {
    const sampleBackups: BackupRecord[] = [
      {
        id: 'backup-001',
        name: 'Full System Backup - Jan 21, 2025',
        type: 'full',
        size: 2847650000, // 2.85 GB
        createdAt: '2025-01-21 02:00:00',
        status: 'completed',
        duration: 1845, // 30m 45s
        location: 's3://orderhere-backups/full-2025-01-21.sql.gz',
        description: 'Complete system backup including all databases and file uploads',
        tables: ['users', 'restaurants', 'orders', 'menu_items', 'payments', 'subscriptions', 'invoices'],
        compressed: true,
        encrypted: true
      },
      {
        id: 'backup-002',
        name: 'Incremental Backup - Jan 21, 2025 (12:00)',
        type: 'incremental',
        size: 145230000, // 145 MB
        createdAt: '2025-01-21 12:00:00',
        status: 'completed',
        duration: 285, // 4m 45s
        location: 's3://orderhere-backups/incremental-2025-01-21-12.sql.gz',
      ...
      {
        id: 'backup-003',
        name: 'Emergency Backup - Jan 20, 2025',
        type: 'full',
        size: 2756890000, // 2.76 GB
        createdAt: '2025-01-20 18:30:00',
        status: 'completed',
        duration: 1920, // 32m
        location: 's3://orderhere-backups/emergency-2025-01-20.sql.gz',
      ...
      {
        id: 'backup-004',
        name: 'Scheduled Backup - Jan 22, 2025',
        type: 'full',
        size: 0,
        createdAt: '2025-01-22 02:00:00',
        status: 'scheduled',
        duration: 0,
        location: 's3://orderhere-backups/scheduled-2025-01-22.sql.gz',
        description: 'Daily scheduled full backup',
        tables: ['users', 'restaurants', 'orders', 'menu_items', 'payments', 'subscriptions', 'invoices'],
        compressed: true,
        encrypted: true
      },
      {
        id: 'backup-005',
        name: 'Failed Backup - Jan 19, 2025',
        type: 'full',
        size: 0,
    ...
    const sampleRestoreOperations: RestoreOperation[] = [
      {
        id: 'restore-001',
        backupId: 'backup-003',
        backupName: 'Emergency Backup - Jan 20, 2025',
        startedAt: '2025-01-21 14:30:00',
        completedAt: '2025-01-21 15:15:00',
        status: 'completed',
        progress: 100,
        restoredTables: ['users', 'restaurants', 'orders', 'menu_items', 'payments', 'subscriptions', 'invoices'],
        totalTables: 7
      },
      {
        id: 'restore-002',
        backupId: 'backup-001',
        backupName: 'Full System Backup - Jan 21, 2025',
        startedAt: '2025-01-21 16:00:00',
        status: 'in-progress',
        progress: 65,
        restoredTables: ['users', 'restaurants', 'orders', 'menu_items'],
        totalTables: 7
      }
    ];
    
    setBackups(sampleBackups);
    setRestoreOperations(sampleRestoreOperations);
  }, []);
