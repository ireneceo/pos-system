...
const RestaurantSubscriptionsPage: React.FC = () => {
  ...
  useEffect(() => {
    const sampleSubscriptions: RestaurantSubscription[] = [
      {
        id: 'sub-rest-001',
        restaurantId: 'rest-001',
        restaurantName: 'Sunway Pyramid Food Court - Stall A',
        managerId: 'mgr-001',
        ...
        payerId: 'mgr-001',
        payerName: 'Ahmad Rahman',
        features: ['Up to 10k orders/month', 'Advanced analytics', 'Priority support'],
      ...
      },
      {
        ...
        restaurantName: 'Sunway Pyramid Food Court - Stall B',
        managerId: 'mgr-001',
        managerName: 'Ahmad Rahman',
        planType: 'basic',
        status: 'active',
        ...
        paymentModel: 'self',
        payerId: 'rest-002',
        payerName: 'Lim Ah Kow (Stall B Owner)',
        features: ['Up to 1k orders/month', 'Basic analytics', 'Email support'],
        lastPayment: '2024-12-15',
        nextPayment: '2025-01-15',
        autoRenew: true,
        createdAt: '2024-01-15',
      ...
      },
      {
        ...
        restaurantName: 'IOI Mall - Korean BBQ',
        managerId: 'mgr-002',
        ...
        paymentModel: 'self',
        payerId: 'rest-003',
        payerName: 'Korean BBQ Restaurant Sdn Bhd',
        features: ['Unlimited orders', 'Custom analytics', '24/7 support', 'Multi-location'],
      ...
      },
      {
        ...
        restaurantName: 'Pavilion KL - Italian Bistro',
        managerId: 'mgr-003',
      ...
      },
      {
        ...
        restaurantName: 'Mid Valley - Coffee Shop',
        managerId: 'mgr-004',
