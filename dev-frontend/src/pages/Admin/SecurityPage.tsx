  ...
  useEffect(() => {
    const sampleEvents: SecurityEvent[] = [
      ...
      },
      {
        ...
        description: 'User role elevated from Staff to Restaurant Admin for user mgr-002',
        location: 'Petaling Jaya, Selangor',
        resolved: true
      },
      {
        id: 'event-003',
        timestamp: '2025-01-21 12:15:08',
        ...
        description: 'Accessed sensitive customer payment data outside normal hours',
        location: 'Shah Alam, Selangor',
        resolved: true
      },
      {
        id: 'event-004',
        timestamp: '2025-01-21 09:30:45',
    ...
    const samplePolicies: SecurityPolicy[] = [
      {
        ...
        description: 'Enforce strong password requirements including minimum length, special characters, and regular updates',
        enabled: true,
        category: 'authentication',
        settings: { minLength: 8, requireSpecialChars: true, requireNumbers: true },
        lastUpdated: '2025-01-15 10:30:00'
      },
      {
        id: 'policy-002',
        name: 'Multi-Factor Authentication',
        description: 'Require two-factor authentication for all administrative accounts',
        enabled: true,
        category: 'authentication',
        settings: { mandatoryForAdmins: true, allowSMS: true, allowApp: true },
        lastUpdated: '2025-01-10 14:22:00'
      },
      {
        id: 'policy-003',
        ...
        settings: { timeoutMinutes: 30, warningMinutes: 5 },
        lastUpdated: '2025-01-18 09:15:00'
      },
      {
        id: 'policy-004',
        name: 'IP Address Whitelist',
        description: 'Restrict administrative access to approved IP addresses only',
        enabled: false,
        category: 'authorization',
        settings: { allowedIPs: ['10.0.0.0/24', '172.16.0.0/16'] },
      ...
      },
      {
        ...
        settings: { algorithm: 'AES-256', rotateKeys: true },
        lastUpdated: '2025-01-08 11:20:00'
      },
      {
        id: 'policy-006',
        name: 'Audit Logging',
        description: 'Log all security-relevant events for compliance and monitoring',
        enabled: true,
        category: 'monitoring',
        settings: { logLevel: 'INFO', retentionDays: 90 },
        lastUpdated: '2025-01-05 13:30:00'
      }
    ];
