            ...
            {invoice.payerType === 'external' ? (
              ...
              <>
                ...
                {invoice.companyName && invoice.companyName !== invoice.customerName && (
                  <div style={{ fontSize: '13px', color: '#6B7280', marginTop: '4px' }}>Company: {invoice.companyName}</div>
                )}
              </>
            )}
          </div>
                  ...
                  {linkSearchResults.managers.length > 0 && (
                    <div>
                      ...
                      {linkSearchResults.managers.map(manager => (
                        <div key={manager.id} onClick={() => onLinkAccount('manager', manager)} style={{ padding: '12px', cursor: 'pointer', borderBottom: '1px solid #F3F4F6' }} onMouseEnter={(e) => e.currentTarget.style.background = '#F8FAFC'} onMouseLeave={(e) => e.currentTarget.style.background = 'white'}>
