...
const FoodcourtPlansPage: React.FC = () => {
  ...
  const [createFormData, setCreateFormData] = useState({
    ...
    display_name: '',
    description: '',
    category: 'custom' as 'basic' | 'custom',
        ...
        {showCreateModal && (
          <Modal onClick={() => setShowCreateModal(false)}>
            <ModalContent onClick={(e) => e.stopPropagation()}>
              ...
              <ModalBody>
                {/* Plan Target and Category are fixed for brand managers */}
                <div style={{ padding: '12px', background: '#F0F9FF', borderRadius: '8px', marginBottom: '16px' }}>
                  <p style={{ margin: 0, fontSize: '14px', color: '#0369A1' }}>
                    Creating a <strong>Custom Subscription</strong> plan for your restaurants.
                  </p>
                </div>
                <FormGroup>
