...
interface FoodcourtInvoiceCreateModalProps {
  newInvoice: any;
  setNewInvoice: (v: any) => void;
  payerMode: 'member' | 'external';
  setPayerMode: (v: 'member' | 'external') => void;
  externalPayer: { name: string; email: string; phone: string; company: string; address: string; tax_id: string };
  setExternalPayer: (v: any) => void;
  searchQuery: string;
  ...
  setSelectedTarget: (v: { type: 'manager' | 'restaurant'; data: Manager | Restaurant } | null) => void;
...
const FoodcourtInvoiceCreateModal: React.FC<FoodcourtInvoiceCreateModalProps> = ({
  newInvoice,
  setNewInvoice,
  payerMode,
  setPayerMode,
...
export default FoodcourtInvoiceCreateModal;
