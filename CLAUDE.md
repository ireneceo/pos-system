...
**~~남발 금지~~ (2026-08-20 폐기):** 이전에는 "일상 작업은 `/검증` 으로 충분"이었으나 Irene 지시로 **검증·판단 자체가 Fable 몫**이 되었다. 위 5개 기준은 이제 "Fable 을 부를지"가 아니라 **"얼마나 깊게 볼지"** 의 기준으로 쓴다(5개 중 하나라도 걸리면 전체 게이트 4종, 아니면 경량 판정).
